...
// Columns: English, Simplified Chinese, Korean, Japanese, Arabic, Italian, Hindi, Portuguese (pt-BR).
...
export const UI_CATALOG = [
  ...
  [
    ...
    "- {0} (critic): आर्किटेक्चर निर्णयों, MCP/सिक्योरिटी सीमाओं, runtime/bootstrap बदलावों, workflow टोपोलॉजी और ऐसे किसी भी user अनुरोध के लिए अनिवार्य reviewer जिसमें \"critic\" या \"critical thinker\" का ज़िक्र हो। @{1}: <समीक्षा के लिए प्रश्न या योजना> का उपयोग करें।",
    "- {0} (crítico): revisor obrigatório para decisões de arquitetura, limites de MCP/segurança, mudanças de runtime/bootstrap, topologia de workflow e qualquer pedido do usuário que mencione \"crítico\" ou \"pensador crítico\". Use @{1}: <pergunta ou plano a revisar>."
  ],
  [
    "- Follow-up batch...",
    "- 后续批次...",
  ...
  [
    ...
    "- वैकल्पिक या रोका गया काम...",
    "- Trabalho opcional ou pausado..."
  ],
  [
    ...
    "- सुसंगत पहला बैच शिप करें...",
    "- Entregue o primeiro lote coerente..."
  ],
  [
    "-<QUANT>.gguf",
    "-<QUANT>.gguf",
  ...
  [
    ...
    "— الوكلاء يرون حاليًا الأدوات المدمجة فقط (read_file، shell، web_search…). هذه أيضًا أسرع طريقة لاختبار ما إذا كانت أداة MCP تعطّل استدعاء الأدوات لدى الوكلاء: أبقِها متوقفة وأعد التشغيل؛ إذا عملت الأدوات الآن، فكان مخطط MCP هو السبب.",
    ...
    "— एजेंट फ़िलहाल केवल built-in tools (read_file, shell, web_search…) ही देखते हैं। यह जांचने का सबसे तेज़ तरीका भी है कि कोई MCP tool एजेंटिक tool-calling को तोड़ तो नहीं रहा: इसे बंद रखकर दोबारा चलाएं; अगर tools अब चल पड़ें, तो MCP schema ही वजह थी।",
    "— os agentes atualmente veem apenas as ferramentas integradas (read_file, shell, web_search…). Esta também é a forma mais rápida de testar se uma ferramenta MCP está quebrando o tool-calling dos agentes: deixe-a desativada e execute de novo; se as ferramentas agora dispararem, um schema MCP era o culpado."
  ],
  [
    ...
    "— एंटी-पैटर्न; ऐसा तभी करें जब लक्ष्य इसके बिना असंभव हो।",
    "— anti-pattern; NÃO faça isso a menos que o objetivo seja impossível sem ele."
  ],
  [
    ...
    "— कोई भी प्रोजेक्ट फ़ोल्डर, जैसे GitHub पर कोई repo",
    "— qualquer pasta de projeto, por exemplo, um repo no GitHub"
  ],
  [
    ...
    "— इसे स्वीकृत करें। जब यह पूरा हो जाए,",
    "— aprove-o. Quando terminar,"
  ],
  [
    ...
    "— टीम का नाम जांचें और फिर से कोशिश करें।",
    "— verifique o nome do time e tente novamente."
  ],
  [
    ...
    "— यह कोड कॉपी करें और वहां पेस्ट करें:",
    "— copie este código e cole lá:"
  ],
  [
    ...
    "— 릴리스를 위해 커밋할 디렉토리",
    "— リリース用にコミットするディレクトリ",
    "— الدليل الذي يتم عمل commit له للإصدار",
    "— directory di cui fare commit per la release",
    "— रिलीज़ के लिए commit की जाने वाली डायरेक्टरी",
    "— diretório do qual fazer commit para a release"
  ],
  [
    ...
    "— आपके अकाउंट पर पाया गया (",
    "— descoberto na sua conta ("
  ],
  [
    ...
    "— modificabile, precompilato in base alla tua scelta",
    "— एडिट किया जा सकता है, आपकी पसंद से प्री-फ़िल",
    "— editável, preenchido com base na sua escolha"
  ],
  [
    "— GitHub repo releases publish TO (may differ from origin)",
    "— releases 发布到的 GitHub 仓库（可能与 origin 不同）",
    "— 릴리스가 게시되는 대상 GitHub 저장소 (origin과 다를 수 있음)",
    "— リリースの公開先 GitHub リポジトリ（origin と異なる場合があります）",
    "— مستودع GitHub الذي تُنشر إليه الإصدارات (قد يختلف عن origin)",
    "— repo GitHub SU CUI vengono pubblicate le release (può differire dall'origin)",
    "— वह GitHub repo जिस पर releases publish होती हैं (origin से अलग हो सकता है)",
    "— repo do GitHub PARA ONDE as releases são publicadas (pode diferir do origin)"
  ],
  [
    ...
    "— सख़्त आवश्यकता; अगर टीम इसका पालन नहीं कर सकती तो उसे लक्ष्य ठुकरा देना चाहिए।",
    "— requisito rígido; o time deve recusar o objetivo se não puder cumpri-lo."
  ],
  [
    ...
    "— आइसोलेटेड एजेंट प्रमाणित हैं।",
    "— os agentes isolados estão autenticados."
  ],
  [
    ...
    "— यह तेज़ है और काफ़ी कम VRAM इस्तेमाल करता है (साधारण GPU पर सबसे अच्छा), और लोकप्रिय मॉडल (Llama, Mistral, Gemma, Qwen, Phi) सपोर्ट करता है। चुनें",
    "— é mais rápido e usa muito menos VRAM (ideal em GPUs modestas), e suporta os modelos populares (Llama, Mistral, Gemma, Qwen, Phi). Escolha"
  ],
  [
    "— just",
    "— 仅",
  ...
  [
    ...
    "— MCP, एनवायरनमेंट, अकाउंट्स, लॉग्स।",
    "— MCP, Ambiente, Contas, Logs."
  ],
  [
    ...
    "— कोई कंसोल पॉपअप नहीं। React, Tauri commands के ज़रिए Rust से बात करता है; कोई एम्बेडेड Python HTTP सर्वर नहीं है। Python सिर्फ़ फ़ाइन-ट्यूनिंग वर्कफ़्लो और प्रति-मॉडल virtualenv बूटस्ट्रैप के लिए एक बार चलाया जाता है।",
    "— sem popups de console. O React fala com o Rust via comandos Tauri; não há servidor HTTP Python embutido. O Python é invocado uma única vez, apenas para o fluxo de fine-tuning e o bootstrap do virtualenv por modelo."
  ],
  [
    "— none downloaded yet —",
    "— 尚未下载任何内容 —",
  ...
  [
    ...
    "— Train पेज खोलें और इसे अपने dataset के रूप में चुनें।",
    "— abra a página Train e escolha-o como seu dataset."
  ],
  [
    "— port",
    "— 端口",
  ...
  [
    ...
    "— साबित करता है कि कोई बदलाव “हो गया” है",
    "— comprova que uma mudança está “pronta”"
  ],
  [
    "— ready to send.",
    "— 准备发送。",
  ...
  [
    ...
    "— تُرسل التقارير إلى فريق OwLLM كـ issues على GitHub، لذا تحتاج إلى حساب GitHub (مجاني) متصل. مرة واحدة فقط، ثم تصبح نقرة واحدة من أي جهاز كمبيوتر تسجّل الدخول عليه.",
    "— le segnalazioni arrivano al team OwLLM come issue su GitHub, quindi serve un account GitHub (gratuito) collegato. Una volta sola, poi è un clic da qualsiasi PC su cui accedi.",
    "— रिपोर्ट GitHub issues के रूप में OwLLM टीम तक जाती हैं, इसलिए एक (मुफ़्त) GitHub अकाउंट कनेक्ट होना ज़रूरी है। एक बार करना है, फिर जिस भी PC पर साइन इन करें, वहां एक क्लिक में हो जाता है।",
    "— os relatórios vão para o time do OwLLM como issues do GitHub, então você precisa de uma conta do GitHub (gratuita) conectada. Uma vez só, depois é um clique em qualquer PC em que você fizer login."
  ],
  [
    ...
    "— एक ही LAN, Tailscale/WireGuard/VPN ओवरले (LAN के बाहर के लिए अनुशंसित, यहां कोई सेटअप नहीं — आपका ओवरले IP अपने-आप publish हो जाता है), नीचे सेट किया गया कोई public host, या आपका खुद का होस्ट किया हुआ relay।",
    "— mesma LAN, um overlay Tailscale/WireGuard/VPN (recomendado fora da LAN, sem configuração aqui — seu IP de overlay é publicado automaticamente), um host público que você define abaixo, ou um relay hospedado por você."
  ],
  [
    "— Select a model —",
    "— 选择一个模型 —",
  ...
  [
    ...
    "— हल्का संकेत; जब विकल्प हो तो योजना को इस ओर झुकाएं।",
    "— dica leve; incline o plano nessa direção quando houver escolha."
  ],
  [
    "— start / stop a model.",
    "— 启动 / 停止一个模型。",
  ...
  [
    ...
    "— अपनी चैट, सेटिंग्स और एजेंट टीमें हर डिवाइस पर ले जाएं",
    "— leve seus chats, configurações e times de agentes para todos os dispositivos"
  ],
  [
    ...
    "— ब्रिज इनबाउंड मेल को प्रोसेस करते समय उसे पढ़ा हुआ चिह्नित कर देता है। Gmail/Outlook के लिए, एक बनाएं",
    "— a bridge marca os e-mails recebidos como lidos ao processá-los. Para Gmail/Outlook, crie um"
  ],
  [
    ...
    "— फ़ाइल प्रोजेक्ट के अंदर डुप्लिकेट हो जाती है और sandbox बरकरार रहता है। “Grant home” सिर्फ़ इसी run के लिए पूरे यूज़र प्रोफ़ाइल तक पहुंच बढ़ा देता है और अगले run में अपने-आप रीसेट हो जाता है।",
    "— o arquivo é duplicado dentro do projeto e a sandbox permanece intacta. “Conceder home” amplia o acesso a todo o seu perfil de usuário apenas nesta execução e é redefinido automaticamente na próxima."
  ],
  [
    ...
    "— वे नियम जो इस repo के साथ चलते हैं (",
    "— as regras que acompanham este repo ("
  ],
  [
    "— unsupported",
    "— 不受支持",
  ...
  [
    ...
    "— आपकी चैट और सेटिंग्स हर डिवाइस पर आपके साथ चलती हैं",
    "— seus chats e configurações acompanham você em todos os dispositivos"
  ],
  [
    ...
    ", …) को इंस्टॉल के समय OWLLM समकक्षों में बदल दिया जाता है (",
    ", …) são reescritas para os equivalentes OWLLM ("
  ],
  [
    ", …) on install.",
    ", …)。",
  ...
  [
    ...
    ", और Event Subscriptions के तहत बॉट को सब्सक्राइब करें",
    ", e em Event Subscriptions inscreva o bot em"
  ],
  [
    ...
    ", यहां तक कि Windows के अपने इंस्टॉलर को भी नहीं। यह एक बार का टॉगल है:",
    ", nem mesmo o instalador do próprio Windows. É uma chave que você ativa uma única vez:"
  ],
  [
    ", or",
    "，或者",
  ...
  [
    ...
    ", या इसे इसके पीछे रखें",
    ", ou coloque-o atrás de um"
  ],
  [
    ", then use",
    "后面，然后使用",
  ...
  [
    ...
    "; ❌ पंक्तियां फ़िट नहीं होंगी, ⚠ पंक्तियां तंग हैं (फ़िट तो होंगी पर कॉन्टेक्स्ट के लिए जगह नहीं बचेगी)।",
    "; ❌ linhas não cabem, ⚠ linhas estão no limite (cabem, mas sem folga para o contexto)."
  ],
  [
    ...
    ": ये जोड़े आपके चुने हुए मॉडल द्वारा आपके स्रोतों से लिखे जाते हैं। इनमें गलतियां या hallucinations हो सकते हैं — ट्रेनिंग से पहले नीचे इनकी समीक्षा करें।",
    ": os pares são escritos pelo modelo que você escolher, a partir das suas fontes. Eles podem conter erros ou alucinações — revise-os abaixo antes do treinamento."
  ],
  [
    ":<tool>",
    ":<工具>",
  ...
  [
    ...
    "· किसी नोड या ऐरो पर क्लिक करें",
    "· clique em um nó ou seta"
  ],
  [
    ...
    "· फ़ैक्ट्स आपके PCs के बीच सिंक होते हैं, worklog लोकल रहता है",
    "· os fatos sincronizam entre seus PCs, o worklog fica local"
  ],
  [
    "· file",
    "· 文件",
  ...
  [
    ...
    "· कुंजी सेव हो गई — .cer के लिए तैयार",
    "· chave armazenada — pronta para o .cer"
  ],
  [
    "· last:",
    "· 上次：",
  ...
  [
    ...
    "· 개방 (봇이 있는 모든 채널)",
    "· 開放（ボットがいる任意のチャンネル）",
    "· مفتوح (أي قناة يتواجد فيها البوت)",
    "· aperto (qualsiasi canale in cui è il bot)",
    "· खुला (हर वह चैनल जिसमें बॉट है)",
    "· aberto (qualquer canal em que o bot está)"
  ],
  [
    ...
    "· 개방 (봇이 볼 수 있는 모든 채널)",
    "· 開放（ボットが見える任意のチャンネル）",
    "· مفتوح (أي قناة يراها البوت)",
    "· aperto (qualsiasi canale che il bot vede)",
    "· खुला (हर वह चैनल जो बॉट देख सकता है)",
    "· aberto (qualquer canal que o bot vê)"
  ],
  [
    "· open (any chat)",
    "· 开放（任何聊天）",
  ...
  [
    ...
    "· रोकने के लिए Stop दबाएं।",
    "· Pressione Stop para abortar."
  ],
  [
    "· role '",
    "· 角色 '",
  ...
  [
    ...
    "· भेजने वालों की allow-list सक्रिय",
    "· lista de remetentes permitidos ativa"
  ],
  [
    "· SimplySign {0}",
    "· SimplySign {0}",
  ...
  [
    ...
    "'{0}' एक built-in टेम्पलेट है — built-in टेम्पलेट हटाए नहीं जा सकते।",
    "'{0}' é um template integrado — templates integrados não podem ser excluídos."
  ],
  [
    "'ArrowDown'). Use after browser_fill to submit a form or trigger a handler.",
    "'ArrowDown')。在 browser_fill 之后使用以提交表单或触发处理程序。",
    "'ArrowDown'). 폼을 제출하거나 핸들러를 트리거하려면 browser_fill 후에 사용하세요.",
    "'ArrowDown'）。フォームを送信するかハンドラーを起動するために browser_fill の後に使用します。",
    "'ArrowDown'). استخدمها بعد browser_fill لإرسال نموذج أو تفعيل معالج.",
    "'ArrowDown'). Usalo dopo browser_fill per inviare un modulo o attivare un handler.",
    "'ArrowDown')। फ़ॉर्म सबमिट करने या हैंडलर ट्रिगर करने के लिए browser_fill के बाद इस्तेमाल करें।",
    "'ArrowDown'). Use após browser_fill para enviar um formulário ou acionar um handler."
  ],
  [
    ...
    "'Enter'), 'mouse'(에뮬레이션된 USB-HID 마우스 이동/클릭), 'boot_key'(부팅/BIOS 키 탭",
    "'Enter'）、'mouse' （エミュレートされた USB-HID マウスの移動/クリック）、'boot_key'（ブート/BIOS キーをタップ）",
    "'Enter')، 'mouse' (تحريك/نقر فأرة USB-HID المحاكاة)، 'boot_key' (الضغط على مفتاح إقلاع/BIOS",
    "'Enter'), 'mouse' (muovi/clicca il mouse USB-HID emulato), 'boot_key' (premi un tasto di avvio/BIOS",
    "'Enter'), 'mouse' (एम्युलेटेड USB-HID माउस को हिलाएं/क्लिक करें), 'boot_key' (boot/BIOS कुंजी दबाएं",
    "'Enter'), 'mouse' (mover/clicar o mouse USB-HID emulado), 'boot_key' (tocar uma tecla de boot/BIOS"
  ],
  [
    ...
    "'Consenti agli agenti di usare dispositivi remoti' deve essere abilitato nella pagina Dispositivi.",
    "इसके लिए Devices पेज पर 'एजेंट्स को रिमोट डिवाइस इस्तेमाल करने दें' सक्षम होना ज़रूरी है।",
    "'Permitir que agentes usem dispositivos remotos' esteja ativado na página Dispositivos."
  ],
  [
    ...
    "'mount_iso' (वर्चुअल USB ISO अटैच करें), 'power' (टारगेट की power/reset लाइन दबाएं)।",
    "'mount_iso' (anexar um ISO USB virtual), 'power' (pressionar a linha de energia/reset do alvo)."
  ],
  [
    "’s GPU",
    "的 GPU",
  ...
  [
    ...
    "'tablet'. تعيد الإعدادات المسبقة للأجهزة المحمولة تحجيم منفذ العرض إلى أبعاد هاتف/جهاز لوحي حقيقية",
    "'tablet'. I preset mobili ridimensionano il viewport alle dimensioni reali di telefono/tablet",
    "'tablet'। मोबाइल प्रीसेट व्यूपोर्ट को असली फ़ोन/टैबलेट आयामों में रीसाइज़ करते हैं",
    "'tablet'. Presets móveis redimensionam o viewport para dimensões reais de celular/tablet"
  ],
  [
    ...
    "blocco 'TEAM MEMORY — current shared knowledge' (può essere vuoto in un nuovo progetto).",
    "'TEAM MEMORY — current shared knowledge' ब्लॉक (नए प्रोजेक्ट में खाली हो सकता है)।",
    "bloco 'TEAM MEMORY — current shared knowledge' (pode estar vazio em um projeto novo)."
  ],
  [
    ...
    "'true' = build+sign+latest.json ma NON pubblicare (prova generale).",
    "'true' = build+sign+latest.json लेकिन publish न करें (रिहर्सल)।",
    "'true' = build+sign+latest.json mas NÃO publica (ensaio)."
  ],
  [
    ...
    "'true' = DRAFT के रूप में publish करें ताकि कोई इंसान उसे public करे।",
    "'true' = publica como DRAFT para um humano tornar público."
  ],
  [
    ...
    "\" 현재 필터로.",
    "\" 現在のフィルターで。",
    "\" مع عوامل التصفية الحالية.",
    "\" con i filtri attuali.",
    "\" वर्तमान फ़िल्टर के साथ।",
  ...
  [
    ...
    "\"transport\": \"ssh\" | \"http\" }。请只提供 auth.sshKeyPath 或 auth.token 中的一个。",
    ...
    "\"transport\": \"ssh\" | \"http\" }. قدّم واحدًا فقط بالضبط من auth.sshKeyPath أو auth.token.",
    "\"transport\": \"ssh\" | \"http\" }. Fornisci ESATTAMENTE uno tra auth.sshKeyPath e auth.token.",
    "\"transport\": \"ssh\" | \"http\" }. auth.sshKeyPath या auth.token में से ठीक एक ही दें।",
    "\"transport\": \"ssh\" | \"http\" }. Forneça EXATAMENTE um entre auth.sshKeyPath e auth.token."
  ],
  [
    "({0} changed)",
    "({0} 已更改)",
  ...
  [
    ...
    "(सस्ते, हर एक में एक फ़ंक्शन) और Inspector में read-only दिखाए जाते हैं। रोल से आगे प्रति-एजेंट टूल अनुमतियां Agents पेज पर प्रोजेक्ट-स्तरीय सेटिंग हैं।",
    "(baratos, uma função cada) e exibidos como somente leitura no Inspector. Permissões de ferramentas por agente além do papel são uma configuração no nível do projeto na página Agentes."
  ],
  [
    "(current page)",
    "（当前页面）",
  ...
  [
    ...
    "(खाली = कोई भी) alice@x.com, bob@y.com",
    "(vazio = qualquer) alice@x.com, bob@y.com"
  ],
  [
    ...
    "(खाली = कोई भी) U0123…, U0456…",
    "(vazio = qualquer) U0123…, U0456…"
  ],
  [
    "(empty)",
    "(空)",
  ...
  [
    ...
    "(इंजन इंस्टॉल नहीं है)",
    "(engine não instalada)"
  ],
  [
    "(env)",
    "(env)",
  ...
  [
    ...
    "(खाली छोड़ें = कोई भी चैनल जिसमें बॉट है) · C0123…, D0456…",
    "(deixe vazio = qualquer canal em que o bot está) · C0123…, D0456…"
  ],
  [
    ...
    "(खाली छोड़ें = कोई भी चैनल) · 112233445566778899, …",
    "(deixe vazio = qualquer canal) · 112233445566778899, …"
  ],
  [
    ...
    "(खाली छोड़ें = कोई भी अनुमत चैट) · 123456789, 987654321",
    "(deixe vazio = qualquer chat permitido) · 123456789, 987654321"
  ],
  [
    ...
    "(लिंक, बटन, इनपुट) उनके इंडेक्स नंबरों के साथ। आप एलिमेंट्स पर इंडेक्स से ही कार्रवाई करते हैं",
    "(links, botões, inputs) com seus números de índice. Você atua nos elementos POR ÍNDICE"
  ],
  [
    ...
    "(कोई सक्रिय इन्फ़रेंस सर्वर नहीं)",
    "(nenhum servidor de inferência ativo)"
  ],
  [
    "(no body)",
    "(无正文)",
  ...
  [
    ...
    "(कोई MCP सर्वर नहीं चल रहा — MCP पेज से शुरू करें)",
    "(nenhum servidor MCP em execução — inicie-os na página MCP)"
  ],
  [
    "(no messages yet)",
    "(尚无消息)",
  ...
  [
    ...
    "(विंडो नहीं)। ऑफ़ = पूरी स्क्रीन रिकॉर्ड करें।",
    "(não Janela). Desativado = grava a tela inteira."
  ],
  [
    "(nothing to commit)",
    "(无可提交内容)",
    ...
    "(コミットするものなし)",
    "(لا شيء لعمل commit)",
    "(niente di cui fare commit)",
    "(commit के लिए कुछ नहीं)",
    "(nada para commit)"
  ],
  [
    ...
    "(या किसी टीम की Workbench) और उस पर टिक करें। रनटाइम पर एजेंट ये निर्देश तभी लोड करता है जब किसी टास्क को इनकी ज़रूरत हो।",
    "(ou a Workbench de um time) e marque-a. Em tempo de execução, o agente carrega essas instruções apenas quando uma tarefa precisa delas."
  ],
  [
    "(pick a model)",
    "(选择一个模型)",
  ...
  [
    ...
    "(port-forward / DDNS / Tailscale MagicDNS host:port)",
    "(port-forward / DDNS / Tailscale MagicDNS होस्ट:पोर्ट)",
    "(port-forward / DDNS / Tailscale MagicDNS host:porta)"
  ],
  [
    "(Port:",
    "(端口:",
  ...
  [
    ...
    "(शुद्ध-NAT fallback — दोनों डिवाइस बाहर की ओर कनेक्ट करते हैं; उसे सिर्फ़ ciphertext दिखता है)",
    "(fallback pure-NAT — os dois dispositivos discam para fora; ele só vê o texto cifrado)"
  ],
  [
    "(screenshot attached 📸)",
    "(截图已附 📸)",
  ...
  [
    ...
    "(Tailscale, WireGuard)। इसे कभी भी इंटरनेट पर port-forward न करें। अपने Windows Firewall नियम को इस पोर्ट + एजेंट के IP तक सीमित रखें।",
    "(Tailscale, WireGuard). Nunca faça port-forward dele para a internet. Restrinja sua regra do Firewall do Windows a esta porta + o IP do agente."
  ],
  [
    ...
    "(फिर resident रहता है), या अगर आप क्लिक करें तो तुरंत",
    "(e depois permanece residente), ou imediatamente se você clicar em"
  ],
  [
    "(this PC)",
    "(此电脑)",
  ...
  [
    ...
    "(Fine Tuning के अंतर्गत) — चल रहे मॉडल से बात करें।",
    "(em Fine Tuning) — converse com o modelo em execução."
  ],
  [
    "(unset)",
    "(未设置)",
  ...
  [
    ...
    "(usa il roster del progetto",
    "(प्रोजेक्ट roster का उपयोग करें",
    "(usar o roster do projeto"
  ],
  [
    "(VM)",
    "(VM)",
  ...
  [
    ...
    ") — fit रंग अक्षम हैं। मुख्य पेज हेडर / Advanced › Hardware टैब पर अपना चुना हुआ GPU जाँचें।",
    ") — cores de ajuste desativadas. Confirme a GPU selecionada no cabeçalho da página principal / aba Avançado › Hardware."
  ],
  [
    ...
    ") — ऑर्केस्ट्रेटर, विशेषज्ञ और critic — सभी इन्हें हर टर्न पर देखते हैं।",
    ") — o orquestrador, os especialistas e o crítico veem tudo isso a cada turno."
  ],
  [
    ...
    ") और कोड पेस्ट करें। आपका इंतज़ार है…",
    ") e cole o código. Esperando você…"
  ],
  [
    ...
    ") किसी एक को साइलेंस करें, और हर MCP स्कीमा मॉडल तक पहुँचने से पहले अपने आप sanitize हो जाता है, ताकि एक खराब स्कीमा tool-calling को न तोड़ सके। कॉन्फ़िग यहाँ सेव होता है:",
    ") silencie um só, e todo schema MCP é auto-sanitizado antes de chegar ao modelo, então um schema ruim não consegue quebrar as tool calls. Config persistida em"
  ],
  [
    "[REMEMBER key=<optional-stable-id> tags=<optional,comma,tags>] <the fact>",
    "[REMEMBER key=<optional-stable-id> tags=<optional,comma,tags>] <事实>",
    "[REMEMBER key=<optional-stable-id> tags=<optional,comma,tags>] <사실>",
    "[REMEMBER key=<optional-stable-id> tags=<optional,comma,tags>] <事実>",
    "[REMEMBER key=<optional-stable-id> tags=<optional,comma,tags>] <الحقيقة>",
    "[REMEMBER key=<optional-stable-id> tags=<optional,comma,tags>] <il fatto>",
    "[REMEMBER key=<optional-stable-id> tags=<optional,comma,tags>] <तथ्य>",
    "[REMEMBER key=<optional-stable-id> tags=<optional,comma,tags>] <o fato>"
  ],
  [
    ...
    "[REMEMBER key=build_command tags=ci] रिपो रूट पर `npm run build` से build करें।",
    "[REMEMBER key=build_command tags=ci] Faça o build com `npm run build` na raiz do repo."
  ],
  [
    ...
    "[REMEMBER] Auth flow src/auth/session.ts में है और JWT जारी करता है।",
    "[REMEMBER] O fluxo de auth fica em src/auth/session.ts e emite JWTs."
  ],
  [
  ...
  [
    ...
    "{0} — vista catturata: {1}",
    "{0} — कैप्चर किया गया व्यू: {1}",
    "{0} — visualização capturada: {1}"
  ],
  [
    "{0} — environment log",
    "{0} — 环境日志",
  ...
  [
    ...
    "{0} — टीम रन जारी है",
    "{0} — execução da equipe em andamento"
  ],
  [
    "{0} — unlocks at {1} XP",
    "{0} — {1} XP 解锁",
    ...
    "{0} — si sblocca a {1} XP",
    "{0} — {1} XP पर अनलॉक होता है",
    "{0} — desbloqueia com {1} XP"
  ],
  [
  ...
  [
    ...
    "{0} चल रहे सर्वरों पर उपलब्ध",
    "{0} disponíveis nos servidores em execução"
  ],
  [
    "{0} base · {1} temp",
    "{0} 基础 · {1} 温度",
  ...
  [
    ...
    "{0} CLI को Node.js चाहिए, जो अभी इंस्टॉल नहीं है। बंडल किया गया Node.js + uv toolchain अभी इंस्टॉल करें? (~47 MB, एक बार का डाउनलोड) पूरा होने के बाद मैं {1} CLI इंस्टॉल अपने आप फिर से आज़माऊँगा।",
    "O CLI {0} precisa do Node.js, que ainda não está instalado. Instalar agora o toolchain Node.js + uv incluído? (~47 MB, download único) Quando terminar, vou tentar instalar o CLI {1} de novo automaticamente."
  ],
  [
    ...
    "{0} commit upstream से आगे — Push उन्हें भेजता है",
    "{0} commit(s) à frente do upstream — Push os envia"
  ],
  [
    ...
    "{0} commit upstream से पीछे",
    "{0} commit(s) atrás do upstream"
  ],
  [
    "{0} done",
    "{0} 完成",
  ...
  [
    ...
    "{0} token · KV cache ≈ {1} GB (30B-क्लास)",
    "{0} tokens · cache KV ≈ {1} GB (classe 30B)"
  ],
  [
    ...
    "{0} टूल एजेंटों को उपलब्ध कराए गए",
    "{0} ferramentas anunciadas aos agentes"
  ],
  [
    "{0} Tools run in: {1}",
    "{0} 个工具运行于：{1}",
    ...
    "{0} टूल यहाँ चलते हैं: {1}",
    "{0} Ferramentas executam em: {1}"
  ],
  [
    ...
    "{0} modifica/e non committata/e — Commit le acquisisce",
    "{0} uncommitted बदलाव — Commit उन्हें कैप्चर करता है",
    "{0} alteração(ões) não commitada(s) — Commit as captura"
  ],
  [
    "{0} web login{1}",
    "{0} 次网页登录{1}",
  ...
  [
    ...
    "* (/ को छोड़कर कोई भी अक्षर), ** (कोई भी गहराई, / सहित), ? (एक अक्षर)।",
    "* (qualquer caractere exceto /), ** (qualquer profundidade incl. /), ? (um caractere)."
  ],
  [
    "&nbsp;",
    "&nbsp;",
  ...
  [
    ...
    "• In Cursor / VS Code Continue, imposta la Base URL sull'URL copiato",
    "• Cursor / VS Code Continue में, Base URL को कॉपी किए गए URL पर सेट करें",
    "• No Cursor / VS Code Continue, defina a Base URL como a URL copiada"
  ],
  [
    ...
    "• API Key में कोई भी टेक्स्ट डालें (जैसे 'sk-local')",
    "• Defina a API Key como qualquer texto (ex.: 'sk-local')"
  ],
  [
    "• Set Model to: {0}",
    "• 将模型设置为：{0}",
    ...
    "• Model को इस पर सेट करें: {0}",
    "• Defina o modelo como: {0}"
  ],
  [
    ...
    "• ऊपर LLM Server शुरू करें",
    "• Inicie o servidor LLM acima"
  ],
  [
    "• unsaved",
    "• 未保存",
  ...
  [
    ...
    "•••• संग्रहीत — रखने के लिए खाली छोड़ें",
    "•••• armazenado — deixe em branco para manter"
  ],
  [
    "← Back",
    "← 返回",
  ...
  [
    ...
    "← प्राइमरी एजेंट को फ़ॉरवर्ड करें",
    "← Encaminhar ao agente principal"
  ],
  [
    "← Projects",
    "← 项目",
  ...
  [
    ...
    "→ दूसरे एजेंट को फ़ॉरवर्ड करें",
    "→ Encaminhar ao segundo agente"
  ],
  [
    "↓ Downloads",
    "↓ 下载",
  ...
  [
    ...
    "↗ टोकन बनाएँ (repo scope)",
    "↗ Criar um token (escopo repo)"
  ],
  [
    "↗ Dispatches to",
    "↗ 派发到",
  ...
  [
    ...
    "↺ टेम्पलेट पर रीसेट करें",
    "↺ Redefinir para o template"
  ],
  [
  ...
  [
    ...
    "↻ रेडीनेस चेक फिर से चलाएँ",
    "↻ Reexecutar verificações de prontidão"
  ],
  [
    "↻ Refresh",
    "↻ 刷新",
  ...
  [
    ...
    "⏱ {0} — {1} को शुरू, {2} को समाप्त",
    "⏱ {0} — iniciado {1}, concluído {2}"
  ],
  [
    ...
    "⏱ रुका हुआ — पहले एजेंट रन पर अपने आप शुरू होता है (या अभी वॉर्म करने के लिए Start क्लिक करें)।",
    "⏱ Parado — inicia automaticamente na primeira execução de agente (ou clique em Iniciar para aquecê-lo agora)."
  ],
  [
    "⏳ {0} running… {1}",
    "⏳ {0} 运行中… {1}",
  ...
  [
    ...
    "⏳ आइसोलेशन (WSL) जाँच रहा है…",
    "⏳ Verificando isolamento (WSL)…"
  ],
  [
    "⏳ Checking…",
    "⏳ 检查中…",
  ...
  [
    ...
    "⏳ पहली बार चलाने पर npx से MCP पैकेज डाउनलोड होता है — आमतौर पर 20-60 सेकंड। इंतज़ार करें; Start दोबारा क्लिक करने से कोई फ़ायदा नहीं।",
    "⏳ A primeira execução baixa o pacote MCP via npx — geralmente 20-60s. Aguarde; clicar em Iniciar de novo não vai ajudar."
  ],
  [
    "⏳ Installing engine…",
    "⏳ 安装引擎…",
  ...
  [
    ...
    "⏳ uv रनटाइम इंस्टॉल हो रहा है…",
    "⏳ Instalando runtime uv…"
  ],
  [
    "⏳ Installing…",
    "⏳ 安装中…",
  ...
  [
    ...
    "⏸ रुका हुआ — Auto-start बंद है, इसलिए यह सिर्फ़ Start क्लिक करने पर चलता है।",
    "⏸ Parado — o início automático está desligado, então só executa quando você clica em Iniciar."
  ],
  [
    "⏹ Stop",
    "⏹ 停止",
  ...
  [
    ...
    "▶ इस PC पर रिमोट कंट्रोल चालू करें",
    "▶ Ativar controle remoto neste PC"
  ],
  [
    "▶ Run",
    "▶ 运行",
  ...
  [
    ...
    "⚙ प्रोजेक्ट सेटिंग्स{0}",
    "⚙ Configurações do projeto{0}"
  ],
  [
    "⚙ Repository setup",
    "⚙ 仓库设置",
  ...
  [
    ...
    "⚠ यह फ़ोल्डर पढ़ा नहीं जा सका —",
    "⚠ não foi possível ler esta pasta —"
  ],
  [
    "⚠ Couldn't save:",
    "⚠ 无法保存：",
  ...
  [
    ...
    "⚠ تم العثور عليها في Windows: {0}، لكن لم يصل أي شيء إلى الـ sandbox.",
    "⚠ Trovato su Windows: {0}, ma nulla è finito nella sandbox.",
    "⚠ Windows पर मिला: {0}, लेकिन sandbox में कुछ नहीं पहुँचा।",
    "⚠ Encontrado no Windows: {0}, mas nada chegou ao sandbox."
  ],
  [
    ...
    "⚠ {0} खाली हुआ, लेकिन {1} डिलीट विफल — {2}",
    "⚠ {0} liberados, mas {1} exclusão(ões) falharam — {2}"
  ],
  [
    ...
    "⚠ 호스트 접근 — 샌드박스 OFF",
    "⚠ ホストアクセス — サンドボックスオフ",
    "⚠ وصول إلى المضيف — الـ sandbox متوقف",
    "⚠ ACCESSO HOST — sandbox SPENTA",
    "⚠ होस्ट एक्सेस — sandbox OFF",
    "⚠ ACESSO AO HOST — sandbox OFF"
  ],
  [
    "⚠ incomplete download",
    "⚠ 下载不完整",
  ...
  [
    ...
    "⚠ لا يوجد محرك sandbox — سيعمل الوكلاء على المضيف. {0}",
    "⚠ Nessun motore sandbox — gli agenti verrebbero eseguiti sull'host. {0}",
    "⚠ कोई sandbox इंजन नहीं — एजेंट होस्ट पर चलेंगे। {0}",
    "⚠ Nenhum mecanismo de sandbox — os agentes rodariam no host. {0}"
  ],
  [
    ...
    "⚠ अभी डिस्क पर नहीं है — ट्रेनिंग से पहले इसे डाउनलोड करें (ट्रेनिंग अपने आप fetch नहीं करती)।",
    "⚠ Ainda não está no disco — baixe antes do treinamento (o treinamento não baixa automaticamente)."
  ],
  [
    ...
    "⚠️ एक मैनुअल स्टेप: अपने BIOS में virtualization चालू करें",
    "⚠️ Uma etapa manual: habilite a virtualização no BIOS"
  ],
  [
    ...
    "⚠️ प्लेन HTTP — key और ट्रैफ़िक एन्क्रिप्टेड नहीं हैं। केवल इस पर इस्तेमाल करें:",
    "⚠️ HTTP puro — a chave e o tráfego não são criptografados. Use somente em uma"
  ],
  [
    "⚠ React render crash",
    "⚠ React 渲染崩溃",
    ...
    "⚠ React रेंडर क्रैश",
    "⚠ Crash de renderização do React"
  ],
  [
    "⚠ review:",
    "⚠ 审查：",
  ...
  [
    ...
    "⚠️ 密钥以明文存储于",
    "⚠️ 비밀 정보가 평문으로 저장되는 위치:",
    "⚠️ シークレットはプレーンテキストで保存されています：",
    "⚠️ يتم تخزين الأسرار كنص عادي في",
    "⚠️ I segreti sono memorizzati in testo chiaro su",
    "⚠️ Secrets प्लेनटेक्स्ट में यहाँ सेव होते हैं:",
    "⚠️ Os segredos são armazenados em texto simples em"
  ],
  [
    "⚡ {0} tok/s",
    "⚡ {0} tok/s",
  ...
  [
    ...
    "✂ OWLLM ऐप तक क्रॉप करें (फ़्रेम सहित)",
    "✂ Recortar para o app OWLLM (moldura incluída)"
  ],
  [
    "✅ Abliterated → {0}",
    "✅ 已清除 → {0}",
  ...
  [
    ...
    "✅ 프로젝트에 적용하고 열기",
    "✅ プロジェクトに適用して開く",
    "✅ التطبيق على المشروع والفتح",
    "✅ Applica al progetto e apri",
    "✅ प्रोजेक्ट पर लागू करें और खोलें",
    "✅ Aplicar ao projeto e abrir"
  ],
  [
    ...
    "✅ प्रोजेक्ट में इस नाम से कॉपी हुआ:",
    "✅ Copiado para o projeto como"
  ],
  [
    "✅ Deleted {0}",
    "✅ 已删除 {0}",
  ...
  [
    ...
    "✅ {0} खाली हुआ ({1} cache/trash आइटम)",
    "✅ {0} liberados ({1} item(ns) de cache/lixeira)"
  ],
  [
    "✅ GGUF written → {0}",
    "✅ GGUF 已写入 → {0}",
  ...
  [
    ...
    "✏️ कस्टम HuggingFace id…",
    "✏️ id personalizado do HuggingFace…"
  ],
  [
    "✏ User Input",
    "✏ 用户输入",
  ...
  [
    ...
    "✓ APIキーは隔離されたエージェントで利用可能です。",
    "✓ مفاتيح API متاحة للوكلاء المنعزلين.",
    "✓ Chiavi API disponibili per agenti isolati.",
    "✓ API keys आइसोलेटेड एजेंट्स के लिए उपलब्ध हैं।",
    "✓ Chaves de API disponíveis para agentes isolados."
  ],
  [
    "✓ Approve (read-only)",
    "✓ 批准（只读）",
    ...
    "✓ 承認（読み取り専用）",
    "✓ الموافقة (قراءة فقط)",
    "✓ Approva (sola lettura)",
    "✓ स्वीकारें (read-only)",
    "✓ Aprovar (somente leitura)"
  ],
  [
    "✓ Brief done — Close",
    "✓ 简报完成 — 关闭",
    ...
    "✓ ブリーフ完了 — 閉じる",
    "✓ الملخص تم — إغلاق",
    "✓ Brief completato — Chiudi",
    "✓ ब्रीफ़ पूरा — बंद करें",
    "✓ Briefing concluído — Fechar"
  ],
  [
    "✓ clean",
    "✓ 干净",
  ...
  [
    ...
    "✓ Project Card repo से मेल खाता दिख रहा है।",
    "✓ O Project Card parece consistente com o repo."
  ],
  [
    ...
    "✓ मेमोरी रीस्टार्ट करें Hugging Face — C:\\Users\\mc\\.cache\\huggingface",
    "✓ Reiniciar memória Hugging Face — C:\\Users\\mc\\.cache\\huggingface"
  ],
  [
    "✓ Saved",
    "✓ 已保存",
  ...
  [
    ...
    "✓ {0} पेयर सेव हुए → {1}। ट्रेनिंग पेज पर इसे अपने डेटासेट के रूप में चुनें।",
    "✓ {0} par(es) salvos → {1}. Selecione na página Treinar como seu dataset."
  ],
  [
    "✓ Saved →",
    "✓ 已保存 →",
  ...
  [
    ...
    "✓ संरचनात्मक रूप से मान्य — हर एजेंट तक पहुँचा जा सकता है, सभी base resolve होते हैं।",
    "✓ Estruturalmente válido — todos os agentes alcançáveis, todas as bases resolvem."
  ],
  [
    "✓ Synced into sandbox: {0} — isolated agents are authenticated.",
    "✓ 已同步到沙箱：{0} — 隔离的代理已认证。",
    "✓ 샌드박스에 동기화됨: {0} — 격리된 에이전트 인증됨.",
    "✓ サンドボックスに同期済み: {0} — 隔離されたエージェントは認証済みです。",
    "✓ تمت المزامنة إلى الـ sandbox: {0} — تم التحقق من هوية الوكلاء المعزولين.",
    "✓ Sincronizzato nella sandbox: {0} — gli agenti isolati sono autenticati.",
    "✓ Sandbox में सिंक हुआ: {0} — आइसोलेटेड एजेंट्स प्रमाणित हैं।",
    "✓ Sincronizado no sandbox: {0} — os agentes isolados estão autenticados."
  ],
  [
    ...
    "✓ 팀 적용됨 — 닫고 캔버스 열기",
    "✓ チームが適用 — キャンバスを閉じて開く",
    "✓ تم تطبيق الفريق — إغلاق وفتح اللوحة",
    "✓ Team applicato — Chiudi e apri il canvas",
    "✓ टीम लागू हुई — बंद करें और कैनवास खोलें",
    "✓ Equipe aplicada — Fechar e abrir o canvas"
  ],
  [
    "✓ Used for training",
    "✓ 用于训练",
  ...
  [
    ...
    "✨ GitHub क्यों कनेक्ट करें? — देखें कि क्या-क्या अनलॉक होता है",
    "✨ Por que conectar o GitHub? — veja o que você desbloqueia"
  ],
  [
    "❌ {0} — see logs below",
    "❌ {0} — 请查看以下日志",
    ...
    "❌ {0} — vedi i log qui sotto",
    "❌ {0} — नीचे log देखें",
    "❌ {0} — veja os logs abaixo"
  ],
  [
    "❌ Delete failed: {0}",
    "❌ 删除失败：{0}",
  ...
  [
    ...
    "❌ GGUF एक्सपोर्ट विफल: {0} — नीचे log देखें",
    "❌ Falha na exportação de GGUF: {0} — veja os logs abaixo"
  ],
  [
    "❤ Likes",
    "❤ 喜欢",
  ...
  [
    ...
    "➕ और weights जोड़ें / डाउनलोड करें…",
    "➕ Adicionar / baixar mais pesos…"
  ],
  [
    "➕ Custom git URL…",
    "➕ 自定义 git URL…",
  ...
  [
    ...
    "⟳ Riavvia rete WSL",
    "⟳ WSL नेटवर्किंग रीस्टार्ट करें",
    "⟳ Reiniciar rede do WSL"
  ],
  [
    "⟳ Retry",
    "⟳ 重试",
  ...
  [
    ...
    "⬇ Sandbox इंजन इंस्टॉल करें",
    "⬇ Instalar mecanismo de sandbox"
  ],
  [
    ...
    "⬇ WSL इंस्टॉल करें (एडमिन + रीबूट)",
    "⬇ Instalar WSL (admin + reinicialização)"
  ],
  [
    "⭐ Recommended",
    "⭐ 推荐",
  ...
  [
    ...
    "🌐 नेटवर्क पर inference सर्व करें (यह PC)",
    "🌐 Servir inferência na rede (este PC)"
  ],
  [
    "🌐 Translator",
    "🌐 翻译器",
  ...
  [
    ...
    "🌐 वेब लॉगिन — पोर्टल ऑटो साइन-इन",
    "🌐 Logins na web — login automático no portal"
  ],
  [
    "Fine-tune a model",
    "微调模型",
  ...
  [
    ...
    "🐙 创建 GitHub 仓库 + 关联 origin",
    "🐙 GitHub 저장소 생성 + 원격 연결",
    "🐙 GitHubリポジトリを作成してoriginを設定",
    "🐙 إنشاء مستودع GitHub + ربط origin",
    "🐙 Crea repo GitHub + collega origin",
    "🐙 GitHub repo बनाएँ + origin जोड़ें",
    "🐙 Criar repo no GitHub + configurar origin"
  ],
  [
    ...
    "🐙 प्रोजेक्ट बन गया, लेकिन GitHub repo सेटअप नहीं हो सका: {0} — Publisher कार्ड के ⚙ Repo सेटअप करें से फिर कोशिश करें।",
    "🐙 Projeto criado, mas não foi possível configurar o repo do GitHub: {0} — tente novamente pelo ⚙ Configurar repo no cartão do Publisher."
  ],
  [
    ...
    "इसे बग के रूप में रिपोर्ट करें",
    "Reportar isso como um bug"
  ],
  [
    ...
    "🐧 Fine-tuning एनवायरनमेंट",
    "🐧 Ambientes de fine-tuning"
  ],
  [
    "🐧 Set up WSL",
    "🐧 设置 WSL",
  ...
  [
    ...
    "📁 यह फ़ोल्डर इस डिवाइस पर नहीं है — प्रोजेक्ट (चैट, मेमोरी और सेटिंग्स) दूसरी मशीन से सिंक हुआ है।",
    "📁 Esta pasta não está neste dispositivo — o projeto (chat, memória e configurações) foi sincronizado de outra máquina."
  ],
  [
    "📄 Add documents…",
    "📄 添加文档…",
  ...
  [
    ...
    "📋 वर्कस्पेस में कॉपी करें",
    "📋 Copiar para o workspace"
  ],
  [
    "📋 Copy LAN URL",
    "📋 复制局域网 URL",
  ...
  [
    ...
    "📋 वर्कलॉग दिख रहा है — छिपाएँ",
    "📋 Log de trabalho visível — ocultar"
  ],
  [
    "📓 Notebook",
    "📓 笔记本",
  ...
  [
    ...
    "📚 LLM/data/skills/ से SKILL.md पैक। इसका मुख्य भाग रनटाइम पर सिस्टम प्रॉम्प्ट बन जाता है।",
    "📚 Pacote SKILL.md de LLM/data/skills/. O corpo vira o prompt de sistema em tempo de execução."
  ],
  [
    "📚 Skills",
    "📚 技能",
  ...
  [
    ...
    "📚 स्किल्स · ज़रूरत पड़ने पर लोड होती हैं",
  ...
  [
    ...
    "📡 यह GPU मेरे अन्य डिवाइस के साथ शेयर करें",
    "📡 Compartilhar esta GPU com meus outros dispositivos"
  ],
  [
    "📤 Send",
    "📤 发送",
  ...
  [
    ...
    "📥 सभी weights डाउनलोड करें",
    "📥 Baixar todos os pesos"
  ],
  [
    "📦 Application",
    "📦 应用",
  ...
  [
    ...
    "📦 {0} से GGUF एक्सपोर्ट हो रहा है…",
    "📦 Exportando GGUF de {0}…"
  ],
  [
    "📦 GGUF",
    "📦 GGUF",
  ...
  [
    ...
    "لقطة شاشة واسأل",
    "Screenshot e chiedi",
    "स्क्रीनशॉट लेकर पूछें",
    "Capturar tela e perguntar"
  ],
  [
    "🔄 Discover",
    "🔄 发现",
  ...
  [
    ...
    "🔄 WSL की इंस्टॉलेशन पूरी करने के लिए रीबूट करें",
    "🔄 Reiniciar para concluir a instalação do WSL"
  ],
  [
    "🔄 Refresh",
    "🔄 刷新",
  ...
  [
    ...
    "🔄 हार्डवेयर डिटेक्शन रीफ़्रेश करें",
    "🔄 Atualizar detecção de hardware"
  ],
  [
    "🔄 Reset",
    "🔄 重置",
  ...
  [
    ...
    "🔑 Brave Search key आवश्यक है (अकाउंट पेज में सेट करें)",
    "🔑 Chave do Brave Search necessária (defina na página Contas)"
  ],
  [
  ...
  [
    ...
    "🔑 क्लाउड लॉगिन सैंडबॉक्स में सिंक हो गए: {0}।",
    "🔑 Logins da nuvem sincronizados no sandbox: {0}."
  ],
  [
    "🔒 Built-in role from LLM/core/agents/roles/. Click",
    "🔒 来自 LLM/core/agents/roles/ 的内置角色。点击",
    "🔒 LLM/core/agents/roles/에 있는 내장 역할. 클릭",
    "🔒 LLM/core/agents/roles/ の組み込みロール。クリック",
    "🔒 دور مدمج من LLM/core/agents/roles/. انقر",
    "🔒 Ruolo integrato da LLM/core/agents/roles/. Clicca",
    "🔒 LLM/core/agents/roles/ से बिल्ट-इन रोल। क्लिक करें",
    "🔒 Role integrado de LLM/core/agents/roles/. Clique"
  ],
  [
  ...
  [
    ...
    "🔓 홈 권한 부여 (이번 실행)",
    "🔓 ホームを付与（この実行時）",
    "🔓 منح الوصول إلى مجلد Home (هذا التشغيل)",
    "🔓 Concedi home (questa esecuzione)",
    "🔓 होम फ़ोल्डर का एक्सेस दें (इस रन के लिए)",
    "🔓 Conceder acesso à home (esta execução)"
  ],
  [
    ...
    "🔗 huggingface.co पर खोलें",
    "🔗 Abrir no huggingface.co"
  ],
  [
    "🔗 Sign in with GitHub",
    "🔗 使用 GitHub 登录",
  ...
  [
    ...
    "🔧 अभी रिपेयर करें (आपके हार्डवेयर के अनुसार री-इंस्टॉल)",
    "🔧 Reparar agora (reinstalar, compatível com seu hardware)"
  ],
  [
    ...
    "🔬 सुरक्षित सेल्फ़-टेस्ट चलाएँ",
    "🔬 Executar autoteste seguro"
  ],
  [
    "🕓 Uploaded",
    "🕓 已上传",
  ...
  [
    ...
    "🖊 Firma e credenziali",
    "🖊 Signing और क्रेडेंशियल",
    "🖊 Signing e credenciais"
  ],
  [
    "🖥 Devices",
    "🖥 设备",
  ...
  [
    ...
    "🖥🔌 OWLLM Node — KVM रिमोट कंट्रोल",
    "🖥🔌 OWLLM Node — controle remoto KVM"
  ],
  [
    "🖧 Server",
    "🖧 服务器",
  ...
  [
    ...
    "🤝 ब्रीफ़ से टीम बनाएँ",
    "🤝 Montar equipe a partir do briefing"
  ],
  [
    "🤝 Assembling team…",
    "🤝 正在组建团队…",
  ...
  [
    ...
    "🦙 Installa motore LLM",
    "🦙 LLM इंजन इंस्टॉल करें",
    "🦙 Instalar engine de LLM"
  ],
  [
    "🦙 Model server",
    "🦙 模型服务器",
  ...
  [
    ...
    "🧹 {0} कैश/ट्रैश आइटम हटाए जा रहे हैं…",
    "🧹 Excluindo {0} item(ns) de cache/lixo…"
  ],
  [
    "🧹 Deleting {0}/{1}: {2} ({3})",
    "🧹 正在删除 {0}/{1}：{2} ({3})",
  ...
  [
    ...
    "🚀 Hugging Face से टोकन पाएँ →",
    "🚀 Obter um token do Hugging Face →"
  ],
  [
    "🚀 Start brainstorm",
    "🚀 开始头脑风暴",
  ...
  [
    ...
    "🚫 0 dispatch analizzati — l'orchestratore ha risposto da solo e questo team non ha uno specialista a cui instradare. Aggiungi uno specialista o riformula l'obiettivo.",
    "🚫 0 डिस्पैच पार्स हुए — ऑर्केस्ट्रेटर ने अकेले जवाब दिया, और इस टीम में रूट करने के लिए कोई विशेषज्ञ नहीं है। कोई विशेषज्ञ जोड़ें या लक्ष्य दोबारा लिखें।",
    "🚫 0 dispatches analisados — o orquestrador respondeu sozinho e esta equipe não tem um especialista para rotear. Adicione um especialista ou reformule o objetivo."
  ],
  [
    "🚫 0 dispatches ran — the orchestrator named agents that don't exist ({0}) and there's no specialist to fall back to.",
    "🚫 0 个调度已运行——协调器指定了不存在的代理 ({0})，且没有可依赖的专家。",
    ...
    "🚫 0 dispatch eseguiti — l'orchestratore ha nominato agenti che non esistono ({0}) e non c'è uno specialista su cui ripiegare.",
    "🚫 0 डिस्पैच चले — ऑर्केस्ट्रेटर ने ऐसे एजेंट बताए जो मौजूद नहीं हैं ({0}), और फ़ॉलबैक के लिए कोई विशेषज्ञ नहीं है।",
    "🚫 0 dispatches executados — o orquestrador citou agentes que não existem ({0}) e não há um especialista para usar como fallback."
  ],
  [
    "🚫 ABLITERATE",
    "🚫 ABLITERATE",
  ...
  [
    ...
    "모델에 abliteration 적용",
    "モデルにabliterationを適用",
    "تطبيق abliteration على نموذج",
    "Applica l'abliteration a un modello",
    "मॉडल को abliterate करें",
    "Aplicar abliteration em um modelo"
  ],
  [
    "🚫 Abliterate model",
    "🚫 对模型执行 abliteration",
    "🚫 모델 abliteration",
    "🚫 モデルをabliterate",
    "🚫 تطبيق abliteration على النموذج",
    "🚫 Abliterate modello",
    "🚫 मॉडल abliterate करें",
    "🚫 Aplicar abliteration no modelo"
  ],
  [
    "🚫 Abliterated",
    "🚫 已 abliterate",
  ...
  [
    ...
    "🛠 uvランタイムをインストール（ワンクリック、約30 MB）",
    "🛠 تثبيت وقت تشغيل uv (بنقرة واحدة، ~30 ميجابايت)",
    "🛠 Installa runtime uv (con un clic, ~30 MB)",
    "🛠 uv रनटाइम इंस्टॉल करें (एक क्लिक, ~30 MB)",
    "🛠 Instalar runtime uv (um clique, ~30 MB)"
  ],
  [
    "🛠️ OWLLM MCP",
    "🛠️ OWLLM MCP",
  ...
  [
    ...
    "🛠️ Configura l'ambiente di fine-tuning",
    "🛠️ फ़ाइन-ट्यूनिंग एनवायरनमेंट सेट अप करें",
    "🛠️ Configurar ambiente de fine-tuning"
  ],
  [
    "🛠 Tool Calls",
    "🛠 工具调用",
  ...
  [
    ...
    "🛡 आइसोलेशन चालू — प्रोजेक्ट {0}{1} के अंदर चलते हैं, आपकी {2} फ़ाइलों से अलग।{3}",
    "🛡 Isolamento ativado — os projetos rodam dentro de {0}{1}, longe dos seus arquivos {2}.{3}"
  ],
  [
    "🛡 New project",
    "🛡 新项目",
  ...
  [
    ...
    "10 अक्षरों वाली टीम ID",
    "ID de equipe de 10 caracteres"
  ],
  [
    "123456:ABCdefGhi…",
    "123456:ABCdefGhi…",
  ...
  [
    ...
    "13B+ मॉडल: 30-60+ मिनट (fp16 forward pass के लिए उपलब्ध VRAM पर निर्भर)",
    "Modelo 13B+: 30-60+ min (depende da folga de VRAM para forward passes em fp16)"
  ],
  [
    ...
    "② token यहाँ पेस्ट करें (ghp_…)",
    "② Cole o token aqui (ghp_…)"
  ],
  [
    "2. Sign in (or",
    "2. 登录（或",
  ...
  [
    ...
    "Grafo di conoscenza 3D della memoria del team",
    "टीम मेमोरी का 3D नॉलेज ग्राफ़",
    "Grafo de conhecimento 3D da memória da equipe"
  ],
  [
    "5px 10px 0",
    "5px 10px 0",
  ...
  [
    ...
    "7-8B मॉडल: ~10-20 मिनट",
    "Modelo de 7-8B: ~10-20 min"
  ],
  [
    "a folder you pick",
    "您选择的文件夹",
    ...
    "आपका चुना हुआ फ़ोल्डर",
    "uma pasta que você escolher"
  ],
  [
    "a Linux sandbox",
    "一个 Linux 沙箱",
  ...
  [
    ...
    "로컬 모델(서버 실행 중 아님)",
    "ローカルモデル（サーバー未起動）",
    "نموذج محلي (الخادم غير قيد التشغيل)",
    "un modello locale (server non in esecuzione)",
    "एक लोकल मॉडल (सर्वर चालू नहीं है)",
    "um modelo local (servidor não está em execução)"
  ],
  [
    ...
    "एक प्राइवेट git worktree चेकआउट हो रहा है (बड़े repo पर कुछ सेकंड)। जब तक आप Merge नहीं करते, आपका असली फ़ोल्डर अछूता रहता है। आप अभी अपना अनुरोध टाइप कर सकते हैं — तैयार होते ही Send अनलॉक हो जाएगा।",
    "Um worktree git privado está sendo criado (alguns segundos em um repo grande). Sua pasta real permanece intocada até você fazer Merge. Você já pode digitar sua solicitação — o Enviar é desbloqueado assim que estiver pronto."
  ],
  [
    ...
    "एक प्रोजेक्ट में एक फ़ोल्डर, एजेंट्स की सूची और टीम की वायरिंग जुड़ी होती है। Agents टैब पर Run क्लिक करने पर orchestrator इसी सूची के आधार पर काम बांटता है।",
    "Um projeto une uma pasta, um elenco de agentes e a fiação da equipe. O orquestrador despacha para esse elenco quando você clica em Executar na aba Agentes."
  ],
  [
    ...
    "رمز وصول للقراءة فقط يفتح النماذج المقيدة (Llama وGemma وبعض Mistral) ويرفع حدود المعدل للمستخدمين المجهولين. النماذج العامة تعمل بدونه.",
    ...
    "एक read-only token gated मॉडल (Llama, Gemma, कुछ Mistral) अनलॉक करता है और anonymous rate limits हटाता है। पब्लिक मॉडल इसके बिना भी काम करते हैं।",
    "Um token somente leitura desbloqueia modelos restritos (Llama, Gemma, alguns Mistral) e remove os limites de taxa anônimos. Modelos públicos funcionam sem ele."
  ],
  [
    ...
    "‏shell حقيقي على الجهاز البعيد — اكتب فيه",
    "una vera shell sulla macchina remota — digita al suo interno",
    "रिमोट मशीन पर एक असली shell — इसमें टाइप करें",
    "um shell de verdade na máquina remota — digite nele"
  ],
  [
    ...
    "यहाँ पहले से एक signing key मौजूद है। नई request जनरेट करने पर वह बदल जाएगी — पुरानी request के लिए जारी .cer फिर import नहीं हो पाएगा। जारी रखें?",
    "Já existe uma chave de assinatura aqui. Gerar uma nova solicitação a substitui — um .cer emitido para a solicitação ANTIGA não poderá mais ser importado. Continuar?"
  ],
  [
    ...
    "एक skill उसकी SKILL.md फ़ाइल से परिभाषित होती है और लाइब्रेरी में मैनेज होती है — यहाँ एडिट नहीं होती। इसके बजाय skill को किसी एजेंट पर equip करें।",
    "Uma skill é definida pelo seu arquivo SKILL.md e gerenciada na biblioteca — ela não é editada aqui. Em vez disso, equipe a skill em um agente."
  ],
  [
    ...
    "एक वर्कर — अपने बॉस से काम लेता है और उसे पूरा करता है।",
    "Um trabalhador — recebe uma tarefa do seu chefe e a executa."
  ],
  [
    "Abliterate",
    "消除",
  ...
  [
    ...
    "파괴 중…",
    "消去中…",
    "جارٍ تنفيذ Abliteration…",
    "Abliterazione in corso…",
    "Abliteration चल रही है…",
    "Executando abliteration…"
  ],
  [
    ...
    "تجد عملية Abliteration وتحذف الاتجاه الوحيد في التيار المتبقي للنموذج الأكثر مسؤولية عن سلوك الرفض (\"عذرًا، لا أستطيع المساعدة في ذلك\")، دون إعادة تدريب.",
    ...
    "Abliteration मॉडल की residual stream में उस एक direction को खोजकर हटा देती है जो refusal (\"Sorry, I can't help with that\") व्यवहार के लिए सबसे ज़्यादा ज़िम्मेदार है — बिना दोबारा ट्रेनिंग के।",
    "A abliteration encontra e apaga a única direção no fluxo residual do modelo que é a maior responsável pelo comportamento de recusa (\"Desculpe, não posso ajudar com isso\"), sem retreinamento."
  ],
  [
    "About rules",
    "关于规则",
  ...
  [
    ...
    "ऊपर — key और .cer अपने आप जोड़ दिए जाते हैं।",
    "acima — a chave e o .cer são combinados automaticamente."
  ],
  [
    ...
    "आउटपुट PNG के लिए absolute फ़ाइलसिस्टम path।",
    "Caminho absoluto no sistema de arquivos para o PNG de saída."
  ],
  [
    ...
    "Absolute या project-relative डायरेक्टरी path।",
    "Caminho de diretório absoluto ou relativo ao projeto."
  ],
  [
    ...
    "Absolute या project-relative फ़ाइल path।",
    "Caminho de arquivo absoluto ou relativo ao projeto."
  ],
  [
    ...
    "Fetch करने के लिए absolute URL।",
    "URL absoluta para buscar."
  ],
  [
    ...
    "स्क्रीनशॉट लेने के लिए absolute URL।",
    "URL absoluta para capturar."
  ],
  [
    "Accounts",
    "账户",
  ...
  [
    ...
    "सीधे काम करें — workspace में पढ़ें, एडिट करें और चलाएं",
    "Aja diretamente — leia, edite e execute no workspace"
  ],
  [
  ...
  [
    ...
    "操作：'screenshot'（捕获目标的实时视频 — 返回保存的 PNG 的绝对路径",
    "동작: 'screenshot' (대상의 실시간 비디오 캡처 — 저장된 PNG의 절대 경로 반환",
    "アクション: 'screenshot'（対象のライブ映像をキャプチャ — 保存されたPNGの絶対パスを返す",
    "الإجراءات: 'screenshot' (التقاط الفيديو المباشر للهدف — يُرجع مسار PNG محفوظًا مطلقًا",
    "Azioni: 'screenshot' (cattura il video in diretta del bersaglio — restituisce un PNG salvato assoluto",
    "Actions: 'screenshot' (टारगेट का लाइव वीडियो कैप्चर करता है — सेव किए गए PNG का absolute path लौटाता है",
    "Ações: 'screenshot' (captura o vídeo ao vivo do alvo — retorna um PNG salvo com caminho absoluto"
  ],
  [
    ...
    "सक्रिय inference सर्वर",
    "Servidores de inferência ativos"
  ],
  [
    ...
    "एक सामान्य टीम सदस्य की तरह काम करता है",
    "Atua como um membro normal da equipe"
  ],
  [
    "Add",
    "添加",
  ...
  [
    ...
    "टीम के लिए एक नोट जोड़ें (कोई निर्णय, कोई build कमांड, कोई चीज़ कहाँ है…)",
    "Adicione uma nota para a equipe (uma decisão, um comando de build, onde algo fica…)"
  ],
  [
    "Add agent from role",
    "从角色添加代理",
    ...
    "रोल से एजेंट जोड़ें",
    "Adicionar agente a partir de um papel"
  ],
  [
    "Add all + clear notes",
    "添加所有 + 清除笔记",
    ...
    "सभी जोड़ें + नोट्स साफ़ करें",
    "Adicionar tudo + limpar notas"
  ],
  [
    ...
    "पहले कम से कम एक डॉक्यूमेंट या URL जोड़ें।",
    "Adicione primeiro pelo menos um documento ou URL."
  ],
  [
    "Add context mention",
    "添加上下文提及",
    ...
    "कॉन्टेक्स्ट mention जोड़ें",
    "Adicionar menção de contexto"
  ],
  [
    "Add documents",
    "添加文档",
  ...
  [
    ...
    "इस स्टेप को सूची में जोड़ें",
    "Adicionar esta etapa à lista"
  ],
  [
    "Add Ubuntu — WSL is here, but only Docker's distro",
    "添加 Ubuntu — 已有 WSL，但只有 Docker 的发行版",
    "Ubuntu 추가 — WSL이 있지만, Docker의 배포판만 가능합니다.",
    "Ubuntuを追加 — WSLは利用可能ですが、Dockerのディストリビューションのみです",
    "أضف Ubuntu — WSL موجود، لكن توزيعة Docker فقط",
    "Aggiungi Ubuntu — WSL è qui, ma solo la distro di Docker",
    "Ubuntu जोड़ें — WSL मौजूद है, पर सिर्फ़ Docker की distro",
    "Adicionar Ubuntu — o WSL está presente, mas só com a distro do Docker"
  ],
  [
    ...
    "बाईं ओर अपने डॉक्यूमेंट/URL जोड़ें, एक मॉडल चुनें, और क्लिक करें",
    "Adicione seus documentos/URLs à esquerda, escolha um modelo e clique em"
  ],
  [
    "Address: -",
    "地址：-",
  ...
  [
    ...
    "Avanzato — template del team e permessi",
    "एडवांस्ड — टीम टेम्पलेट और permissions",
    "Avançado — template e permissões da equipe"
  ],
  [
  ...
  [
    ...
    "एजेंट ब्राउज़र — वह साझा वेब ब्राउज़र देखें और चलाएं जिसे आपके एजेंट browser_* टूल्स से नियंत्रित करते हैं (लाइव पेज व्यू, URL खोलना, स्थायी लॉगिन)।",
    "Navegador do Agente — veja e controle o navegador web compartilhado que seus agentes comandam com as ferramentas browser_* (visualização da página ao vivo, abrir URLs, logins persistentes)."
  ],
  [
    "Agent can use tools",
    "代理可以使用工具",
    ...
    "एजेंट टूल्स इस्तेमाल कर सकता है",
    "O agente pode usar ferramentas"
  ],
  [
    "Agent settings ·",
    "代理设置 ·",
  ...
  [
    ...
    "{0} में एजेंट टूल्स इंस्टॉल हो गए।",
    "Ferramentas do agente instaladas em {0}."
  ],
  [
    ...
    "एजेंट टूल्स इंस्टॉल हो गए; sync किए गए लॉगिन: {0}।",
    "Ferramentas do agente instaladas; logins sincronizados: {0}."
  ],
  [
    ...
    "एजेंट टूल्स इंस्टॉल हो गए। Windows पर {0} मिला लेकिन सैंडबॉक्स में कॉपी नहीं हो सका — फिर से कोशिश करने के लिए 'लॉगिन sync करें' क्लिक करें।",
    "Ferramentas do agente instaladas. Encontramos {0} no Windows, mas não foi possível copiar para a sandbox — clique em 'Sincronizar logins' para tentar novamente."
  ],
  [
    ...
    "एजेंट टूल्स इंस्टॉल हो गए। अकाउंट्स से लॉगिन करें, फिर 'लॉगिन sync करें' क्लिक करें।",
    "Ferramentas do agente instaladas. Faça login em Contas e depois clique em 'Sincronizar logins'."
  ],
  [
    ...
    "एजेंट↔एजेंट बातचीत — इसके बाद रुकती है",
    "conversa agente↔agente — pausa após"
  ],
  [
    "Agentic Team",
    "代理团队",
  ...
  [
    ...
    "Agenti → scegli un agente → 📚 Skill",
    "एजेंट्स → एक एजेंट चुनें → 📚 Skills",
    "Agentes → escolha um agente → 📚 Skills"
  ],
  [
    "agents on team",
    "团队中的代理",
  ...
  [
    ...
    "एजेंट सैंडबॉक्स के बाहर चलते हैं — आपके PC तक पूरी पहुंच। वापस बंद करने के लिए क्लिक करें।",
    "Os agentes rodam FORA da sandbox — acesso total ao seu PC. Clique para desativar de novo."
  ],
  [
    ...
    "एजेंट डिफ़ॉल्ट रूप से सैंडबॉक्स में चलते हैं — सुरक्षा, फ़ोल्डर और टीम, सब बाद में ⚙ प्रोजेक्ट सेटिंग्स में बदले जा सकते हैं।",
    "Por padrão, os agentes rodam em sandbox — segurança, pasta e equipe podem ser alteradas depois em ⚙ Configurações do projeto."
  ],
  [
    "Agents send inference to a llama-server on another host (e.g. your Windows GPU box). Run agents here, model there.",
    "代理将推理发送到另一台主机上的 llama-server（例如你的 Windows GPU 机器）。代理在这里运行，模型在那边。",
    "에이전트는 다른 호스트(예: Windows GPU 머신)의 llama-server로 추론을 보냅니다. 에이전트는 여기서, 모델은 저기서 실행됩니다.",
    "エージェントは別のホスト上の llama-server に推論を送信します（例：Windows GPU マシン）。エージェントはここで、モデルはそちらで実行します。",
    "يرسل الوكلاء الاستدلال إلى llama-server على مضيف آخر (مثل جهاز Windows المزود بـ GPU). شغّل الوكلاء هنا والنموذج هناك.",
    ...
    "एजेंट inference किसी दूसरे host पर चल रहे llama-server को भेजते हैं (जैसे आपकी Windows GPU मशीन)। एजेंट यहाँ चलाएं, मॉडल वहाँ।",
    "Os agentes enviam a inferência para um llama-server em outro host (por exemplo, sua máquina Windows com GPU). Rode os agentes aqui, o modelo lá."
  ],
  [
    "Agents use this PC's managed llama-server (default).",
    "代理使用这台电脑托管的 llama-server（默认）。",
    "에이전트는 이 PC의 관리되는 llama-server를 사용합니다(기본값).",
    "エージェントはこのPCで管理されている llama-server を使用します（デフォルト）。",
    "يستخدم الوكلاء llama-server المُدار على هذا الكمبيوتر (افتراضي).",
    "Gli agenti usano il server llama gestito di questo PC (predefinito).",
    "एजेंट इस PC के मैनेज्ड llama-server का इस्तेमाल करते हैं (डिफ़ॉल्ट)।",
    "Os agentes usam o llama-server gerenciado deste PC (padrão)."
  ],
  [
    ...
    "एजेंट्स, कनेक्टेड और तैयार",
    "agentes, conectados e prontos"
  ],
  [
    "agents)",
    "代理)",
  ...
  [
    ...
    "सभी स्टेप पूरे — नीचे 'पूर्ण' में से कोई फिर खोलें, या ऊपर नया स्टेप जोड़ें।",
    "Todas as etapas concluídas — reabra uma em Concluídas abaixo ou adicione uma nova etapa acima."
  ],
  [
    "all templates",
    "所有模板",
  ...
  [
    ...
    "सभी MCP टूल्स की अनुमति दें (कोई प्रतिबंध नहीं)",
    "Permitir todas as ferramentas MCP (sem restrição)"
  ],
  [
    ...
    "اقتربنا من النهاية — ثبّت Python في Ubuntu",
    "Quasi pronto — installa Python su Ubuntu",
    "बस थोड़ा और — Ubuntu में Python इंस्टॉल करें",
    "Quase lá — instale o Python no Ubuntu"
  ],
  [
    ...
    "इसके साथ-साथ — Virtual Machine Platform पहले से चालू है, इसलिए",
    "junto com ele — a Plataforma de Máquina Virtual já está ativada, então"
  ],
  [
    ...
    "अपने आप कैप्चर हुई worklog ट्रांसक्रिप्ट भी दिखाएं (असंबद्ध हालिया-गतिविधि पंक्तियाँ)",
    "Mostrar também a transcrição do worklog capturada automaticamente (linhas de atividade recente não conectadas)"
  ],
  [
  ...
  [
    ...
    "एक इंस्टॉल चल रहा है — आप यह पेज छोड़ भी दें तो भी यह चलता रहेगा।",
    "Uma instalação está em andamento — ela continua mesmo se você sair desta página."
  ],
  [
    ...
    "और नहीं पहुँच सकता आपके",
    "e não consegue acessar seu"
  ],
  [
    ...
    "레포와 함께 커밋되므로 모든 머신과 팀원이 동일한 규칙을 사용합니다. verify를 비워 두면 프로젝트에서 자동 감지됩니다.",
    ...
    "और repo के साथ commit होता है, इसलिए हर मशीन और टीम-साथी एक जैसे नियम इस्तेमाल करते हैं। प्रोजेक्ट से अपने आप पता लगाने के लिए verify खाली छोड़ दें।",
    "e é commitado com o repo, então toda máquina e colega de equipe usa as mesmas regras. Deixe verify em branco para detectar automaticamente a partir do projeto."
  ],
  [
    ...
    "और उसे Home पेज पर पेस्ट करें।)",
    "e cole na página Home.)"
  ],
  [
    ...
    "والصقها في إعدادات المستودع → الأسرار.",
    "e incollali nelle Impostazioni → Segreti del repository. ",
    "और उन्हें repo की Settings → Secrets में पेस्ट करें।",
    "e cole-os em Settings → Secrets do repo."
  ],
  [
    ...
    "और हर वह फ़ाइल लौटाता है जिसका नाम `pattern` से मेल खाता है। समर्थन करता है",
    "e retorna todos os arquivos cujo nome corresponde a `pattern`. Suporta"
  ],
  [
    ...
    "और साथ ही एक मोबाइल user-agent भेजता है, जिससे responsive लेआउट और UA-sniffing साइटें",
    "E envia um user-agent mobile, então layouts responsivos e sites que detectam UA"
  ],
  [
    ...
    "और नेटवर्क के आर-पार काम करता है (एक ही LAN, Tailscale/VPN overlay, या relay) —",
    "e funciona entre redes (mesma LAN, um overlay Tailscale/VPN ou um relay) pelo"
  ],
  [
    "Answer, push back, or say ‘go’ to research + write the brief…",
    "回答、提出异议，或说“go”来研究并撰写简报…",
    "답변하거나, 되돌리거나, 또는 ‘go’라고 말하여 조사하고 간단히 작성하세요…",
    "回答するか、反論するか、「go」と言えば調査してブリーフを作成します…",
    "أجب، أو ادفع الرد، أو قل 'انطلق' للبحث وكتابة الملخص...",
    "Rispondi, obietta o di’ ‘go’ per fare la ricerca e scrivere il brief…",
    "जवाब दें, असहमति जताएं, या रिसर्च करके brief लिखवाने के लिए ‘go’ कहें…",
    "Responda, conteste ou diga ‘go’ para pesquisar e escrever o briefing…"
  ],
  [
    ...
    "मेरे निर्णयों का जवाब देता है + योजना को मंज़ूर/नामंज़ूर करता है + जवाब",
    "responde às minhas decisões + aprova/rejeita o plano + responde"
  ],
  [
    "ANTHROPIC",
    "ANTHROPIC",
  ...
  [
    ...
    "कोई भी नेटवर्क जिस पर दोनों मशीनें एक-दूसरे तक route कर सकती हैं",
    "qualquer rede em que as duas máquinas conseguem se rotear"
  ],
  [
    "api",
    "API",
  ...
  [
    ...
    "API key (रिमोट सर्वर की --api-key, वैकल्पिक)",
    "Chave de API (o --api-key do servidor remoto, opcional)"
  ],
  [
    "API key saved",
    "API 密钥已保存",
  ...
  [
    ...
    "ऐप के end-to-end एन्क्रिप्टेड डिवाइस चैनल पर। टेक सपोर्ट, सॉफ़्टवेयर इंस्टॉल करने,",
    "canal de dispositivo com criptografia de ponta a ponta do app. Use para suporte técnico, instalação de software,"
  ],
  [
  ...
  [
    ...
    "APPLE_ID, APPLE_PASSWORD, APPLE_TEAM_ID — उदा. इन्हें GitHub Actions secrets के रूप में सेट करने के लिए। secret को संभालें",
    "APPLE_ID, APPLE_PASSWORD, APPLE_TEAM_ID — por exemplo, para defini-los como secrets do GitHub Actions. Trate o secret"
  ],
  [
    ...
    "हर एजेंट के सिस्टम prompt पर लागू + director mode चालू होने पर critic पर भी।",
    "Aplicado ao prompt de sistema de cada agente + ao crítico quando o modo diretor está ativado."
  ],
  [
    ...
    "ऑटो-फ़िक्स अभी लागू करें",
    "Aplicar correções automáticas agora"
  ],
  [
    "Apply failed:",
    "应用失败：",
  ...
  [
    ...
    "कुछ भी पूछें — न कोई प्रोजेक्ट, न कोई सेटअप। ऊपर चुना गया मॉडल (लोकल या क्लाउड) इस्तेमाल होता है। मॉडल से किसी फ़ोल्डर के अंदर काम कराने के लिए, वापस जाकर “नया प्रोजेक्ट” या “प्रोजेक्ट फ़ोल्डर खोलें” चुनें।",
    "Pergunte qualquer coisa — sem projeto, sem configuração. Usa o modelo escolhido acima (local ou na nuvem). Para o modelo trabalhar dentro de uma pasta, volte e escolha “Novo projeto” ou “Abrir uma pasta de projeto”."
  ],
  [
    ...
    "ऐप के बारे में मुझसे कुछ भी पूछें — क्या टूटा, कोई पेज क्या करता है, क्या आज़माएँ…",
    "Pergunte qualquer coisa sobre o app — o que quebrou, o que uma página faz, o que tentar…"
  ],
  [
    "Ask-only prompt",
    "仅提问提示",
    ...
    "सिर्फ़ पूछने के लिए prompt",
    "Prompt apenas para perguntas"
  ],
  [
    "Ask, discuss, review — nothing is modified in chat mode…",
    "提问、讨论、审查 — 聊天模式下不会修改任何内容…",
    ...
    "पूछें, चर्चा करें, review करें — chat mode में कुछ भी modify नहीं होता…",
    "Pergunte, discuta, revise — nada é modificado no modo chat…"
  ],
  [
    ...
    "पूछें, edit करें या agent task चलाएँ। commands के लिए / और context के लिए # टाइप करें।",
    "Pergunte, edite ou execute uma tarefa do agente. Digite / para comandos, # para contexto."
  ],
  [
    "Asset Preview",
    "资产预览",
  ...
  [
    ...
    "boot के समय, BIOS/UEFI में जाने के लिए।",
    "na inicialização para entrar no BIOS/UEFI."
  ],
  [
    ...
    "सबसे ऊपर) से कोई team template चुनें, या नया शुरू करें",
    "no topo) para escolher um template de equipe, ou comece um novo com"
  ],
  [
    "Attach a file",
    "附加文件",
  ...
  [
    ...
    "इमेज attach करें (या बस paste कर दें)",
    "Anexar imagem (ou simplesmente cole uma)"
  ],
  [
    "Attach image(s)",
    "附加图片",
  ...
  [
    ...
    "ऑटो (हर task के हिसाब से चुनाव)",
    "Auto (seleção por tarefa)"
  ],
  [
    ...
    "ऑटो (पहले लोकल चलाता है)",
    "Auto (executa local primeiro)"
  ],
  [
    "Auto mode",
    "自动模式",
  ...
  [
    ...
    "ऑटो मोड OFF है — agents अनुमति का इंतज़ार करते हैं",
    "Modo automático DESLIGADO — os agentes aguardam aprovação"
  ],
  [
    "Auto mode is ON — agents auto-accept tool calls",
    "自动模式已开启 — 代理自动接受工具调用",
    "자동 모드가 켜져 있음 — 에이전트가 도구 호출을 자동으로 수락합니다",
    "自動モードはオン — エージェントはツール呼び出しを自動承認します",
    "الوضع التلقائي مفعل — الوكلاء يقبلون استدعاءات الأدوات تلقائيًا",
    "La modalità automatica è ACCESA — gli agenti accettano automaticamente le chiamate dello strumento",
    "ऑटो मोड ON है — agents tool calls अपने आप स्वीकार कर लेते हैं",
    "Modo automático LIGADO — os agentes aceitam chamadas de ferramentas automaticamente"
  ],
  [
    "Auto voice",
    "自动语音",
  ...
  [
    ...
    "हर tool call अपने आप approve करें",
    "Aprovar automaticamente toda chamada de ferramenta"
  ],
  [
    ...
    "हर tool call अपने आप approve करें (सिर्फ़ personal bots के लिए)",
    "Aprovar automaticamente toda chamada de ferramenta (apenas para bots pessoais)"
  ],
  [
    ...
    "tool requests अपने आप approve करें",
    "aprovar automaticamente solicitações de ferramentas"
  ],
  [
    "Auto-captured record of recent agent work — local to this PC, capped",
    "最近代理工作的自动记录 — 仅保存在本机，容量有限",
    "최근 에이전트 작업의 자동 기록 — 이 PC에 로컬 저장, 용량 제한",
    ...
    "हाल के agent काम का अपने आप कैप्चर हुआ रिकॉर्ड — इसी PC पर लोकल, सीमित",
    "Registro capturado automaticamente do trabalho recente dos agentes — local neste PC, com limite"
  ],
  [
    ...
    "अपने आप detect हुआ — जैसे npm run build · cargo check · pytest -q",
    "detectado automaticamente — ex.: npm run build · cargo check · pytest -q"
  ],
  [
    ...
    "merge के बाद auto-doc",
    "documentação automática após o merge"
  ],
  [
    ...
    "Auto-feed (guidato da un'altra pagina)",
    "Auto-feed (दूसरा पेज चला रहा है)",
    "Auto-feed (outra página controla)"
  ],
  [
    ...
    "自动馈送由该项目的另一页面驱动。取消勾选可在所有页面停止；之后重新勾选可从此页面驱动。",
    ...
    "Auto-feed इस project के किसी दूसरे पेज से चल रहा है। हर जगह रोकने के लिए अनचेक करें; बाद में फिर चेक करके इसी पेज से चलाएँ।",
    "O auto-feed está sendo controlado por outra página deste projeto. Desmarque para pará-lo em todo lugar; marque novamente depois para controlá-lo a partir desta página."
  ],
  [
    "Auto-feed next step",
    "自动馈送下一步",
    ...
    "अगला step auto-feed करें",
    "Auto-feed do próximo passo"
  ],
  [
    "auto-generated",
    "自动生成",
  ...
  [
    ...
    "ऑटो-इंस्टॉल सिर्फ़ Windows पर है।",
    "A instalação automática é somente para Windows."
  ],
  [
    ...
    "/auth अपने आप चल रहा है — Google sign-in चुनें, फिर browser flow पूरा करें।",
    "executando /auth automaticamente — escolha o login com Google e conclua o fluxo no navegador."
  ],
  [
    ...
    "/login अपने आप चल रहा है — browser में sign-in पूरा करें।",
    "executando /login automaticamente — conclua o login no navegador."
  ],
  [
    "Auto-start",
    "自动启动",
  ...
  [
    ...
    "ऑटो-स्टार्ट OFF — यह server तभी चलता है जब आप Start क्लिक करते हैं।",
    "Início automático DESLIGADO — este servidor só roda quando você clica em Iniciar."
  ],
  [
    ...
    "ऑटो-स्टार्ट ON — यह server पहली agent run पर अपने आप शुरू हो जाता है (या अभी Start क्लिक करें)।",
    "Início automático LIGADO — este servidor sobe automaticamente na primeira execução de agente (ou clique em Iniciar agora)."
  ],
  [
    ...
    "ऐप शुरू होते ही ऑटो-स्टार्ट",
    "Início automático ao abrir o app"
  ],
  [
    ...
    "ऑटो: OWLLM आपके GPU की VRAM के हिसाब से context window चुनता है (24 GB कार्ड पर ≈32K, छोटे पर कम)। agentic teams के लिए काफ़ी बड़ा; अगर कोई model फिर भी load न हो तो manually कम करें।",
    "Auto: o OWLLM escolhe uma janela de contexto que cabe na VRAM da sua GPU (≈32K em uma placa de 24 GB, menos nas menores). Grande o suficiente para equipes agênticas; reduza manualmente se um modelo ainda não carregar."
  ],
  [
    "Autofill login",
    "自动填充登录",
  ...
  [
    ...
    "जो भी search backend configure हो, अपने आप उसी का इस्तेमाल करता है — एक",
    "Usa automaticamente o backend de busca que estiver configurado — um"
  ],
  [
    "available",
    "可用",
  ...
  [
    ...
    "अपने आप model चुनने पर वापस जाएँ",
    "Voltar à escolha automática de modelo"
  ],
  [
    "Back to menu",
    "返回菜单",
  ...
  [
    ...
    "डिफ़ॉल्ट team model पर वापस",
    "Voltar ao modelo padrão da equipe"
  ],
  [
    ...
    "project सूची पर वापस (आपकी फ़ाइलें disk पर बनी रहती हैं)",
    "Voltar à lista de projetos (seus arquivos permanecem no disco)"
  ],
  [
    "BASE",
    "基础",
  ...
  [
    ...
    "बेस — आपके Chat/Server से अलग format",
    "bases — um formato diferente do seu Chat/Server"
  ],
  [
    "bash",
    "Bash",
  ...
  [
    ...
    "असली device की तरह व्यवहार करता है — मोबाइल पर web app कैसा दिखता है, यह टेस्ट करने के लिए इस्तेमाल करें।",
    "se comporta como em um dispositivo real — use para testar como um web app aparece no celular."
  ],
  [
    "below to keep them.",
    "下面以保存它们。",
    ...
    "नीचे, उन्हें बनाए रखने के लिए।",
    "abaixo para mantê-los."
  ],
  [
    "below.",
    "下面。",
  ...
  [
    ...
    "नीचे। इसे store किया जाएगा यहाँ:",
    "abaixo. Ele será armazenado em"
  ],
  [
    "BF16",
    "BF16",
  ...
  [
    ...
    "Bot token · gateway WebSocket · public URL की ज़रूरत नहीं",
    "Token do bot · WebSocket do gateway · sem necessidade de URL pública"
  ],
  [
    ...
    "@BotFather से bot token · long-poll · public URL की ज़रूरत नहीं",
    "Token do bot do @BotFather · long-poll · sem necessidade de URL pública"
  ],
  [
    ...
    "Developer Portal से bot token",
    "Token do bot do Developer Portal"
  ],
  [
    ...
    "आपके Slack app का bot token (xoxb- से शुरू होता है)। api.slack.com/apps पर नया app बनाएँ।",
    "Token do bot do seu app Slack (começa com xoxb-). Crie um novo app em api.slack.com/apps."
  ],
  [
    "bot@example.com",
    "bot@example.com",
  ...
  [
    ...
    "Brainstorm के लिए project folder चाहिए — Project settings खोलकर सेट करने के लिए क्लिक करें",
    "O Brainstorm precisa de uma pasta de projeto — clique para abrir as configurações do Projeto e definir uma"
  ],
  [
    ...
    "Brainstorm: co-founder chat → research → team चलने से पहले BRIEF.md",
    "Brainstorm: chat de cofundador → pesquisa → BRIEF.md antes de a equipe rodar"
  ],
  [
    ...
    "Brainstormer role load नहीं हुआ (resources/agents/roles/brainstormer.yaml)।",
    "Papel de Brainstormer não carregado (resources/agents/roles/brainstormer.yaml)."
  ],
  [
    "Branch",
    "分支",
  ...
  [
    ...
    "लक्ष्य को क्रमबद्ध steps में बाँटें, फिर उन्हें एक-एक करके बनाएँ (Kanban)",
    "Divida o objetivo em passos ordenados e construa um por um (Kanban)"
  ],
  [
  ...
  [
    ...
    "Categories, ratings और one-click install configs के साथ browse करने लायक web directory।",
    "Diretório web navegável com categorias, avaliações e configurações de instalação em um clique."
  ],
  [
    "browse",
    "浏览",
  ...
  [
    ...
    "Output directory खोलें",
    "Abrir o diretório de saída"
  ],
  [
    ...
    "पूरा MCP universe browse करें",
    "Explore o universo MCP completo"
  ],
  [
    "Browse…",
    "浏览…",
  ...
  [
    ...
    "पेज का content पढ़ने के लिए browser_get_text।",
    "browser_get_text para ler o conteúdo da página."
  ],
  [
    ...
    "browser_snapshot। index पाने के लिए पहले snapshot लें।",
    "browser_snapshot. Faça um snapshot primeiro para obter o índice."
  ],
  [
    "BSA…",
    "BSA…",
  ...
  [
    ...
    "HOST पर एक signed OwLLM release build, sign और publish करें (चलाता है vetted",
    "Compile, assine e publique uma release assinada do OwLLM no HOST (executa o script aprovado"
  ],
  [
    ...
    "compila e firma la release su questa macchina (serve la toolchain di build + il certificato qui).",
    "release इसी मशीन पर build और sign करता है (यहाँ build toolchain + cert चाहिए)।",
    "compila e assina a release nesta máquina (precisa da toolchain de build + certificado aqui)."
  ],
  [
    "Built-in",
    "内建",
  ...
  [
    ...
    "बिल्ट-इन · Save इसे वहीं edit कर देता है (override के रूप में)",
    "integrado · Salvar edita no lugar (como um override)"
  ],
  [
    "Built-in agent — Duplicate it first to give your copy skills.",
    "内置代理 — 首先复制它以赋予你的副本技能。",
    "내장 에이전트 — 복제본에 스킬을 부여하려면 먼저 복제하세요.",
    "組み込みエージェント — まずそれを複製して、コピーのスキルを付与してください。",
    "وكيل مدمج — كرّره أولًا لتمنح نسختك المهارات.",
    "Agente integrato — Duplicalo prima per dare skill alla tua copia.",
    "बिल्ट-इन agent — अपनी copy को skills देने के लिए पहले इसे Duplicate करें।",
    "Agente integrado — Duplique-o primeiro para dar skills à sua cópia."
  ],
  [
    ...
    "बिल्ट-इन best practice — किसी भी rule की तरह edit या delete करें",
    "Boa prática integrada — edite ou exclua como qualquer regra"
  ],
  [
    "Built-in tools",
    "内置工具",
  ...
  [
    ...
    "पहले tauri.conf.json में version बढ़ाएँ, commit, push और tag करें, फिर इसे call करें।",
    "Primeiro atualize a versão no tauri.conf.json, faça commit, push e tag, depois chame isto."
  ],
  [
    "By status",
    "按状态",
  ...
  [
    ...
    "इसे तब call करें जब task किसी ऐसी skill से मेल खाए जिसका body आपने load नहीं किया है",
    "Chame isto quando a tarefa corresponder a uma skill cujo corpo você ainda não carregou"
  ],
  [
    "Can dispatch",
    "可以分派",
  ...
  [
    ...
    "क्या यह agent दूसरे agents को sub-tasks dispatch कर सकता है? Orchestrators (और Team Leaders) के लिए यह ON होना चाहिए। Specialists आमतौर पर इसे OFF रखते हैं ताकि वे अपने काम पर ध्यान दें और काम न फैलाएँ।",
    "Este agente pode despachar subtarefas para OUTROS agentes? Orquestradores (e líderes de equipe) precisam disso ligado. Especialistas geralmente deixam desligado para focar no próprio trabalho e não distribuir tarefas."
  ],
  [
    ...
    "Save नहीं हो सकता: disk पर कोई path नहीं (built-in role या unloaded)। पहले Duplicate क्लिक करें।",
    "Não é possível salvar: sem caminho no disco (papel integrado ou não carregado). Clique primeiro em Duplicar."
  ],
  [
    "cancel",
    "取消",
  ...
  [
    ...
    "इस app window को capture करें और screen पर जो है उसके बारे में model से पूछें।",
    "Capture esta janela do app e pergunte ao modelo sobre o que está na tela."
  ],
  [
    "Card colour",
    "卡片颜色",
  ...
  [
    ...
    "청크 간에 이월되는 문자",
    "チャンク間で運ばれる文字",
    "الأحرف المنقولة بين الأجزاء",
    "Caratteri trasportati tra i blocchi",
    "chunks के बीच carry होने वाले अक्षर",
    "Caracteres transportados entre os chunks"
  ],
  [
    "chars)",
    "字符)",
  ...
  [
    ...
    "देखा जा रहा है कि कौन से environments install हैं…",
    "Verificando quais ambientes estão instalados…"
  ],
  [
    "Checking...",
    "检查中...",
  ...
  [
    ...
    "download करने के लिए weights चुनें",
    "Escolha os pesos para baixar"
  ],
  [
    ...
    "अपना certificate चुनें (Keychain से .p12, या Apple से मिला .cer)",
    "Escolha seu certificado (.p12 do Keychain, ou o .cer baixado da Apple)"
  ],
  [
    "Chunk size",
    "块大小",
  ...
  [
    ...
    "CI / GitHub Actions — قم بعمل push للـ tag ودع سير العمل يتولى البناء",
    "CI / GitHub Actions — fai push del tag e lascia che il workflow faccia la build",
    "CI / GitHub Actions — tag push करें, workflow को build करने दें",
    "CI / GitHub Actions — faça push da tag e deixe o workflow fazer o build"
  ],
  [
    "CI mode",
    "CI 模式",
  ...
  [
    ...
    "Classic token जिसमें",
    "Token clássico com o"
  ],
  [
    "clear",
    "清除",
  ...
  [
    ...
    "chat window और सारी saved chat history साफ़ करें",
    "Limpar a janela de chat e todo o histórico de chat salvo"
  ],
  [
    ...
    "chat window और सारी saved chat history साफ़ करें? इसे undo नहीं किया जा सकता।",
    "Limpar a janela de chat e todo o histórico de chat salvo? Isso não pode ser desfeito."
  ],
  [
    ...
    "मौजूदा run साफ़ करें (tasks, drafts और run state) लेकिन chat रखें",
    "Limpar a execução atual (tarefas, rascunhos e estado da execução), mantendo o chat"
  ],
  [
    ...
    "draft का text साफ़ करें",
    "Limpar o texto do rascunho"
  ],
  [
  ...
  [
    ...
    "नई idea शुरू करने के लिए यह बातचीत और इसका saved checkpoint साफ़ करें",
    "Limpar esta conversa e seu checkpoint salvo para começar uma nova ideia"
  ],
  [
    ...
    "working notes साफ़ करके नया note शुरू करें",
    "Limpar as notas de trabalho e começar uma nota nova"
  ],
  [
    "CLI logged in",
    "CLI 已登录",
  ...
  [
    ...
    "CLI install / login नहीं है",
    "CLI não instalado / não conectado"
  ],
  [
    ...
    "CLI signed in हो; वरना इस्तेमाल करें",
    "CLI conectado; caso contrário, use"
  ],
  [
    ...
    "'Get Started' क्लिक करें → sign up करें → 'Subscriptions' → 'Free' plan → 'API Keys' टैब।",
    "Clique em 'Get Started' → cadastre-se → 'Subscriptions' → plano 'Free' → aba 'API Keys'."
  ],
  [
    ...
    "Select करने के लिए क्लिक + drag करें, फिर copy के लिए Ctrl-C। या नीचे 'Copy API URL' इस्तेमाल करें।",
    "Clique e arraste para selecionar, depois Ctrl-C para copiar. Ou use 'Copiar URL da API' abaixo."
  ],
  [
    ...
    "बाईं ओर किसी मॉडल कार्ड पर क्लिक करें और उसका विवरण यहाँ देखें।",
    "Clique em um card de modelo à esquerda para ver seus detalhes aqui."
  ],
  [
    ...
    "बाईं ओर किसी skill पर क्लिक करके देखें कि वह क्या करती है,",
    "Clique em uma skill à esquerda para ver o que ela faz,"
  ],
  [
    ...
    "किसी skill पर क्लिक करके उसका SKILL.md प्रीव्यू करें",
    "Clique em uma skill para pré-visualizar seu SKILL.md"
  ],
  [
    ...
    "Clicca su un agente sul canvas per vedere le sue informazioni qui.",
    "कैनवास पर किसी एजेंट पर क्लिक करें और उसकी जानकारी यहाँ देखें।",
    "Clique em um agente no canvas para ver suas informações aqui."
  ],
  [
    ...
    "बाईं ओर किसी एजेंट पर क्लिक करके उसे जाँचें या एडिट करें।",
    "Clique em um agente à esquerda para inspecioná-lo ou editá-lo."
  ],
  [
    ...
    "Add डायलॉग को पहले से भरने के लिए किसी पर भी क्लिक करें",
    "clique em qualquer um para preencher previamente o diálogo Adicionar"
  ],
  [
    ...
    "انقر على 'اتصال' في أي اشتراك مدعوم بـ CLI لفتح طرفية مباشرة هنا.",
    "Clicca Connetti su qualsiasi abbonamento supportato dalla CLI per aprire un terminale live qui.",
    "किसी भी CLI-आधारित सब्सक्रिप्शन पर Connect क्लिक करें और यहाँ एक लाइव टर्मिनल खोलें।",
    "Clique em Conectar em qualquer assinatura baseada em CLI para abrir um terminal ao vivo aqui."
  ],
  [
    ...
    "Clicca Fetch / aggiorna per clonare questa fonte e scoprire le skill.",
    "इस source को clone करने और skills खोजने के लिए Fetch / refresh क्लिक करें।",
    "Clique em Fetch / atualizar para clonar esta fonte e descobrir skills."
  ],
  [
    ...
    "नवीनतम browser_snapshot में दिए गए index वाले इंटरैक्टिव एलिमेंट पर क्लिक करें।",
    "Clique no elemento interativo no índice fornecido do browser_snapshot mais recente."
  ],
  [
  ...
  [
    ...
    "انقر لتمكين وحدة GPU هذه للاستدلال",
    "Clicca per abilitare questa GPU per l'inferenza",
    "इस GPU को inference के लिए इनेबल करने हेतु क्लिक करें",
    "Clique para habilitar esta GPU para inferência"
  ],
  [
    ...
    "विस्तार के लिए क्लिक करें · Ctrl+A इस बॉक्स को सिलेक्ट करता है",
    "Clique para expandir · Ctrl+A seleciona esta caixa"
  ],
  [
    ...
    "पूरा log खोलने के लिए क्लिक करें",
    "Clique para abrir o log completo"
  ],
  [
    ...
    "इस एजेंट के लिए कोई दूसरा आइकन चुनने हेतु क्लिक करें",
    "Clique para escolher um ícone diferente para este agente"
  ],
  [
    ...
    "{0} की chat देखने के लिए क्लिक करें — नाम पर क्लिक करके मॉडल · रंग · prompt एडिट करें",
    "Clique para ver o chat de {0} — clique no nome para editar modelo · cor · prompt"
  ],
  [
    ...
    "Clona o fai fast-forward della fonte",
    "Source को clone या fast-forward करें",
    "Clonar ou fazer fast-forward da fonte"
  ],
  [
    "Close",
    "关闭",
  ...
  [
    ...
    "닫기 (셸 종료)",
    "閉じる（シェルを終了）",
    "إغلاق (يُنهي جلسة الـ shell)",
    "Chiudi (termina la shell)",
    "बंद करें (shell समाप्त हो जाएगा)",
  ...
  [
    ...
    "बंद करें (या खाली कैनवास पर क्लिक करें)",
    "Fechar (ou clique no canvas vazio)"
  ],
  [
    "Close page",
    "关闭页面",
  ...
  [
    ...
    "दूसरे एजेंट का पेन बंद करें",
    "Fechar o painel do segundo agente"
  ],
  [
    "Close this page",
    "关闭此页面",
  ...
  [
    ...
    "यह पेज बंद करें (इसका worktree हटा दिया जाता है)",
    "Fechar esta página (seu worktree é removido)"
  ],
  [
    ...
    "このページを閉じますか？プライベートな作業ツリー（{0}）と未マージの変更はすべて削除されます。保持するには先にマージしてください。",
    ...
    "यह पेज बंद करें? इसका निजी worktree ({0}) और सभी unmerged बदलाव हटा दिए जाएँगे। उन्हें रखने के लिए पहले merge करें।",
    "Fechar esta página? Seu worktree privado ({0}) e quaisquer alterações não mescladas serão removidos. Faça merge antes para mantê-los."
  ],
  [
    ...
    "यह पैनल बंद करें (browser एजेंट्स के लिए चलता रहेगा)",
    "Fechar este painel (o browser continua rodando para os agentes)"
  ],
  [
    ...
    "यह प्रोजेक्ट बंद करें? इसके worktree ({0}) के unmerged बदलाव खो जाएँगे। उन्हें रखने के लिए पहले main में merge करें।",
    "Fechar este projeto? Alterações não mescladas no worktree ({0}) serão descartadas. Faça merge para a main antes para mantê-las."
  ],
  [
    ...
    "स्थायी browser सत्र बंद/स्टॉप करें। बाद में browser_open से फिर खोलें।",
    "Fechar/parar a sessão persistente do browser. Reabra depois com browser_open."
  ],
  [
    ...
    "Sandbox में क्लाउड अकाउंट",
    "Contas de nuvem no sandbox"
  ],
  [
    "CN=Your Company",
    "CN=您的公司",
  ...
  [
    ...
    "Co-founder chat → रिसर्च (प्रतिस्पर्धी, OSS, असली समस्याएँ) → BRIEF.md → टीम बनाएँ",
    "Chat com o cofundador → pesquisa (concorrentes, OSS, dores reais) → BRIEF.md → montar uma equipe"
  ],
  [
    ...
    "Co-founder सोच रहा है…",
    "O cofundador está pensando…"
  ],
  [
    "Code page session",
    "代码页面会话",
    ...
    "コードページセッション",
    "جلسة صفحة Code",
    "Sessione della pagina Code",
    "Code पेज सत्र",
    "Sessão da página Code"
  ],
  [
    "Code review",
    "代码审查",
  ...
  [
    ...
    "عمل commit لـ {0} تغيير(ات) في مساحة العمل هذه",
    "Fai commit di {0} modifica/e in questo workspace",
    "इस workspace में {0} बदलाव commit करें",
    "Fazer commit de {0} alteração(ões) neste workspace"
  ],
  [
    "Commit all",
    "提交全部",
  ...
  [
    ...
    "عمل commit لكل التغييرات في مساحة العمل هذه",
    "Fai commit di tutte le modifiche in questo workspace",
    "इस workspace के सभी बदलाव commit करें",
    "Fazer commit de todas as alterações neste workspace"
  ],
  [
    "Commit message…",
    "提交信息…",
  ...
  [
    ...
    "社区精选的长尾 — 涵盖各种可以想到的类别的 200 多个服务器。",
    "커뮤니티 큐레이션 롱테일 — 상상할 수 있는 모든 카테고리에 걸쳐 200개 이상의 서버.",
    "コミュニティがキュレーションしたロングテール — 想像できるあらゆるカテゴリにわたる200以上のサーバー。",
    "الذيل الطويل المنسَّق من المجتمع — أكثر من 200 خادم في كل فئة يمكن تخيلها.",
    "Long tail curata dalla community — oltre 200 server in ogni categoria immaginabile.",
    "समुदाय-चयनित long tail — हर कल्पनीय श्रेणी में 200+ सर्वर।",
    "Cauda longa com curadoria da comunidade — mais de 200 servidores em todas as categorias imagináveis."
  ],
  [
    "Complete",
    "完成",
  ...
  [
    ...
    "上記のすべての項目（証明書、両方のパスワード、署名 ID、Apple ID、チーム ID）を入力すると、プッシュが有効になります。",
    ...
    "Push सक्षम करने के लिए ऊपर के सभी फ़ील्ड भरें (सर्टिफ़िकेट, दोनों पासवर्ड, identity, Apple ID, Team ID)।",
    "Preencha todos os campos acima (certificado, as duas senhas, identidade, Apple ID, Team ID) para habilitar o push."
  ],
  [
    "Completed",
    "已完成",
  ...
  [
    ...
    "Avvisi di configurazione dal normalizzatore dei team",
    "टीम normalizer से कॉन्फ़िगरेशन सूचनाएँ",
    "Avisos de configuração do normalizador de equipes"
  ],
  [
  ...
  [
    ...
    "किसी दूसरी मशीन को कॉन्फ़िगर या प्रोग्राम करें — कोई server, Raspberry Pi या दूसरा PC।",
    "configurar ou programar outra máquina — um servidor, Raspberry Pi ou outro PC."
  ],
  [
    "configured",
    "已配置",
  ...
  [
    ...
    "पहले ऊपर GitHub कनेक्ट करें।",
    "Conecte o GitHub acima primeiro."
  ],
  [
    ...
    "निजी repos clone करने, sandbox से push करने के लिए GitHub कनेक्ट करें — और एक repo रखें",
    "Conecte o GitHub para clonar repos privados, fazer push do sandbox — e ter um repo"
  ],
  [
    ...
    "भेजने के लिए GitHub कनेक्ट करें",
    "Conecte o GitHub para enviar"
  ],
  [
    "Connect GitHub…",
    "连接 GitHub…",
  ...
  [
    ...
    "已授权主机 — 代理只能对此处列出的设备进行注入（键入/按键/鼠标/电源/挂载）。截图适用于任何可访问的设备。每个操作都会记录在脱敏的审计日志（kvm_audit.jsonl）中。",
    ...
    "المضيفون الموافَق عليهم — يمكن للوكلاء الحقن (كتابة/مفاتيح/ماوس/طاقة/تركيب) فقط في الأجهزة المدرجة هنا. لقطات الشاشة تعمل لأي جهاز يمكن الوصول إليه. كل إجراء يُسجل في سجل تدقيق محجوب (kvm_audit.jsonl).",
    "Host consentiti — gli agenti possono INIETTARE (digitazione/tasti/mouse/alimentazione/mount) solo nei dispositivi elencati qui. Gli screenshot funzionano per qualsiasi dispositivo raggiungibile. Ogni azione viene registrata in un log di audit redatto (kvm_audit.jsonl).",
    "सहमति-प्राप्त होस्ट — एजेंट केवल यहाँ सूचीबद्ध डिवाइसों में ही INJECT (टाइपिंग/keys/माउस/पावर/mount) कर सकते हैं। स्क्रीनशॉट किसी भी पहुँच योग्य डिवाइस पर काम करते हैं। हर क्रिया redacted ऑडिट log (kvm_audit.jsonl) में दर्ज होती है।",
    "Hosts com consentimento — os agentes só podem INJETAR (digitação/teclas/mouse/energia/mount) nos dispositivos listados aqui. Screenshots funcionam para qualquer dispositivo alcançável. Toda ação é registrada em um log de auditoria com dados ocultados (kvm_audit.jsonl)."
  ],
  [
    ...
    "किसी तथ्य को दोबारा निकालने, उपयोगकर्ता से पूछने या खोजने से पहले सबसे पहले उसे देखें",
    "Consulte isso PRIMEIRO antes de rederivar um fato, perguntar ao usuário ou pesquisar o"
  ],
  [
    ...
    "सामग्री। सटीक (surgical) बदलावों के लिए उपयोग करें — फ़ाइल का बाकी हिस्सा सुरक्षित रहता है।",
    "conteúdo. Use para edições cirúrgicas — preserva o restante do arquivo."
  ],
  [
  ...
  [
    ...
    "중단된 다운로드를 멈춘 지점부터 이어서 진행 (다시 선택하지 않고, 0%부터 다시 시작하지 않음)",
    ...
    "रुका हुआ डाउनलोड वहीं से जारी रखें जहाँ वह रुका था (दोबारा चुनना नहीं, 0% से रीस्टार्ट नहीं)",
    "Continuar o download interrompido de onde parou (sem escolher de novo, sem recomeçar do 0%)"
  ],
  [
    ...
    "इस फ़ोल्डर के साथ जारी रखें — अगले चरण में टीम चुनें",
    "Continuar com esta pasta — escolha a equipe na próxima etapa"
  ],
  [
  ...
  [
    ...
    "नेटवर्क से जुड़े KVM नोड (Sipeed NanoKVM) को लक्ष्य मशीन की आँखों + हाथों की तरह नियंत्रित करें।",
    "Controle um nó KVM em rede (Sipeed NanoKVM) como os olhos + mãos da máquina alvo."
  ],
  [
    ...
    "अपनी अन्य OwLLM मशीनों को नियंत्रित करें। Pairing + एक क्रिप्टोग्राफ़िक डिवाइस key ज़रूरी है — सिर्फ़ GitHub लॉगिन से कभी नियंत्रण नहीं मिलता।",
    "Controle suas outras máquinas OwLLM. O pareamento + uma chave criptográfica do dispositivo são obrigatórios — um login do GitHub sozinho nunca concede controle."
  ],
  [
    ...
    "डिवाइस का नियंत्रण इनके पार भी काम करता है",
    "O controle de um dispositivo funciona através de"
  ],
  [
    "Convert failed: {0}",
    "转换失败：{0}",
  ...
  [
    ...
    "उपयोगकर्ता की SSH keys से SSH/SCP के ज़रिए एक LOCAL फ़ाइल को REMOTE होस्ट पर कॉपी करें।",
    "Copiar um arquivo LOCAL para um host REMOTO via SSH/SCP usando as chaves SSH do usuário."
  ],
  [
    ...
    "उपयोगकर्ता की SSH keys से SSH/SCP के ज़रिए एक REMOTE फ़ाइल को LOCAL मशीन पर कॉपी करें।",
    "Copiar um arquivo REMOTO para a máquina LOCAL via SSH/SCP usando as chaves SSH do usuário."
  ],
  [
    "Copy into workspace",
    "复制到工作区",
  ...
  [
    ...
    "LAN URL क्लिपबोर्ड पर कॉपी करें",
  ...
  [
    ...
    "फ़ाइल को प्रोजेक्ट फ़ोल्डर में कॉपी करें (अनुशंसित)",
    "Copiar o arquivo para a pasta do projeto (recomendado)"
  ],
  [
    ...
    "मॉडल आइडेंटिफ़ायर क्लिपबोर्ड पर कॉपी करें।",
    "Copiar o identificador do modelo para a área de transferência."
  ],
  [
    ...
    "OpenAI-संगत base URL क्लिपबोर्ड पर कॉपी करें।",
    "Copiar a URL base compatível com OpenAI para a área de transferência."
  ],
  [
    ...
    "この隔離されたプロジェクトを通常のフォルダー（隔離されていない）にコピーして、そのコピーを開きますか？隔離された元のプロジェクトはサンドボックスに残ります。",
    ...
    "इस isolated प्रोजेक्ट को बाहर एक सामान्य फ़ोल्डर (isolated नहीं) में कॉपी करके कॉपी खोलें? Isolated मूल sandbox में ही रहेगा।",
    "Copiar este projeto isolado PARA FORA, em uma pasta normal (NÃO isolada), e abrir a cópia? O original isolado permanece no sandbox."
  ],
  [
    "Copy this project INTO the Linux sandbox (isolated) and open it",
    "将此项目复制到 Linux 沙箱（隔离）并打开它",
    "이 프로젝트를 리눅스 샌드박스(격리)로 복사하고 엽니다",
    "このプロジェクトをLinuxサンドボックス（隔離）にコピーして開く",
    "نسخ هذا المشروع إلى صندوق لينكس (معزول) وفتحه",
    "Copia questo progetto DENTRO la sandbox di Linux (isolata) e aprilo",
    "इस प्रोजेक्ट को Linux sandbox (isolated) में कॉपी करके खोलें",
    "Copiar este projeto PARA DENTRO do sandbox Linux (isolado) e abri-lo"
  ],
  [
    ...
    "このプロジェクトをLinuxサンドボックス（隔離）にコピーして、そのコピーを開きますか？元のフォルダーはそのまま残ります。",
    ...
    "इस प्रोजेक्ट को Linux sandbox (isolated) में कॉपी करके कॉपी खोलें? मूल फ़ोल्डर अपनी जगह रहेगा।",
    "Copiar este projeto PARA DENTRO do sandbox Linux (isolado) e abrir a cópia? A pasta original permanece onde está."
  ],
  [
    ...
    "इस प्रोजेक्ट को Linux sandbox में कॉपी करके कॉपी पर स्विच करें? मूल फ़ोल्डर अपनी जगह रहेगा। बड़े repo में एक मिनट लग सकता है।",
    "Copiar este projeto para o sandbox Linux e mudar para a cópia? A pasta original permanece onde está. Um repo grande pode levar um minuto."
  ],
  [
    "Copy this project OUT to a normal (not isolated) folder and open it",
    "将此项目复制到普通（非隔离）文件夹并打开它",
    "이 프로젝트를 일반(격리되지 않은) 폴더로 복사하고 열기",
    "このプロジェクトを通常の（隔離されていない）フォルダーにコピーして開く",
    "نسخ هذا المشروع إلى مجلد عادي (ليس معزولًا) وفتحه",
    "Copia questo progetto FUORI in una cartella normale (non isolata) e aprilo",
    "इस प्रोजेक्ट को बाहर एक सामान्य (isolated नहीं) फ़ोल्डर में कॉपी करके खोलें",
    "Copiar este projeto PARA FORA, em uma pasta normal (não isolada), e abri-lo"
  ],
  [
    "Copy values",
    "复制数值",
  ...
  [
    ...
    "दिखाई दे रही log लाइनें क्लिपबोर्ड पर कॉपी करें।",
    "Copiar as linhas de log visíveis para a área de transferência."
  ],
  [
    ...
    "Sandbox में कॉपी हो रहा है…",
    "Copiando para o sandbox…"
  ],
  [
    ...
    "Copia dalla sandbox…",
    "Sandbox से बाहर कॉपी हो रहा है…",
    "Copiando para fora do sandbox…"
  ],
  [
    "Copying…",
    "复制中…",
  ...
  [
    ...
    "Webhook पोर्ट बाइंड नहीं हो सका।",
    "Não foi possível vincular a porta do webhook."
  ],
  [
    ...
    "मॉड्यूल रजिस्ट्री लोड नहीं हो सकी",
    "Não foi possível carregar o registro de módulos"
  ],
  [
    ...
    "Workbench नहीं खुल सका।",
    "Não foi possível abrir o workbench."
  ],
  [
  ...
  [
    ...
    "फ़ाइलें नहीं जोड़ी जा सकीं: {0}",
    "Não foi possível adicionar os arquivos: {0}"
  ],
  [
    ...
    "Isolation नहीं बदला जा सका: {0}",
    "Não foi possível alterar o isolamento: {0}"
  ],
  [
    ...
    "प्रोजेक्ट नहीं बन सका: {0}",
    "Não foi possível criar o projeto: {0}"
  ],
  [
    ...
    "WSL इंस्टॉल शुरू नहीं हो सका: {0}",
    "Não foi possível iniciar a instalação do WSL: {0}"
  ],
  [
    ...
    "मॉडल लोड नहीं हो सके: {0}",
    "Não foi possível carregar os modelos: {0}"
  ],
  [
    ...
    "Non è stato possibile caricare questo template dal disco — aggiorna e riprova.",
    "यह template डिस्क से लोड नहीं हो सका — रिफ़्रेश करके फिर आज़माएँ।",
    "Não foi possível carregar este template do disco — atualize e tente novamente."
  ],
  [
    ...
    "Impossibile leggere un team dalla risposta del modello — riprova, oppure crea il team sul canvas.",
    "मॉडल के जवाब से टीम नहीं पढ़ी जा सकी — फिर आज़माएँ, या कैनवास पर टीम बनाएँ।",
    "Não foi possível ler uma equipe da resposta do modelo — tente de novo ou monte a equipe no canvas."
  ],
  [
    "CPU:",
    "CPU：",
  ...
  [
    ...
    "एक डायरेक्टरी बनाएँ (और कोई भी लापता parent डायरेक्टरी)।",
    "Criar um diretório (e quaisquer diretórios pais ausentes)."
  ],
  [
  ...
  [
    ...
    "एक नई फ़ाइल बनाएँ या मौजूदा को पूरी तरह फिर से लिखें। Parent डायरेक्टरियाँ",
    "Criar um arquivo NOVO ou reescrever totalmente um existente. Os diretórios pais são"
  ],
  [
  ...
  [
    ...
    "एक निजी GitHub repo बनाएँ",
    "Criar um repo privado no GitHub"
  ],
  [
    ...
    "इस प्रोजेक्ट के लिए एक निजी GitHub रिपॉज़िटरी बनाएँ, उसे origin सेट करें और मौजूदा branch push करें। कनेक्टेड GitHub अकाउंट चाहिए (Accounts पेज)।",
    "Criar um repositório privado no GitHub para este projeto, defini-lo como origin e fazer push da branch atual. Requer uma conta do GitHub conectada (página Contas)."
  ],
  [
    "create a token",
    "创建令牌",
  ...
  [
    ...
    "अपना Linux यूज़र बनाएँ",
    "Criar seu usuário Linux"
  ],
  [
    ...
    "إنشاء فريقك الخاص",
    "Crea il tuo team",
    "अपनी खुद की टीम बनाएँ",
    "Criar sua própria equipe"
  ],
  [
    "CREATE_NO_WINDOW",
    "CREATE_NO_WINDOW",
  ...
  [
    ...
    "अपने आप बन जाती हैं। नया कोड / config लिखते समय इसका उपयोग करें /",
    "criados automaticamente. Use ao escrever código / configs novos /"
  ],
  [
    "created for you",
    "已为你创建",
  ...
  [
    ...
    "आपके GitHub अकाउंट पर प्रोजेक्ट के नाम से एक PRIVATE repository बनाता है, उसे origin के रूप में सेट करता है और शुरुआती branch को push कर देता है — और कुछ सेट करने की ज़रूरत नहीं। आप यह बाद में Publisher कार्ड के ⚙ Set up repo से भी कर सकते हैं।",
    "Cria um repositório PRIVADO na sua conta do GitHub com o nome do projeto, configura-o como origin e faz push do branch inicial — nada mais para configurar. Você também pode fazer isso depois pelo ⚙ Configurar repositório no card do Publisher."
  ],
  [
    "Creating…",
    "创建中…",
  ...
  [
    ...
    "क्रिटिक = सुपर यूज़र (मेरे लिए फ़ैसला करता है)",
    "crítico = superusuário (decide por mim)"
  ],
  [
    ...
    "क्रिटिकल थिंकर — हमेशा मौजूद सलाहकार (Agents पेज पर Director Mode में कॉन्फ़िगर करें)",
    "Pensador Crítico — conselheiro sempre presente (configure no Modo Diretor na página Agentes)"
  ],
  [
    "Ctrl+Enter digests",
    "Ctrl+Enter 消化",
    ...
    "Ctrl+Enter لتلخيص",
    "Ctrl+Enter elabora",
    "Ctrl+Enter से digest करें",
    "Ctrl+Enter faz o digest"
  ],
  [
    "ctx",
    "上下文",
  ...
  [
    ...
    "वर्तमान: {0} किसी दूसरे फ़ोल्डर पर जाने के लिए क्लिक करें",
    "Atual: {0} Clique para trocar para outra pasta"
  ],
  [
    "custom",
    "自定义",
  ...
  [
    ...
    "कस्टम कॉन्टेक्स्ट साइज़ (tokens)",
    "Tamanho de contexto personalizado (tokens)"
  ],
  [
    "Custom roster",
    "自定义花名册",
  ...
  [
    ...
    "खतरनाक ऐक्शन के लिए आपकी मंज़ूरी ज़रूरी है",
    "Ação perigosa requer sua aprovação"
  ],
  [
    "dark",
    "暗",
  ...
  [
    ...
    "Dataset जस का तस train नहीं हो सकता — {0}",
    "O dataset não pode ser treinado como está — {0}"
  ],
  [
    ...
    "Dataset जाँच विफल: {0}",
    "Falha na verificação do dataset: {0}"
  ],
  [
    ...
    "Dataset में 0 उदाहरण हैं — training के लिए कुछ नहीं।",
    "O dataset tem 0 exemplos — nada para treinar."
  ],
  [
    "Debug Office",
    "调试办公室",
  ...
  [
    ...
    "डिफ़ॉल्ट रीड-ओनली डायग्नोस्टिक्स है। फ़ाइल लिखने और admin कार्यों के लिए भी इस मशीन पर हर ऐक्शन की अलग मंज़ूरी चाहिए (v1 में एक्ज़िक्यूट नहीं होता)।",
    "O padrão é diagnóstico somente leitura. Gravações de arquivo e ações de admin também exigem aprovação por ação nesta máquina (não executável na v1)."
  ],
  [
    "Default mode",
    "默认模式",
  ...
  [
    ...
    "डिफ़ॉल्ट http) — इसे उस वेब ऐप को जाँचने के लिए इस्तेमाल करें जिसे आप बना रहे हैं।",
    "padrão http) — use para verificar um app web que você está construindo."
  ],
  [
    "Definition of Done",
    "完成定义",
  ...
  [
    ...
    "Elimina {0} entr{1} di cache/cestino",
    "{0} cache/trash entr{1} हटाएं",
    "Excluir {0} entr{1} de cache/lixeira"
  ],
  [
    "Delete asset?",
    "删除资源？",
  ...
  [
    ...
    "कस्टम एजेंट '{0}' हटाएं? इसे रेफ़र करने वाली टीमें अपनी-अपनी कॉपी से काम करती रहेंगी।",
    "Excluir o agente personalizado '{0}'? As equipes que o referenciam continuam funcionando com suas próprias cópias."
  ],
  [
    "Delete failed: {0}",
    "删除失败：{0}",
  ...
  [
    ...
    "{0} ({1}) के लिए सेव किया गया लॉगिन हटाएं?",
    "Excluir o login salvo de {0} ({1})?"
  ],
  [
    "Delete the source to reclaim disk? The abliterated copy stays.",
    "删除源以释放磁盘空间？消融后的副本将保留。",
    "디스크 공간을 확보하기 위해 소스를 삭제할까요? 어블리터레이션된 사본은 남아 있습니다.",
    "ディスクを空けるためにソースを削除しますか？アブリタレーション済みのコピーはそのまま残ります。",
    "حذف المصدر لتحرير مساحة القرص؟ النسخة المعالجة بالـ abliteration تبقى.",
    "Eliminare la sorgente per liberare spazio su disco? La copia abliterata rimane.",
    "डिस्क खाली करने के लिए सोर्स हटाएं? Abliterated कॉपी बनी रहेगी।",
    "Excluir a origem para liberar espaço em disco? A cópia abliterada permanece."
  ],
  [
    ...
    "टीम टेम्पलेट '{0}' हटाएं? इससे बने मौजूदा प्रोजेक्ट जस के तस बने रहेंगे।",
    "Excluir o modelo de equipe '{0}'? Os projetos existentes criados a partir dele permanecem intactos."
  ],
  [
    "Delete this memory",
    "删除此记忆",
  ...
  [
    ...
    "फ़ाइन-ट्यून्ड मॉडल \"{0}\" हटाएं? पाथ: {1} यह स्थायी है — डायरेक्टरी और उसकी सभी फ़ाइलें हटा दी जाएंगी।",
    "Excluir o modelo ajustado \"{0}\"? Caminho: {1} Isto é permanente — o diretório e todos os seus arquivos serão removidos."
  ],
  [
    ...
    "Cache/trash हटाया जा रहा है",
    "Excluindo cache/lixeira"
  ],
  [
    "Deleting...",
    "正在删除...",
  ...
  [
    ...
    "2 × r के रूप में निकाला गया (PEFT परंपरा)। प्रभावी स्केलिंग = α / r।",
    "Derivado como 2 × r (convenção PEFT). Escala efetiva = α / r."
  ],
  [
    "Describe the bug",
    "描述错误",
  ...
  [
    ...
    "बदलाव, बग या फ़ीचर का विवरण दें… (इमेज भी पेस्ट/ड्रॉप कर सकते हैं)",
    "Descreva a mudança, o bug ou a funcionalidade… (cole/arraste imagens também)"
  ],
  [
    ...
    "बताएं कि यह एजेंट क्या करता है।",
  ...
  [
    ...
    "बताएं कि क्या गड़बड़ है, फिर यह व्यू + डायग्नोस्टिक्स + कोई भी स्क्रीनशॉट OwLLM टीम को भेजें।",
    "Descreva o problema e envie esta visualização + diagnósticos + qualquer captura de tela para a equipe do OwLLM."
  ],
  [
    "Description",
    "描述",
  ...
  [
    ...
    "अलग-अलग एजेंट डिज़ाइन करें — अवतार, काम और उनके इस्तेमाल के टूल चुनें। बिल्ट-इन एजेंट OWLLM के साथ आते हैं और एडिट नहीं हो सकते; किसी भी बिल्ट-इन पर Duplicate क्लिक करके अपनी कॉपी बनाएं।",
    "Projete agentes individuais — escolha um avatar, uma função e as ferramentas que eles podem usar. Os integrados vêm com o OWLLM e não podem ser editados; clique em Duplicar em qualquer um deles para criar sua própria cópia."
  ],
  [
  ...
  [
    ...
    "इस मशीन पर डेस्टिनेशन पाथ।",
    "Caminho de destino nesta máquina."
  ],
  [
    "detached HEAD",
    "分离的 HEAD",
  ...
  [
    ...
    "Developer ID Application: 본인 이름 (TEAMID)",
    "Developer ID Application: あなたの名前 (TEAMID)",
    "Developer ID Application: اسمك (TEAMID)",
    "Developer ID Application: Il tuo nome (TEAMID)",
    "Developer ID Application: आपका नाम (TEAMID)",
  ...
  [
    ...
    "टास्क के बीच में skill बदलने के लिए कोई दूसरी skill — जितनी बार ज़रूरत हो।",
    "outra skill para trocar de skill no meio da tarefa, quantas vezes forem necessárias."
  ],
  [
    ...
    "다이제스트 에이전트 모델. 기본값: 팀의 모델 (보류 중인 재정의 -> 프로젝트의 팀 모델 -> 로드된 서버 모델).",
    ...
    "Digest एजेंट का मॉडल। डिफ़ॉल्ट: टीम का मॉडल (पेंडिंग ओवरराइड -> प्रोजेक्ट का टीम मॉडल -> लोड किया गया सर्वर मॉडल)।",
    "Modelo do agente de digest. Padrão: o modelo da equipe (override pendente -> modelo de equipe do projeto -> modelo carregado no servidor)."
  ],
  [
    ...
    "मौजूदा नोटबुक को एक साफ़ प्लान और नए फ़ीड करने लायक़ स्टेप्स में digest करें।",
    "Condense o notebook atual em um plano mais claro e novas etapas prontas para alimentar."
  ],
  [
    ...
    "वर्किंग नोट्स, मौजूदा प्लान और मौजूदा स्टेप्स को digest करें",
    "Condense as notas de trabalho, o plano atual e as etapas existentes"
  ],
  [
    "Digest transcript",
    "消化记录",
    ...
    "ट्रांसक्रिप्ट digest करें",
    "Condensar transcrição"
  ],
  [
    "Digesting...",
    "正在消化...",
  ...
  [
    ...
    "डायरेक्टर मोड (क्रिटिक मेरी जगह लेता है)",
    "modo diretor (o crítico me substitui)"
  ],
  [
    ...
    "सर्च के लिए डायरेक्टरी रूट। डिफ़ॉल्ट '.' (प्रोजेक्ट cwd)।",
    "Diretório raiz da busca. Padrão: '.' (cwd do projeto)."
  ],
  [
    ...
    "जिस डायरेक्टरी के अंदर खोजना है। डिफ़ॉल्ट '.' (प्रोजेक्ट cwd)।",
    "Diretório onde buscar. Padrão: '.' (cwd do projeto)."
  ],
  [
    ...
    "자신의 구성원을 직접 지휘합니다 — 하위 오케스트레이터입니다. 상사와 대화하는 것은 이 에이전트뿐이며, 파견하는 에이전트들이 곧 그 팀입니다.",
    ...
    "अपने सदस्यों को खुद निर्देशित करता है — एक सब-ऑर्केस्ट्रेटर। सिर्फ़ यही अपने बॉस से बात करता है; जिन एजेंटों को यह डिस्पैच करता है, वे इसकी टीम हैं।",
    "Dirige seus próprios membros — um sub-orquestrador. Só ele fala com o chefe; os agentes para os quais despacha são sua equipe."
  ],
  [
  ...
  [
    ...
    "비활성화됨 — 에이전트에게 숨겨짐",
    "無効 — エージェントからは隠されています",
    "معطل — مخفي عن الوكلاء",
    "Disabilitato — nascosto agli agenti",
    "अक्षम — एजेंटों से छिपा हुआ",
    "Desativado — oculto dos agentes"
  ],
  [
    "Discard",
    "放弃",
  ...
  [
    ...
    "बदलाव त्यागें और एडिटिंग बंद करें",
    "Descartar alterações e parar de editar"
  ],
  [
    ...
    "प्रस्तावित स्टेप्स त्यागें",
    "Descartar etapas propostas"
  ],
  [
    "Discard steps",
    "放弃步骤",
  ...
  [
    ...
    "प्रस्तावित प्लान त्यागें",
    "Descartar o plano proposto"
  ],
  [
    ...
    "यह नया प्रोजेक्ट त्यागकर बंद करें?",
    "Descartar este novo projeto e fechar?"
  ],
  [
    ...
    "इस फ़ाइल के सेव न किए गए बदलाव त्यागें?",
    "Descartar as alterações não salvas neste arquivo?"
  ],
  [
    "Disconnect",
    "断开连接",
  ...
  [
    ...
    "ऐसी skill खोजें जिसे आप मौजूदा टास्क के लिए load_skill() से कॉन्टेक्स्ट में ला सकें।",
    "descobrir uma skill que você pode carregar com load_skill() no contexto para a tarefa atual."
  ],
  [
    ...
    "सिर्फ़ चर्चा/समीक्षा — न कोई एडिट, न कोई state बदलने वाला कमांड",
    "Apenas discutir/revisar — sem edições, sem comandos que alterem o estado"
  ],
  [
    "Dismiss",
    "忽略",
  ...
  [
    ...
    "डिस्पैच करने (या आउटपुट सौंपने) के लिए",
    "despachar para (ou entregar a saída para)"
  ],
  [
    "dispatched",
    "已分派",
  ...
  [
    ...
    "नए लक्ष्य के रूप में डिस्पैच किया गया",
    "despachado como um novo objetivo"
  ],
  [
    "dispatching",
    "分派中",
  ...
  [
    ...
    "distro — एक स्ट्रिप्ड-डाउन userland, जिसमें नहीं है",
    "distro, um userland enxuto sem"
  ],
  [
    "Docker Desktop's",
    "Docker Desktop 的",
  ...
  [
    ...
    "दस्तावेज़ + URL → instruction/output JSONL",
    "documentos + URLs → JSONL de instrução/saída"
  ],
  [
    "does NOT code-sign",
    "不进行代码签名",
  ...
  [
    ...
    "ऑर्केस्ट्रेटर जो काम डिस्पैच करता है, उसे करता है।",
    "Faz o trabalho que o orquestrador despacha."
  ],
  [
    ...
    "ऐप बंद न करें — तैयार होते ही यह अपने आप रीस्टार्ट हो जाएगा।",
    "Não feche o app — ele reiniciará automaticamente quando estiver pronto."
  ],
  [
    "Don't show again",
    "不再显示",
  ...
  [
    ...
    "पूर्ण — {1} chunk से {0} जोड़ी(यां)। नीचे समीक्षा करें, फिर Save करें।",
    "Concluído — {0} par(es) de {1} bloco(s). Revise abaixo e depois salve."
  ],
  [
    "down_proj",
    "down_proj",
  ...
  [
    ...
    "अपने GPU के लिए लोकल llama.cpp इन्फ़रेंस इंजन डाउनलोड + इंस्टॉल करें",
    "Baixe + instale o motor de inferência local llama.cpp para sua GPU"
  ],
  [
    "Download failed: {0}",
    "下载失败: {0}",
  ...
  [
    ...
    "पहले बेस मॉडल डाउनलोड करें — Base Model के नीचे वाले Download बटन का इस्तेमाल करें।",
    "Baixe o modelo base primeiro — use o botão Baixar em Modelo Base."
  ],
  [
    "downloaded",
    "已下载",
  ...
  [
    ...
    "मॉडल डाउनलोड हो रहा है (~142 MB)",
    "Baixando modelo (~142 MB)"
  ],
  [
    ...
    "whisper.cpp बाइनरी डाउनलोड हो रही है",
    "Baixando o binário do whisper.cpp"
  ],
  [
    "Downloading…",
    "下载中…",
  ...
  [
    ...
    "यहां .jsonl ड्रैग करें, या ब्राउज़ करें...",
    "Arraste um .jsonl aqui ou procure..."
  ],
  [
    ...
    "Trascina da una porta di output blu → rilascia su un'altra scheda per collegare un edge di dispatch. Clicca un edge per selezionarlo, poi ✕ Edge / ⇄ Inverti.",
    "नीले आउटपुट पोर्ट से ड्रैग करें → दूसरे कार्ड पर छोड़कर डिस्पैच edge जोड़ें। किसी edge को चुनने के लिए उस पर क्लिक करें, फिर ✕ Edge / ⇄ Reverse।",
    "Arraste de uma porta de saída azul → solte em outro card para conectar um edge de dispatch. Clique em um edge para selecioná-lo e depois ✕ Edge / ⇄ Inverter."
  ],
  [
    ...
    "Trascina su un altro agente per creare un edge di dispatch",
    "डिस्पैच edge बनाने के लिए दूसरे एजेंट पर ड्रैग करें",
    "Arraste até outro agente para criar um edge de dispatch"
  ],
  [
    "Drag to resize",
    "拖动以调整大小",
  ...
  [
    ...
    "फ़ोन से अपनी एजेंट टीम चलाएं। Telegram को सिर्फ़ एक bot token चाहिए; WhatsApp Cloud API को एक पब्लिक webhook URL चाहिए — लोकल पोर्ट पर एक tunnel (cloudflared / ngrok) पॉइंट करें और वह URL Meta App के webhook कॉन्फ़िग में कॉपी करें।",
    "Controle sua equipe de agentes pelo celular. O Telegram precisa apenas de um token de bot; a API WhatsApp Cloud precisa de uma URL de webhook pública — aponte um túnel (cloudflared / ngrok) para a porta local e copie essa URL na configuração de webhook do App da Meta."
  ],
  [
    "Drop this pair",
    "删除此对",
  ...
  [
    ...
    "복제합니다. 런타임이 이러한 줄을 감지하여 자동으로 저장합니다; 만약",
    ...
    "उसे डुप्लिकेट करके। रनटाइम इन लाइनों को पहचानकर अपने आप सेव कर लेता है; अगर",
    "duplicando-o. O runtime detecta essas linhas e as salva automaticamente; se"
  ],
  [
    "Durable knowledge — synced across your PCs via the vault",
    "持久知识 — 通过保险库在你的电脑间同步",
    "지속적인 지식 — 금고를 통해 PC 간에 동기화됨",
    "耐久性のある知識 — ボールトを通じてPC間で同期されます",
    ...
    "स्थायी नॉलेज — vault के ज़रिए आपके सभी PC पर सिंक होती है",
    "Conhecimento duradouro — sincronizado entre seus PCs pelo vault"
  ],
  [
    "e.g. . · owllm-desktop",
    "例如 . · owllm-desktop",
  ...
  [
    ...
    "जैसे: एक Gmail-नेटिव CRM जिसे मैं अपने बिज़नेस कॉन्टैक्ट्स के लिए इस्तेमाल कर सकूं। या: एक वर्कआउट ट्रैकर जो मेरी हिस्ट्री से सीखकर अगले हफ़्ते का प्लान सुझाए।",
    "ex.: Um CRM nativo do Gmail que eu possa usar para meus contatos de negócios. Ou: um rastreador de treinos que aprende com meu histórico e sugere o plano da próxima semana."
  ],
  [
    ...
    "जैसे: WSL तैयार होने के बावजूद एजेंट आइसोलेटेड नहीं चलते — यह मुझे training env इंस्टॉल करने को कहता है, जिसका कोई मतलब नहीं है।",
    "ex.: Os agentes não rodam isolados mesmo com o WSL pronto — ele me manda instalar o ambiente de treinamento, o que não faz sentido."
  ],
  [
    ...
    "जैसे bash scripts/publish.sh --notes \"$OWLLM_RELEASE_NOTES\"",
    "ex.: bash scripts/publish.sh --notes \"$OWLLM_RELEASE_NOTES\""
  ],
  [
    ...
    "जैसे esp-flash, cleanup-pr, paper-draft",
    "ex.: esp-flash, cleanup-pr, paper-draft"
  ],
  [
    "e.g. my-app",
    "例如 my-app",
  ...
  [
    ...
    "जैसे: कभी mock डेटा नहीं — हमेशा असली DB कॉल",
    "ex.: nunca simular dados — sempre chamadas reais ao DB"
  ],
  [
    ...
    "जैसे package.json · src-tauri/tauri.conf.json",
    "ex.: package.json · src-tauri/tauri.conf.json"
  ],
  [
  ...
  [
    ...
    "जैसे your-org/your-app — खाली = publish स्क्रिप्ट का डिफ़ॉल्ट",
    "ex.: your-org/your-app — vazio = padrão do script de publicação"
  ],
  [
    ...
    "जनरेट किया गया हर instruction/output पेयर समीक्षा के लिए यहाँ दिखेगा।",
    "Cada par de instrução/saída gerado aparecerá aqui para revisão."
  ],
  [
    ...
    "يحصل كل مزوّد على بطاقة واحدة فيها طريقتا الوصول: الاشتراك (تسجيل الدخول عبر CLI أو بوابة الويب) ومفتاح API. مخرجات التثبيت / الاتصال تُبث مباشرة في السجل على الجانب الأيمن — دون وحدة تحكم منبثقة.",
    "Ogni provider riceve una scheda con entrambi i modi per accedervi: abbonamento (login CLI o portale web) e chiave API. L'output di Installa / Connetti viene trasmesso in tempo reale nel log sul lato destro — nessuna console pop-out.",
    "हर provider को एक कार्ड मिलता है जिसमें उस तक पहुँचने के दोनों तरीके होते हैं: सब्सक्रिप्शन (CLI लॉगिन या वेब पोर्टल) और API key। Install / Connect का आउटपुट दाईं ओर के log में लाइव स्ट्रीम होता है — कोई अलग pop-out कंसोल नहीं।",
    "Cada provedor recebe um card com as duas formas de acesso: assinatura (login via CLI ou portal web) e chave de API. A saída de Instalar / Conectar é transmitida ao vivo no log à direita — sem console pop-out."
  ],
  [
    "edge",
    "边缘",
  ...
  [
    ...
    "{0} एडिट करें — मॉडल · रंग · prompt",
    "Editar {0} — modelo · cor · prompt"
  ],
  [
    "Edit Server: {0}",
    "编辑服务器：{0}",
  ...
  [
    ...
    "इस एजेंट का मॉडल, कार्ड का रंग और prompt एडिट करें। Save करने पर ये टीम टेम्पलेट में लिख दिए जाते हैं।",
    "Edite o modelo, a cor do card e o prompt deste agente. Salvar grava tudo no template da equipe."
  ],
  [
    "Edit this file",
    "编辑此文件",
  ...
  [
    ...
    "एडिट-केंद्रित prompt",
    "Prompt focado em edição"
  ],
  [
    ...
    "नवीनतम browser_snapshot से element index।",
    "Índice do elemento do browser_snapshot mais recente."
  ],
  [
    "Email",
    "电子邮件",
  ...
  [
    ...
    "비상 정지 — 진행 중인 모든 원격 명령 + 세션 취소",
    "緊急停止 — 実行中のすべてのリモートコマンド + セッションをキャンセル",
    "الإيقاف الطارئ — إلغاء كل أمر عن بُعد قيد التنفيذ + الجلسات",
    "Arresto d'emergenza — annulla ogni comando remoto in corso + sessione",
    "इमरजेंसी स्टॉप — चल रही हर remote कमांड + सेशन कैंसल करें",
    "Parada de emergência — cancela cada comando remoto em andamento + sessão"
  ],
  [
    "Empty",
    "空",
  ...
  [
    ...
    "खाली — टीम चलने पर replies, reasoning और tool calls सब यहाँ समय-क्रम में दिखेंगे।",
    "Vazio — respostas, raciocínio e chamadas de ferramentas aparecerão aqui em ordem cronológica quando a equipe rodar."
  ],
  [
    "empty = unsigned",
    "空 = 未签名",
  ...
  [
    ...
    "इस डिवाइस को एमुलेट करें: असली viewport साइज़ + मोबाइल user-agent (पेज रीलोड होगा)",
    "Emular este dispositivo: tamanho real de viewport + user-agent móvel (a página recarrega)"
  ],
  [
    ...
    "에뮬레이션된 USB-HID 키보드), 'keys' (키 조합/시퀀스 누르기, 예: 'ctrl+alt+del' 또는",
    "エミュレートされた USB-HID キーボード）、'keys'（キーの組み合わせ/シーケンスを押す、例: 'ctrl+alt+del' または",
    "لوحة مفاتيح USB-HID محاكاة)، 'keys' (اضغط تركيبة/تسلسل مفاتيح، مثل 'ctrl+alt+del' أو",
    "tastiera USB-HID emulata), 'keys' (premi una combinazione/sequenza di tasti, es. 'ctrl+alt+del' o",
    "एमुलेटेड USB-HID कीबोर्ड), 'keys' (कोई key chord/सीक्वेंस दबाएँ, जैसे 'ctrl+alt+del' या",
    "teclado USB-HID emulado), 'keys' (pressiona um atalho/sequência de teclas, ex.: 'ctrl+alt+del' ou"
  ],
  [
    "Enable the",
    "启用",
  ...
  [
    ...
    "Agent मोड में tool calls इनेबल करें",
    "Habilitar chamadas de ferramentas no modo Agente"
  ],
  [
    "enabled",
    "已启用",
  ...
  [
    ...
    "इनेबल्ड — एजेंट्स को विज्ञापित",
    "Habilitado — anunciado aos agentes"
  ],
  [
    "encrypted",
    "加密",
  ...
  [
    ...
    "पहले एक सामान्य आइडिया लिखें (एक-दो वाक्य काफ़ी हैं)।",
    "Primeiro insira uma ideia genérica (uma ou duas frases bastam)."
  ],
  [
    ...
    "सिस्टम निर्देश दर्ज करें...",
    "Insira as instruções do sistema..."
  ],
  [
    "Entire Screen",
    "整个屏幕",
  ...
  [
    ...
    "इक्विप्ड स्किल context",
    "contexto das skills equipadas"
  ],
  [
    "error",
    "错误",
  ...
  [
    ...
    "ऐप भर में चल रहा हर inference सर्वर। तब उपयोगी जब कोई चीज़ ऐसी GPU मेमोरी पकड़े हो जो आपको दिख नहीं रही।",
    "Todos os servidores de inferência rodando no app. Útil quando algo está segurando memória da GPU que você não consegue ver."
  ],
  [
    "Every request, both sides, redacted (command output is never stored — only a length + digest).",
    "每个请求，双方，均已脱敏（命令输出从不存储——只存储长度 + 摘要）。",
    "모든 요청, 양쪽 모두, 마스킹 처리됨(명령 출력은 절대 저장되지 않음 — 길이와 다이제스트만 저장됨).",
    "すべてのリクエストは両側でマスキング済み（コマンド出力は保存されず、長さとダイジェストのみが記録されます）。",
    "كل طلب، من كلا الجانبين، مموَّه (مخرجات الأوامر لا تُخزن أبدًا — فقط الطول + الملخص).",
    "Ogni richiesta, entrambe le parti, oscurata (l'output dei comandi non viene mai memorizzato — solo una lunghezza + digest).",
    "हर request, दोनों तरफ़ से, redacted (कमांड का आउटपुट कभी स्टोर नहीं होता — सिर्फ़ लंबाई + digest)।",
    "Cada requisição, dos dois lados, com dados ocultados (a saída dos comandos nunca é armazenada — apenas tamanho + digest)."
  ],
  [
    ...
    "소프트웨어를 출시하는 개발자가 다루는 모든 것 — 인증서, 서명 선택기, 포털 로그인, 토큰 — 을 한곳에서 관리하며 이 컴퓨터에 암호화되어 보관됩니다. 공급자 포털은 OwLLM 자체 브라우저에서 열리고 저장된 로그인으로 이미 로그인되어 있어, '인증서 갱신'이 오후 내내 비밀번호를 재설정하는 일이 되지 않습니다.",
    "リリースを担う開発者が扱うすべて — 証明書、署名セレクター、ポータルログイン、トークン — を1か所で管理し、このマシン上で暗号化して保管します。プロバイダーのポータルはOwLLM自身のブラウザ内で開き、保存済みログインで既にサインインされているため、「証明書の更新」が午後いっぱいのパスワードリセット作業ではなくなります。",
    "كل ما يتعامل معه المطوّر الذي يُصدر البرمجيات — الشهادات، ومحدِّدات التوقيع، وتسجيلات الدخول إلى البوابات، والرموز — يُدار في مكان واحد ويبقى مشفّرًا على هذا الجهاز. تُفتح بوابات المزوّدين داخل متصفح OwLLM نفسه، مسجَّلة الدخول مسبقًا من حساباتك المحفوظة، فلا يعود \"تجديد الشهادة\" أمسية كاملة من إعادة تعيين كلمات المرور.",
    "Tutto ciò che uno sviluppatore che rilascia software deve gestire — certificati, selettori di firma, login ai portali, token — gestito in un unico posto e mantenuto cifrato su questa macchina. I portali dei provider si aprono nel browser di OwLLM, già autenticati con i tuoi login salvati, così \"rinnovare il certificato\" smette di essere un pomeriggio di reset di password.",
    "सॉफ़्टवेयर शिप करने वाला डेवलपर जो कुछ भी संभालता है — सर्टिफ़िकेट, signing सेलेक्टर, पोर्टल लॉगिन, tokens — सब एक जगह मैनेज होता है और इसी मशीन पर एन्क्रिप्टेड रहता है। Provider पोर्टल OwLLM के अपने ब्राउज़र में खुलते हैं, आपके सेव किए लॉगिन से पहले से साइन-इन — तो \"cert renew करना\" पासवर्ड रीसेट में बीतने वाली दोपहर नहीं रह जाता।",
    "Tudo o que um desenvolvedor que lança software precisa gerenciar — certificados, seletores de assinatura, logins de portais, tokens — administrado em um só lugar e mantido criptografado nesta máquina. Os portais dos provedores abrem no próprio navegador do OwLLM, já autenticados com seus logins salvos, então \"renovar o certificado\" deixa de ser uma tarde inteira de redefinição de senhas."
  ],
  [
    "exa_…",
    "exa_…",
  ...
  [
    ...
    "खोजने और बदलने के लिए सटीक टेक्स्ट।",
    "Texto exato a localizar e substituir."
  ],
  [
    ...
    "विशेष connectors के लिए उदाहरण templates",
    "templates de exemplo para conectores especializados"
  ],
  [
    ...
    "उदाहरण / connectors चाहिए",
    "Exemplos / precisam de conectores"
  ],
  [
    "Examples:",
    "示例：",
  ...
  [
    ...
    "एक्सपायरी, कौन से फ़ील्ड मौजूद हैं) डिफ़ॉल्ट रूप से। CI env भी पाने के लिए include_secrets=true पास करें",
    "expiração, quais campos estão presentes) por padrão. Passe include_secrets=true para obter também o ambiente de CI"
  ],
  [
    "Explore Models",
    "探索模型",
  ...
  [
    ...
    "अतिरिक्त env vars (JSON, वैकल्पिक):",
    "Variáveis de ambiente extras (JSON, opcional):"
  ],
  [
    ...
    "अतिरिक्त env vars मान्य JSON होने चाहिए।",
    "As variáveis de ambiente extras devem ser um JSON válido."
  ],
  [
    ...
    "अतिरिक्त निर्देश (role prompt के साथ जोड़े जाते हैं)",
    "Instruções extras (anexadas ao prompt do papel)"
  ],
  [
    ...
    "डिस्पैच के समय इस एजेंट के बेस role prompt के ऊपर जोड़े जाने वाले अतिरिक्त निर्देश…",
    "Instruções extras aplicadas sobre o prompt de papel base deste agente no momento do dispatch…"
  ],
  [
    ...
    "अतिरिक्त prompt (वैकल्पिक — बेस role के prompt के साथ जोड़ा जाता है)",
    "Prompt extra (opcional — anexado ao prompt do papel base)"
  ],
  [
    ...
    "{0} स्रोत(ों) से टेक्स्ट निकाला जा रहा है…",
    "Extraindo texto de {0} fonte(s)…"
  ],
  [
    ...
    "एक्सट्रैक्शन + जनरेशन की प्रगति यहाँ दिखती है।",
    "O progresso de extração + geração aparece aqui."
  ],
  [
    ...
    "हर layer पर last-token hidden states निकालता है; बेस्ट layer पर सबसे मज़बूत activation-difference दिशा (\"refusal direction\") ढूँढता है।",
    "Extrai os estados ocultos do último token em cada camada; encontra a direção de diferença de ativação mais forte na melhor camada (a \"direção de recusa\")."
  ],
  [
    "F16",
    "F16",
  ...
  [
    ...
    "fact (टैग के अनुसार रंगीन)",
    "fato (colorido por tag)"
  ],
  [
    ...
    "il fatto sul posto (ad es. key='build_command') invece di duplicarlo.",
    "fact को उसी जगह (जैसे key='build_command') — उसे डुप्लिकेट करने की बजाय।",
    "o fato no lugar (ex.: key='build_command') em vez de duplicá-lo."
  ],
  [
    "facts",
    "事实",
  ...
  [
    ...
    "स्रोत सूचीबद्ध नहीं हो सके: {0}",
    "Falha ao listar as fontes: {0}"
  ],
  [
    "Failed: {0}",
    "失败：{0}",
  ...
  [
    ...
    "FailSpy की refusal-direction stripping रेसिपी",
    "Receita de remoção da direção de recusa do FailSpy"
  ],
  [
    "Fast-forward {0} to HEAD on origin",
    "把 {0} 快进到 origin 的 HEAD",
    "{0}를 origin의 HEAD로 패스트포워드",
    "{0} を origin の HEAD へ fast-forward",
    "عمل fast-forward لـ {0} إلى HEAD على origin",
    "Avanzamento rapido {0} a HEAD su origin",
    "{0} को origin पर HEAD तक fast-forward करें",
    "Fast-forward de {0} até o HEAD no origin"
  ],
  [
    "fed to team",
    "交给团队",
  ...
  [
    ...
    "غذِّ الآن — يُرسل هذه الخطوة كهدف جديد",
    "Alimenta ora — invia questo passaggio come nuovo obiettivo",
    "अभी फ़ीड करें — इस स्टेप को नए goal के रूप में डिस्पैच करता है",
    "Alimentar agora — despacha esta etapa como um novo objetivo"
  ],
  [
    ...
    "غذِّ الآن — يوجّه الفريق قيد التشغيل عند حدّه التالي.",
    "Alimenta ora — dirige il team in esecuzione al suo prossimo confine",
    "अभी फ़ीड करें — चल रही टीम को उसकी अगली सीमा पर स्टीयर करता है",
    "Alimentar agora — direciona a equipe em execução no seu próximo limite"
  ],
  [
    ...
    "पहला pending स्टेप अभी फ़ीड करें — auto-feed बाक़ी लिस्ट पर चलता है, हर क्लीन रन पर एक स्टेप",
    "Alimente a primeira etapa pendente agora — o auto-feed percorre o resto da lista, uma etapa por execução limpa"
  ],
  [
    ...
    "最初の保留中のステップを今すぐフィード（オートフィードをオンにするとリスト全体を自動で進めます）",
    ...
    "पहला pending स्टेप अभी फ़ीड करें (पूरी लिस्ट अपने-आप चलाने के लिए auto-feed चालू करें)",
    "Alimente a primeira etapa pendente agora (ative o auto-feed para percorrer toda a lista automaticamente)"
  ],
  [
    ...
    "NOWバッチ全体をフィード — 実行中のチームを次の境界で誘導します。ボードはカードを保持します。",
    "غذِّ دفعة NOW كاملة — يوجّه الفريق قيد التشغيل عند حدّه التالي. تحتفظ اللوحة ببطاقاتها.",
    "Alimenta l'intero batch NOW — dirige il team in esecuzione al suo prossimo confine. La board mantiene le sue card.",
    "पूरा NOW बैच फ़ीड करें — चल रही टीम को उसकी अगली सीमा पर स्टीयर करता है। बोर्ड के कार्ड बने रहते हैं।",
    "Alimente todo o lote NOW — direciona a equipe em execução no seu próximo limite. O quadro mantém seus cards."
  ],
  [
    "Fetch / refresh",
    "获取 / 刷新",
  ...
  [
    ...
    "URL fetch करें → markdown के रूप में लौटाएँ। स्टैटिक पेजों के लिए puppeteer से सरल।",
    "Busca uma URL → retorna como markdown. Mais simples que o puppeteer para páginas estáticas."
  ],
  [
    ...
    "URL fetch करके उसका पठनीय टेक्स्ट लौटाता है (HTML हटाकर,",
    "Busca uma URL e retorna seu texto legível (HTML removido,"
  ],
  [
    "Fetching {0}…",
    "正在获取 {0}…",
  ...
  [
    ...
    "ファイル内容（ターゲットがアクションを承認した後にのみ書き込まれる）",
    ...
    "फ़ाइल कंटेंट (target पर तभी लिखा जाता है जब वह एक्शन को मंज़ूरी दे)",
    "conteúdo do arquivo (gravado no alvo somente depois que ele aprova a ação)"
  ],
  [
    "File write ⚠ (approval)",
    "文件写入 ⚠（批准）",
  ...
  [
    ...
    "फ़ाइल राइट एक ख़तरनाक एक्शन है — target को इसे लाइव मंज़ूरी देनी होगी (और उसकी policy में file writes की अनुमति होनी चाहिए)।",
    "Gravar arquivos é uma ação perigosa — o alvo precisa aprová-la ao vivo (e sua política precisa permitir gravações de arquivo)."
  ],
  [
    "File writes",
    "文件写入",
  ...
  [
    ...
    "फ़ाइल। उस फ़ाइल को Apple के \"Create a certificate\" पेज पर अपलोड करें, और जारी किया गया डाउनलोड करें",
    "arquivo. Envie esse arquivo na página \"Create a certificate\" da Apple, baixe o"
  ],
  [
    ...
    "फ़ाइलनाम glob फ़िल्टर, जैसे '*.rs' या '*.{ts,tsx}'।",
    "Filtro glob de nome de arquivo, ex.: '*.rs' ou '*.{ts,tsx}'."
  ],
  [
    "files",
    "文件",
  ...
  [
    ...
    "filesystem. Se il tuo modello offre anche gli strumenti memory_search / memory_read, usali",
    "फ़ाइलसिस्टम। अगर आपका मॉडल memory_search / memory_read tools भी देता है, तो उनका इस्तेमाल करें",
    "sistema de arquivos. Se o seu modelo também oferece as ferramentas memory_search / memory_read, use"
  ],
  [
    ...
    "Compila il login di questa pagina dalle tue password salvate",
    "इस पेज का लॉगिन आपके सेव किए पासवर्ड से भरें",
    "Preencher o login desta página com suas senhas salvas"
  ],
  [
    "Filter agents…",
    "筛选代理…",
  ...
  [
    ...
    "नाम, विवरण, श्रेणी या एजेंट से टीमें फ़िल्टर करें…",
    "Filtrar equipes por nome, descrição, categoria ou agente…"
  ],
  [
    "filter…",
    "筛选…",
  ...
  [
    ...
    "फ़ाइलनाम पैटर्न से फ़ाइलें खोजता है। `path` के नीचे ट्री में चलता है",
    "Encontra arquivos por padrão de nome. Percorre a árvore sob `path`"
  ],
  [
    ...
    "निष्कर्ष)। यह एजेंट्स के बीच और इस प्रोजेक्ट के आगे के रन में भी बना रहता है।",
    "descobertas). Persiste entre os agentes E entre execuções futuras deste projeto."
  ],
  [
    "Fine Tune",
    "微调",
  ...
  [
    ...
    "Fine-tuning एनवायरनमेंट — इंस्टॉल करें / देखें क्या तैयार है",
    "Ambientes de fine-tuning — instale / veja o que está pronto"
  ],
  [
    ...
    "एनवायरनमेंट इंस्टॉल करने से पहले WSL सेटअप पूरा करें।",
    "Conclua a configuração do WSL antes de instalar um ambiente."
  ],
  [
    "Finished → {0}",
    "完成 → {0}",
  ...
  [
    ...
    "पहला क्लिक लोकल मॉडल लोड करता है, फिर अपने-आप भेज देता है। बाद के क्लिक तुरंत भेजते हैं।",
    "O primeiro clique carrega o modelo local e depois envia automaticamente. Os cliques seguintes enviam imediatamente."
  ],
  [
    ...
    "먼저 자신의 사본을 만드세요.",
    "まず自分のコピーを作成します。",
    "أولاً لإنشاء نسختك الخاصة.",
    "per primo per fare la tua copia.",
    "पहले, ताकि आपकी अपनी कॉपी बन जाए।",
    "primeiro para criar a sua própria cópia."
  ],
  [
    "first-run",
    "首次运行",
  ...
  [
    ...
    "आराम से फ़िट (inference + fine-tuning)",
    "Cabe com folga (inferência + fine-tuning)"
  ],
  [
    "Fits your VRAM",
    "适合你的显存",
  ...
  [
    ...
    "Home पेज पर WSL ठीक करें या प्रोजेक्ट को sandbox में बदलें।",
    "Corrija o WSL na página Home ou converta o projeto para o sandbox."
  ],
  [
    "Folder",
    "文件夹",
  ...
  [
    ...
    "फ़ोल्डर चुनना विफल: {0}",
    "Falha ao escolher a pasta: {0}"
  ],
  [
  ...
  [
    ...
    "जो OAuth URL दिखे उसे फ़ॉलो करें।",
    "siga a URL de OAuth que aparecer."
  ],
  [
    ...
    "सेफ़ रिहर्सल के लिए (build+sign, publish नहीं)। सिर्फ़ Publisher रोल।",
    "para um ensaio seguro (build+assinatura, sem publicar). Apenas o papel Publisher."
  ],
  [
    ...
    "सुरक्षा के लिए, एजेंट वर्किंग फ़ोल्डर तक सीमित रहते हैं",
    "Por segurança, os agentes ficam confinados à pasta de trabalho"
  ],
  [
    ...
    "brainstorm GUI-दिशा संश्लेषण के लिए। आउटपुट PNG",
    "para a síntese de direção de GUI do brainstorm. O PNG de saída deve"
  ],
  [
    "for this project",
    "针对本项目",
  ...
  [
    ...
    "इस एजेंट को किसी खास model id पर पिन करें (जैसे 'claude-opus-4-7', 'claude-sonnet-4-6', 'gpt-5')। टीम डिफ़ॉल्ट → सर्वर fallback से इनहेरिट करने के लिए खाली छोड़ें। तब उपयोगी जब orchestrator Opus पर चले और critic को किसी सस्ते तेज़ मॉडल पर पिन करना हो।",
    "Força este agente a um id de modelo específico (ex.: 'claude-opus-4-7', 'claude-sonnet-4-6', 'gpt-5'). Deixe vazio para herdar do padrão da equipe → fallback do servidor. Útil para fixar um crítico em um modelo barato e rápido enquanto o orquestrador roda no Opus."
  ],
  [
    ...
    "OWLLM_REMOTE_DEVICES द्वारा ज़बरदस्ती चालू।",
    "Ativado à força por OWLLM_REMOTE_DEVICES."
  ],
  [
    ...
    "OWLLM_KVM_NODE एनवायरनमेंट वेरिएबल द्वारा ज़बरदस्ती चालू — टॉगल बायपास हो जाता है।",
    "Ativado à força pela variável de ambiente OWLLM_KVM_NODE — o toggle é ignorado."
  ],
  [
    "forget",
    "忘记",
  ...
  [
    ...
    "اعمل fork لهذا الفريق في قالب جديد باسم مستقل (يبقى الأصل دون تغيير)",
    "Fai il fork di questo team in un nuovo template con un nome separato (l'originale resta intatto)",
    "इस टीम को एक नए, अलग नाम वाले टेम्पलेट में fork करें (मूल जस का तस रहता है)",
    "Faça fork desta equipe em um novo template com nome próprio (mantém o original intacto)"
  ],
  [
    "form",
    "表单",
  ...
  [
    ...
    "أعد توجيه هذا الرد إلى الوكيل الرئيسي",
    "Inoltra questa risposta all'agente principale",
    "यह जवाब प्राइमरी एजेंट को फ़ॉरवर्ड करें",
    "Encaminhar esta resposta para o agente principal"
  ],
  [
    ...
    "أعد توجيه هذا الرد إلى الوكيل الثاني",
    "Inoltra questa risposta al secondo agente",
    "यह जवाब दूसरे एजेंट को फ़ॉरवर्ड करें",
    "Encaminhar esta resposta para o segundo agente"
  ],
  [
    "Found {0} skills.",
    "找到 {0} 个技能。",
  ...
  [
    ...
    "전체 강조 색상 팔레트",
    "フルアクセントカラーパレット",
    "لوحة ألوان التمييز الكاملة",
    "Palette completa dei colori d'accento",
    "पूरा एक्सेंट कलर पैलेट",
    "Paleta completa de cores de destaque"
  ],
  [
    "Full agentic team — the orchestrator dispatches specialists",
    "完整的代理团队 — 指挥者派遣专家",
    "완전한 에이전트 팀 — 오케스트레이터가 전문가를 파견합니다",
    "完全なエージェンシーチーム — オーケストレーターが専門家を派遣する",
    "فريق وكلاء كامل — المنسّق يوزّع المهام على المتخصصين",
    "Team completamente agentico — l'orchestratore invia specialisti",
    "पूरी एजेंटिक टीम — ऑर्केस्ट्रेटर विशेषज्ञों को डिस्पैच करता है",
    "Equipe agêntica completa — o orquestrador despacha especialistas"
  ],
  [
    "Gamify",
    "游戏化",
  ...
  [
    ...
    "GB VRAM · 빨강 = 로드되지 않음",
    "GB VRAM · 赤 = 読み込まない",
    "جيجابايت VRAM · الأحمر = لن يتم التحميل",
    "GB VRAM · Rosso = non si carica",
    "GB VRAM · लाल = लोड नहीं होगा",
    "GB de VRAM · Vermelho = não carrega"
  ],
  [
    "GB)",
    "GB)",
  ...
  [
    ...
    "एक नया रैंडम auth token जनरेट करें (मौजूदा token ओवरराइट हो जाएगा)।",
    "Gerar um novo token de autenticação aleatório (substitui o atual)."
  ],
  [
    "Generate dataset",
    "生成数据集",
  ...
  [
    ...
    "पेयर जनरेट हो रहे हैं — चंक {0}/{1} · अब तक {2} पेयर…",
    "Gerando pares — bloco {0}/{1} · {2} par(es) até agora…"
  ],
  [
    "generating…",
    "正在生成…",
  ...
  [
    ...
    "इंटरैक्ट करने से पहले ताज़ा इंडेक्स लें, और पेज बदलने के बाद फिर से।",
    "obtenha índices atualizados antes de interagir, e novamente depois que a página mudar."
  ],
  [
    ...
    "एक प्राप्त करें — Apple ID पोर्टल",
    "Obtenha um — portal do Apple ID"
  ],
  [
    "ggml-base.bin",
    "ggml-base.bin",
  ...
  [
    ...
    "GGUF एक्सपोर्ट शुरू नहीं हो सका: {0}",
    "Falha ao iniciar a exportação GGUF: {0}"
  ],
  [
    "GGUF export: {0}",
    "GGUF 导出: {0}",
  ...
  [
    ...
    "GitHub API — repos, issues, PRs, फ़ाइलें।",
    "API do GitHub — repos, issues, PRs, arquivos."
  ],
  [
    ...
    "GitHub कनेक्ट है। आपकी चैट, सेटिंग्स और एजेंट टीमें सिंक होंगी एक प्राइवेट",
    "O GitHub está conectado. Seus chats, configurações e equipes de agentes serão sincronizados em um privado"
  ],
  [
    "github.com/",
    "github.com/",
  ...
  [
    ...
    "قدّم `key` لتحديث حقيقة في مكانها (مثال: key=build_command) بدلًا من",
    "Fornisci una `key` per AGGIORNARE un fatto in loco (es. key=build_command) invece di",
    "किसी फ़ैक्ट को उसी जगह UPDATE करने के लिए `key` दें (जैसे key=build_command), बजाय",
    "Forneça uma `key` para ATUALIZAR um fato no lugar (ex.: key=build_command) em vez de"
  ],
  [
    ...
    "Dare agli agenti di questo progetto ACCESSO COMPLETO al tuo PC?",
    "इस प्रोजेक्ट के एजेंट्स को अपने PC का FULL ACCESS दें?",
    "Dar aos agentes deste projeto ACESSO TOTAL ao seu PC?"
  ],
  [
    "Glama directory",
    "Glama 目录",
  ...
  [
    ...
    "glob / grep — किसी भी OwLLM एप्लिकेशन फ़ोल्डर में नहीं।",
    "glob / grep, NÃO em nenhuma pasta do aplicativo OwLLM."
  ],
  [
    ...
    "Glob पैटर्न, जैसे 'src/**/*.tsx' या '*.py'।",
    "Padrão glob, ex.: 'src/**/*.tsx' ou '*.py'."
  ],
  [
    "Go",
    "去",
  ...
  [
    ...
    "परसिस्टेंट ब्राउज़र की हिस्ट्री में एक एंट्री पीछे जाएँ। एलिमेंट्स दोबारा पढ़ने के लिए बाद में snapshot लें।",
    "Voltar uma entrada no histórico do browser persistente. Depois, faça um snapshot para reler os elementos."
  ],
  [
    ...
    "<project>/brainstorm/ के अंतर्गत जाते हैं।",
    "vão para <project>/brainstorm/."
  ],
  [
    "Goal",
    "目标",
  ...
  [
    ...
    "Google Drive — फ़ाइलें लिस्ट करें, पढ़ें, खोजें। OAuth सेटअप ज़रूरी (मल्टी-स्टेप)।",
    "Google Drive — listar, ler e pesquisar arquivos. Requer configuração OAuth (várias etapas)."
  ],
  [
    "Got it",
    "明白了",
  ...
  [
    ...
    "गॉचा, पिछले निष्कर्ष)। यूज़र से पूछने या दोबारा निकालने से पहले इसे कॉल करें",
    "pegadinhas, descobertas anteriores). Chame isto ANTES de perguntar ao usuário ou rederivar"
  ],
  [
    "GPU",
    "GPU",
  ...
  [
    ...
    "अपने आप एक स्क्रीनशॉट लेता है और समस्या बताने के लिए एक बॉक्स खोलता है।",
    "Captura um screenshot automaticamente e abre uma caixa para descrever o problema."
  ],
  [
    ...
    "सिर्फ़ इस run के लिए अपने होम फ़ोल्डर का रीड एक्सेस दें (दोबारा run करने पर लागू होगा)",
    "Conceder acesso de leitura à sua pasta home apenas para esta execução (vale a partir da próxima execução)"
  ],
  [
    "grants",
    "授予",
  ...
  [
    ...
    "ये टूल्स प्रदान करता है",
    "Concede estas ferramentas"
  ],
  [
    "graph",
    "图",
  ...
  [
    ...
    "गाइडेड WSL सेटअप — Ubuntu + Python अपने आप इंस्टॉल करें",
    "Configuração guiada do WSL — instala Ubuntu + Python automaticamente"
  ],
  [
    ...
    "गाइडेड WSL सेटअप केवल Windows पर उपलब्ध है।",
    "A configuração guiada do WSL está disponível apenas no Windows."
  ],
  [
    ...
    "सख़्त पाबंदियाँ — इसे हमेशा क्या करना है / कभी क्या नहीं करना है।",
    "Restrições rígidas — o que deve sempre / nunca fazer."
  ],
  [
    ...
    "हेडलेस Chromium — नेविगेट, स्क्रीनशॉट, क्लिक, स्क्रैप। पहली बार चलने पर Chromium डाउनलोड करता है।",
    "Chromium headless — navegar, capturar tela, clicar, extrair dados. Baixa o Chromium na primeira execução."
  ],
  [
    ...
    "ध्यान दें: आइसोलेशन के बिना एजेंट सीधे आपके सिस्टम पर चलता है और आपके अकाउंट की पहुँच वाली कोई भी फ़ाइल पढ़ या बदल सकता है। write-jail और खतरनाक-कमांड गार्ड फिर भी लागू रहते हैं, और OWLLM को इस तरह डिज़ाइन किया गया है कि कोई भी इसे सुरक्षित रूप से इस्तेमाल कर सके — लेकिन जब तक कोई ख़ास वजह न हो, हम आइसोलेशन चालू रखने की सलाह देते हैं। Linux VM सुरक्षा की कहीं ज़्यादा मज़बूत परत जोड़ती है।",
    "Atenção: sem isolamento, o agente roda diretamente no seu sistema e pode ler ou modificar qualquer arquivo que a sua conta acessa. As proteções de write-jail e de comandos perigosos continuam valendo, e o OWLLM foi projetado para ser usado com segurança por qualquer pessoa — mas, a menos que você tenha um motivo específico, sugerimos manter o isolamento ativado. A VM Linux adiciona uma camada de proteção muito mais forte."
  ],
  [
    "help",
    "帮助",
  ...
  [
    ...
    "ऐप इस्तेमाल करने में मदद",
    "ajuda para usar o app"
  ],
  [
    "Help using the app",
    "使用应用程序的帮助",
  ...
  [
    ...
    "यह रही मेरी स्क्रीन — आपको क्या दिख रहा है, और मुझे क्या करना चाहिए?",
    "Aqui está minha tela — o que você vê e o que devo fazer?"
  ],
  [
    "Hermes",
    "Hermes",
  ...
  [
    ...
    "إخفاء (يظل الـ shell قيد التشغيل — أعد فتحه من زر 🖥 Terminal)",
    "Nascondi (la shell continua a funzionare — riaprila dal pulsante 🖥 Terminal)",
    "छिपाएँ (shell चलता रहेगा — 🖥 Terminal बटन से दोबारा खोलें)",
    "Ocultar (o shell continua rodando — reabra pelo botão 🖥 Terminal)"
  ],
  [
    "Hide checks",
    "隐藏检查",
  ...
  [
    ...
    "रेडीनेस जाँचें छिपाएँ",
    "Ocultar verificações de prontidão"
  ],
  [
    ...
    "वर्कलॉग ट्रांसक्रिप्ट छिपाएँ — सिर्फ़ स्थायी ज्ञान (फ़ैक्ट्स) दिखाएँ",
    "Ocultar a transcrição do worklog — mostrar apenas o conhecimento durável (fatos)"
  ],
  [
    "Hide token option",
    "隐藏令牌选项",
  ...
  [
    ...
    "होस्ट — इसी मशीन पर build + sign + publish",
    "Host — build + assinatura + publicação nesta máquina"
  ],
  [
    ...
    "होस्ट / IP (जैसे 192.168.1.20)",
    "host / IP (ex.: 192.168.1.20)"
  ],
  [
    ...
    "इस मशीन पर एक रिले होस्ट करें (bind 0.0.0.0:47772) — हमेशा चालू रहने वाले, पब्लिक URL/टनल वाले सिस्टम के लिए",
    "Hospedar um relay nesta máquina (bind 0.0.0.0:47772) — para uma máquina sempre ligada com URL público/túnel"
  ],
  [
    "Host build",
    "主机构建",
  ...
  [
    ...
    "होस्ट मोड इसी मशीन से तुरंत publish करता है। CI मोड GitHub Actions runners पर निर्भर है, जो बिलिंग सीमाओं की वजह से फ़िलहाल उपलब्ध नहीं हैं।",
    "O modo host publica imediatamente desta máquina. O modo CI depende dos runners do GitHub Actions, atualmente indisponíveis por limites de cobrança."
  ],
  [
    ...
    "होस्ट के लिए इस कंप्यूटर पर build टूलचेन और signing सर्टिफ़िकेट चाहिए। CI के लिए एक काम करता GitHub Actions workflow और बिलिंग चाहिए।",
    "O host precisa da toolchain de build e do certificado de assinatura neste computador. O CI precisa de um workflow do GitHub Actions funcionando e de cobrança ativa."
  ],
  [
    "How it works:",
    "工作原理：",
  ...
  [
    ...
    "पिछले run में कितना समय लगा",
    "Quanto tempo levou a última execução"
  ],
  [
    ...
    "पिछले टर्न में कितना समय लगा",
    "Quanto tempo levou o último turno"
  ],
  [
    ...
    "इस एजेंट ने कुल कितना समय काम किया है (संचयी)",
    "Quanto tempo este agente já trabalhou (acumulado)"
  ],
  [
    ...
    "हर चंक में मॉडल से कितने पेयर माँगे जाएँ",
    "Quantos pares pedir ao modelo por bloco"
  ],
  [
    ...
    "कितने नतीजे लौटाए जाएँ (1-20, डिफ़ॉल्ट 5)।",
    "Quantos resultados retornar (1-20, padrão 5)."
  ],
  [
    ...
    "मॉडल कॉन्टेक्स्ट में कितने token रखता है। बड़ा होने पर KV cache के लिए ज़्यादा VRAM चाहिए।",
    "Quantos tokens o modelo mantém no contexto. Valores maiores exigem mais VRAM para o cache KV."
  ],
  [
    ...
    "वे आपस में कैसे जुड़े हैं, और इसे कौन-से MCP सर्वर चाहिए।",
    "como estão conectados entre si e de quais servidores MCP ele precisa."
  ],
  [
    ...
    "कैसे पता चले कि काम पूरा है — वापस सौंपने से पहले पार करने वाला स्तर।",
    "Como saber que o trabalho está completo — o critério a cumprir antes de devolver."
  ],
  [
    ...
    "इसे कैसे पढ़ें — सबसे नई एंट्रीज़ नीचे आपके prompt में इंजेक्ट की जाती हैं, एक",
    "COMO LER — as entradas mais recentes são injetadas no seu prompt abaixo como um"
  ],
  [
    ...
    "इसे कैसे लिखें (हर मॉडल पर काम करता है) — कोई स्थिर, दोबारा इस्तेमाल होने वाला फ़ैक्ट दर्ज करने के लिए (NOT",
    "COMO ESCREVER (funciona em TODOS os modelos) — para registrar um fato estável e reutilizável (NÃO"
  ],
  [
    "ℹ️ Info",
    "ℹ 信息",
  ...
  [
    ...
    "निष्क्रिय — स्टेप्स से run शुरू होता है",
    "ocioso — os passos iniciam uma execução"
  ],
  [
    ...
    "निष्क्रिय — टीम यहाँ आपको पिंग करती है",
    "ocioso — a equipe avisa você aqui"
  ],
  [
    "ies",
    "ies",
  ...
  [
    ...
    "अगर आपका मॉडल Unsloth से सपोर्टेड नहीं है या आपको अधिकतम कम्पैटिबिलिटी चाहिए।",
    "se o seu modelo não é suportado pelo Unsloth ou você quer máxima compatibilidade."
  ],
  [
    "image",
    "图片",
  ...
  [
    ...
    "IMAP + SMTP · एक समर्पित मेलबॉक्स इस्तेमाल करें · कोई पब्लिक URL नहीं",
    "IMAP + SMTP · use uma caixa de e-mail dedicada · sem URL público"
  ],
  [
    "imap.gmail.com",
    "imap.gmail.com",
  ...
  [
    ...
    "अपने ब्राउज़र से इम्पोर्ट करें",
    "Importar dos seus navegadores"
  ],
  [
    "Import media asset",
    "导入媒体资产",
    ...
    "मीडिया एसेट इम्पोर्ट करें",
    "Importar asset de mídia"
  ],
  [
    ...
    "अपने इंस्टॉल किए हुए ब्राउज़रों से सेव किए गए लॉगिन vault में इम्पोर्ट करें।",
    "Importar logins salvos dos navegadores instalados para o cofre."
  ],
  [
    "Importing…",
    "导入中…",
  ...
  [
    ...
    "शेयर डायलॉग में चुनें",
    "Na caixa de compartilhamento, escolha"
  ],
  [
    ...
    "शेयर डायलॉग में “पूरी स्क्रीन” पर क्लिक करें और वह स्क्रीन चुनें जिस पर OWLLM है — मैं उसे सिर्फ़ ऐप तक क्रॉप कर देता हूँ (फ़्रेम समेत)। रोकने के लिए Ctrl+Shift+R दबाएँ।",
    "Na caixa de compartilhamento, clique em “Tela inteira” e escolha a tela em que o OWLLM está — eu recorto apenas para o app (com a moldura incluída). Pressione Ctrl+Shift+R para parar."
  ],
  [
    "in your browser and",
    "在你的浏览器中，并且",
  ...
  [
    ...
    "आपकी लाइब्रेरी में — इस डिवाइस पर डाउनलोड नहीं हुआ।",
    "Na sua biblioteca — não baixado neste dispositivo."
  ],
  [
    ...
    "आपकी मॉडल लाइब्रेरी में (दूसरे डिवाइस पर डाउनलोड किया गया) — इस PC पर अभी नहीं",
    "Na sua biblioteca de modelos (baixado em outro dispositivo) — ainda não neste PC"
  ],
  [
    ...
    "अपने Slack ऐप में: चालू करें",
    "No seu app do Slack: ative"
  ],
  [
    ...
    "आने वाले कनेक्शन यहाँ पहुँचते हैं",
    "As conexões de entrada chegam aqui"
  ],
  [
    "Indigo",
    "靛蓝色",
  ...
  [
    ...
    "सबसे हालिया browser_snapshot से इनपुट एलिमेंट का इंडेक्स।",
    "Índice do elemento de input do browser_snapshot mais recente."
  ],
  [
    "Insert @reference into the composer so the model edits this file",
    "在编辑器中插入 @reference，以便模型编辑此文件",
    "컴포저에 @reference를 삽입하면 모델이 이 파일을 편집합니다",
    "コンポーザーに @reference を挿入すると、モデルがこのファイルを編集します",
    "أدخل @reference في صندوق الكتابة حتى يقوم النموذج بتحرير هذا الملف",
    "Inserisci @reference nel composer così il modello modifica questo file",
    "कंपोज़र में @reference डालें ताकि मॉडल इस फ़ाइल को एडिट करे",
    "Insira @reference no campo de mensagem para que o modelo edite este arquivo"
  ],
  [
    ...
    "उसके अंदर, ताकि Coder और फ़ाइन-ट्यूनिंग काम करें।",
    "dentro dele para que o Coder e o fine-tuning funcionem."
  ],
  [
    "install",
    "安装",
  ...
  [
    ...
    "Log di installazione / accesso",
    "इंस्टॉल / लॉगिन लॉग",
    "Log de instalação / login"
  ],
  [
    ...
    "प्रीव्यू चालू करने के लिए एक सिस्टम वॉइस इंस्टॉल करें",
    "Instale uma voz do sistema para habilitar a prévia"
  ],
  [
    ...
    "Anthropic का आधिकारिक स्किल पैक (PDF, Excel, Word हेल्पर — ड्रॉप-इन कम्पैटिबल) इंस्टॉल करें ताकि आपके एजेंट्स को शुरुआत से ही प्रो-ग्रेड क्षमताएँ मिलें।",
    "Instale o pacote oficial de skills da Anthropic (helpers de PDF, Excel e Word — compatível drop-in) para dar aos seus agentes capacidades de nível profissional desde o início."
  ],
  [
    ...
    "قم بتثبيت حزم SKILL.md المجتمعية من مصادر git المختارة. أسماء الأدوات على طراز Anthropic (",
    "Installa i pacchetti SKILL.md della community da fonti git selezionate. Nomi degli strumenti in stile Anthropic (",
    "क्यूरेटेड git सोर्स से कम्युनिटी SKILL.md पैक इंस्टॉल करें। Anthropic-शैली के टूल नाम (",
    "Instale packs SKILL.md da comunidade a partir de fontes git selecionadas. Nomes de ferramentas no estilo Anthropic ("
  ],
  [
    ...
    "Lima/bubblewrap इंस्टॉल करें।",
    "Instale o Lima/bubblewrap."
  ],
  [
    "Install MCP pack",
    "安装MCP包",
  ...
  [
    ...
    "Node.js टूलचेन इंस्टॉल करें?",
    "Instalar a toolchain do Node.js?"
  ],
  [
    "Install now",
    "立即安装",
  ...
  [
    ...
    "قم بتثبيت حزم SKILL.md من مصدر مختار (Anthropic، obra/superpowers) أو من رابط git",
    "Installa i pacchetti SKILL.md da una fonte selezionata (Anthropic, obra/superpowers) o da un URL git",
    "क्यूरेटेड सोर्स (Anthropic, obra/superpowers) या किसी git URL से SKILL.md पैक इंस्टॉल करें",
    "Instale packs SKILL.md de uma fonte selecionada (Anthropic, obra/superpowers) ou de um URL git"
  ],
  [
    ...
    "पहले फ़ाइन-ट्यूनिंग एनवायरनमेंट इंस्टॉल करें — Environment खोलें (मॉडल के बगल वाला बटन)।",
    "Instale primeiro o ambiente de fine-tuning — abra Ambiente (botão ao lado do modelo)."
  ],
  [
    ...
    "वे MCP सर्वर इंस्टॉल करें जिनकी इस वर्कफ़्लो को ज़रूरत है।",
    "Instale os servidores MCP que este fluxo de trabalho espera."
  ],
  [
    "install uv: {0}",
    "安装 uv: {0}",
  ...
  [
    ...
    "वॉइस रनटाइम इंस्टॉल करें",
    "Instalar runtime de voz"
  ],
  [
    "Install WSL + Ubuntu",
    "安装 WSL + Ubuntu",
  ...
  [
    ...
    "उन्हें अलग रखने के लिए WSL इंस्टॉल करें।",
    "Instale o WSL para isolá-los."
  ],
  [
    "installed",
    "已安装",
  ...
  [
    ...
    "{0}スキル{1}をインストールしました。",
    "تم تثبيت مهارة {0}{1}.",
    "Installate {0} skill{1}.",
    "{0} स्किल{1} इंस्टॉल की गईं।",
    "Instaladas {0} skill{1}."
  ],
  [
    ...
    "{0} इंस्टॉल हुए, {1} विफल: {2}",
    "{0} instalados, {1} falharam: {2}"
  ],
  [
    ...
    "इस PC पर इंस्टॉल है और काम कर रहा है — लेकिन इसमें मौजूद एकमात्र Linux है",
    "instalado e funcionando neste PC — mas o único Linux nele é"
  ],
  [
    ...
    "इंस्टॉल किया गया सर्च MCP सर्वर (जैसे DuckDuckGo, जिसे किसी key की ज़रूरत नहीं) है",
    "servidor MCP de busca instalado (ex.: DuckDuckGo, que não precisa de chave) é"
  ],
  [
    "installing",
    "正在安装",
  ...
  [
    ...
    "{0} में एजेंट टूल इंस्टॉल हो रहे हैं (node, uv, git, CLIs)… इसमें कुछ मिनट लग सकते हैं।",
    "Instalando ferramentas de agente em {0} (node, uv, git, CLIs)… isso pode levar alguns minutos."
  ],
  [
    ...
    "एजेंट टूल इंस्टॉल हो रहे हैं…",
    "Instalando ferramentas de agente…"
  ],
  [
    "Installing...",
    "正在安装……",
  ...
  [
    ...
    "निर्देश · SKILL.md बॉडी (",
    "Instruções · corpo do SKILL.md ("
  ],
  [
    "integrating",
    "集成",
  ...
  [
    ...
    "इस bot के लिए Discord Developer Portal में intent, नहीं तो मैसेज का टेक्स्ट खाली आता है।",
    "intent para este bot no Discord Developer Portal, ou o texto das mensagens chega vazio."
  ],
  [
    ...
    "जाँच-पड़ताल करता है, तथ्य जुटाता है, docs/APIs पढ़ता है",
    "investiga, coleta fatos, lê docs/APIs"
  ],
  [
    "IP / hostname",
    "IP / 主机名",
  ...
  [
    ...
    "इस डिवाइस पर तैयार है। आपकी चैट, सेटिंग्स और एजेंट टीमें यहाँ sync होती हैं।",
    "está pronto neste dispositivo. Seus chats, configurações e times de agentes sincronizam aqui."
  ],
  [
    ...
    "मास्टर गेट है (off = कोई MCP टूल किसी एजेंट तक नहीं पहुँचता, कुछ भी spawn नहीं होता); हर सर्वर का",
    "é a chave geral (off = nenhuma ferramenta MCP chega a nenhum agente, nada é iniciado); a de cada servidor"
  ],
  [
    ...
    "आइसोलेटेड: टूल Linux (WSL) के अंदर चलते हैं और आपकी Windows फ़ाइलों को छू नहीं सकते।",
    "Isolado: as ferramentas rodam dentro do Linux (WSL) e não podem tocar seus arquivos do Windows."
  ],
  [
    "Isolation Bunker",
    "隔离地堡",
  ...
  [
    ...
    "आइसोलेशन चालू है लेकिन यह लोकेशन HOST पर चलती है (सैंडबॉक्स उपलब्ध नहीं है या यह फ़ोल्डर उसके बाहर है)।",
    "O isolamento está ativado, mas este local roda no HOST (o sandbox está indisponível ou esta pasta está fora dele)."
  ],
  [
    ...
    "यह वहाँ फ़ाइलें पढ़, खोज, एडिट और बना सकता है और कमांड चला सकता है।",
    "Ele pode ler, pesquisar, editar e criar arquivos e executar comandos lá."
  ],
  [
    "it there and click",
    "它在那里并点击",
  ...
  [
    ...
    "KVM नोड की पहचान करने वाला JSON ऑब्जेक्ट:",
    "Objeto JSON que identifica o nó KVM:"
  ],
  [
    "JSON object of action-specific params. screenshot: {} — type: {\"text\": string} —",
    "动作特定参数的 JSON 对象。screenshot: {} — type: {\"text\": string} —",
    "액션별 매개변수의 JSON 객체. screenshot: {} — type: {\"text\": string} —",
    "アクション固有のパラメータのJSONオブジェクト。screenshot: {} — type: {\"text\": string} —",
    "كائن JSON للمعلمات الخاصة بالإجراء. screenshot: {} — type: {\"text\": string} —",
    "Oggetto JSON di parametri specifici per l'azione. screenshot: {} — type: {\"text\": string} —",
    "एक्शन-विशिष्ट params का JSON ऑब्जेक्ट। screenshot: {} — type: {\"text\": string} —",
    "Objeto JSON de parâmetros específicos da ação. screenshot: {} — type: {\"text\": string} —"
  ],
  [
    "Just chat",
    "仅聊天",
  ...
  [
    ...
    "सब कुछ सिर्फ़ इसी डिवाइस पर रखें",
    "Manter tudo apenas neste dispositivo"
  ],
  [
    "Keep frame",
    "保持帧",
  ...
  [
    ...
    "key (वैकल्पिक, जैसे build_command)",
    "chave (opcional, ex.: build_command)"
  ],
  [
    ...
    "Nome del tasto da premere, es. 'Enter' o 'Escape'.",
    "दबाने के लिए key का नाम, जैसे 'Enter' या 'Escape'।",
    "Nome da tecla a pressionar, ex.: 'Enter' ou 'Escape'."
  ],
  [
    "keys: {\"combo\": string} (e.g. \"ctrl+alt+del\") — mouse: {\"x\"?: number, \"y\"?: number,",
    "keys: {\"combo\": string}（例如 \"ctrl+alt+del\"）— mouse: {\"x\"?: number, \"y\"?: number,",
    "keys: {\"combo\": string} (예: \"ctrl+alt+del\") — mouse: {\"x\"?: number, \"y\"?: number,",
    "keys: {\"combo\": string}（例: \"ctrl+alt+del\"）— mouse: {\"x\"?: number, \"y\"?: number,",
    "keys: {\"combo\": string} (مثال: \"ctrl+alt+del\") — mouse: {\"x\"?: number, \"y\"?: number,",
    "keys: {\"combo\": string} (es. \"ctrl+alt+del\") — mouse: {\"x\"?: number, \"y\"?: number,",
    "keys: {\"combo\": string} (जैसे \"ctrl+alt+del\") — mouse: {\"x\"?: number, \"y\"?: number,",
    "keys: {\"combo\": string} (ex.: \"ctrl+alt+del\") — mouse: {\"x\"?: number, \"y\"?: number,"
  ],
  [
    ...
    "खोजने के लिए कीवर्ड (जैसे 'build command', 'auth flow')। खाली = सबसे हालिया।",
    "Palavras-chave a buscar (ex.: 'build command', 'auth flow'). Vazio = mais recente."
  ],
  [
    ...
    "أنهِ خادم الاستدلال المميّز في القائمة.",
    "Termina il server di inferenza evidenziato nella lista.",
    "लिस्ट में हाइलाइट किए गए inference सर्वर को kill करें।",
    "Encerrar o servidor de inferência destacado na lista."
  ],
  [
    "KIMI",
    "KIMI",
  ...
  [
    ...
    "conoscenza — NON chiacchiere transitorie. Fornisci una breve 'chiave' per AGGIORNARE una conoscenza nota",
    "ज्ञान — क्षणिक गपशप नहीं। किसी ज्ञात एंट्री को UPDATE करने के लिए एक छोटा 'key' दें",
    "conhecimento — NÃO conversa passageira. Forneça uma 'key' curta para ATUALIZAR um item conhecido"
  ],
  [
    ...
    "KV cache ≈ वेट्स के ऊपर {0} GB (30B-क्लास अनुमान)। अगर मॉडल लोड होते समय क्रैश हो तो इसे घटाएँ।",
    "Cache KV ≈ {0} GB além dos pesos (estimativa para classe 30B). Reduza se um modelo travar ao carregar."
  ],
  [
    "LAN",
    "局域网",
  ...
  [
    ...
    "最新的 browser_snapshot。先执行 snapshot 以获取索引。",
    "최신 browser_snapshot. 인덱스를 얻으려면 먼저 snapshot을 실행하세요.",
    "最新の browser_snapshot。インデックスを取得するには、まず snapshot を実行してください。",
    "أحدث browser_snapshot. التقط snapshot أولاً للحصول على الفهرس.",
    "ultimo browser_snapshot. Esegui prima uno snapshot per ottenere l'indice.",
    "नवीनतम browser_snapshot। इंडेक्स पाने के लिए पहले snapshot लें।",
    "browser_snapshot mais recente. Faça um snapshot primeiro para obter o índice."
  ],
  [
    ...
    "WSL इंस्टॉल शुरू हो रहा है — UAC प्रॉम्प्ट स्वीकार करें, फिर रीबूट करें…",
    "Iniciando a instalação do WSL — aceite o prompt do UAC e depois reinicie…"
  ],
  [
    "leader",
    "领导者",
  ...
  [
    ...
    "एक सब-टीम का नेतृत्व करता है — अपने सदस्यों को काम dispatch करता है",
    "Lidera um subtime — despacha para seus próprios membros"
  ],
  [
    ...
    "टीम का नेतृत्व करता है, योजना बनाता है और specialists को काम बाँटता है",
    "lidera o time, planeja e despacha trabalho para especialistas"
  ],
  [
    ...
    "पूरी टीम का नेतृत्व करता है — यह हमेशा dispatch करता है। (यह Agent/Leader विकल्प नहीं है; वह सिर्फ़ बाकी एजेंटों के लिए है।)",
    "Lidera o time inteiro — ele sempre despacha. (Não é uma escolha Agente/Líder; isso é só para os outros agentes.)"
  ],
  [
    "Legacy templates",
    "传统模板",
  ...
  [
    ...
    "एजेंटों को NanoKVM/PiKVM (kvm_node टूल) के ज़रिए एक रिमोट कंप्यूटर देखने + चलाने दें",
    "permite que agentes vejam e operem um computador remoto via NanoKVM/PiKVM (ferramenta kvm_node)"
  ],
  [
    ...
    "एजेंटों को रिमोट डिवाइस इस्तेमाल करने दें",
    "Permitir que agentes usem dispositivos remotos"
  ],
  [
    ...
    "OWLLM को आपके GPU के हिसाब से context का साइज़ तय करने दें — बड़ा कार्ड = बड़ी विंडो (अनुशंसित)।",
    "Deixe o OWLLM dimensionar o contexto para sua GPU — placa maior = janela maior (recomendado)."
  ],
  [
    ...
    "इस प्रोजेक्ट के एजेंटों को सैंडबॉक्स के बाहर चलने दें। सिर्फ़ भरोसेमंद प्रोजेक्ट्स के लिए इस्तेमाल करें।",
    "Permite que os agentes deste projeto rodem FORA do sandbox. Use apenas em projetos confiáveis."
  ],
  [
    ...
    "आपकी दूसरी OwLLM मशीनों को इससे pair होने देता है। इसका पता आपके GitHub vault के ज़रिए अपने-आप उन तक पहुँच जाता है — कुछ टाइप नहीं करना।",
    "Permite que suas outras máquinas OwLLM pareiem com esta. O endereço é compartilhado com elas automaticamente pelo seu vault do GitHub — nada para digitar."
  ],
  [
    "Light",
    "轻量",
  ...
  [
    ...
    "शायद लोड नहीं होगा",
    "Provavelmente não vai carregar"
  ],
  [
    "likes",
    "喜欢",
  ...
  [
    ...
    "आपके लिए उपलब्ध हर SKILL पैक की सूची दें (नाम + एक-पंक्ति विवरण)।",
    "Lista todos os packs de SKILL disponíveis para você (nome + descrição de uma linha)."
  ],
  [
    ...
    "किसी डायरेक्टरी की एंट्रीज़ (फ़ाइलें + सबफ़ोल्डर) सूचीबद्ध करें।",
    "Lista as entradas (arquivos + subpastas) de um diretório."
  ],
  [
    "List view",
    "列表视图",
  ...
  [
    ...
    "{0} पर सुन रहा है — अपनी tunnel इस पोर्ट पर पॉइंट करें; webhook callback URL = <tunnel>/whatsapp।",
    "Escutando em {0} — aponte seu túnel para esta porta; URL de callback do webhook = <tunnel>/whatsapp."
  ],
  [
    "LIVE",
    "直播",
  ...
  [
    ...
    "live — حسّن الموجز في الدردشة وسيتم تحديثه",
    "live — affina il brief in chat e si aggiorna",
    "live — चैट में brief को refine करें और यह अपडेट हो जाता है",
    "live — refine o briefing no chat e ele se atualiza"
  ],
  [
    "Llama 3.x",
    "Llama 3.x",
  ...
  [
    ...
    "llama-server अभी warm up हो रहा है ·",
    "llama-server ainda aquecendo ·"
  ],
  [
    ...
    "LLM-ट्यून्ड सर्च — कच्चे HTML की जगह साफ़ टेक्स्ट देता है। मुफ़्त 1000 क्वेरी/माह, कोई कार्ड नहीं।",
    "Busca otimizada para LLM — retorna texto limpo em vez de HTML bruto. 1000 consultas/mês grátis, sem cartão."
  ],
  [
    "Load",
    "加载",
  ...
  [
    ...
    "अपडेट करने के लिए फ़ॉर्म में लोड करें (पासवर्ड वैसा ही रखने के लिए खाली छोड़ें)",
    "Carregue no formulário para atualizar (deixe a senha em branco para mantê-la)"
  ],
  [
    ...
    "Carica le istruzioni COMPLETE di un pacchetto SKILL nel contesto, per nome.",
    "किसी एक SKILL पैक के पूरे निर्देश नाम से context में लोड करें।",
    "Carrega as instruções COMPLETAS de um pack de SKILL no contexto, pelo nome."
  ],
  [
    "Loading",
    "正在加载",
  ...
  [
    ...
    "मॉडल VRAM में लोड हो रहा है — तैयार होते ही क्लिक भेज देगा",
    "Carregando o modelo na VRAM — o clique envia assim que estiver pronto"
  ],
  [
    ...
    "अनुशंसित मॉडल लोड हो रहे हैं…",
    "Carregando modelos recomendados…"
  ],
  [
    ...
    "टीम वर्कबेंच लोड हो रहा है…",
    "Carregando a bancada do time…"
  ],
  [
    "loading…",
    "加载中…",
  ...
  [
    ...
    "ターゲットモデルを transformers で読み込みます（HF形式、CUDAでfp16）。",
    "يحمّل النموذج المستهدف في transformers (صيغة HF، fp16 على CUDA).",
    "Carica il modello di destinazione in transformers (formato HF, fp16 su CUDA).",
    "टारगेट मॉडल को transformers में लोड करता है (HF फ़ॉर्मैट, CUDA पर fp16)।",
    "Carrega o modelo alvo no transformers (formato HF, fp16 em CUDA)."
  ],
  [
    "local",
    "本地",
  ...
  [
    ...
    "लोकल फ़ोल्डर key (जैसे myteam)",
    "chave da pasta local (ex.: myteam)"
  ],
  [
    ...
    "लोकल जनरेशन स्पीड (टोकन प्रति सेकंड)",
    "Velocidade de geração local (tokens por segundo)"
  ],
  [
    "Local git ops — log, diff, blame, branches. Edit --repository to your repo.",
    "本地 git 操作 — log、diff、blame、branch。将 --repository 改为你的仓库。",
    "로컬 git 작업 — log, diff, blame, branch. --repository를 자신의 저장소로 수정하세요.",
    "ローカル git 操作 — log、diff、blame、branch。--repository を自分のリポジトリに変更してください。",
    "عمليات git محلية — log وdiff وblame وbranch. عدّل --repository ليشير إلى مستودعك.",
    "Operazioni git locali — log, diff, blame, branch. Modifica --repository per il tuo repository.",
    "लोकल git ऑपरेशन — log, diff, blame, branch। --repository को अपने repo पर सेट करें।",
    "Operações git locais — log, diff, blame, branches. Edite --repository para o seu repo."
  ],
  [
    ...
    "लोकल मॉडल अभी warm up हो रहा है",
    "O modelo local ainda está aquecendo"
  ],
  [
    "Local Models",
    "本地模型",
  ...
  [
    ...
    "लोकल SQLite पढ़ना/लिखना + स्कीमा निरीक्षण। --db-path को अपने DB पर सेट करें।",
    "Leitura/escrita de SQLite local + inspeção de schema. Edite --db-path para o seu banco."
  ],
  [
    ...
    "लोकल सपोर्ट असिस्टेंट",
    "assistente de suporte local"
  ],
  [
    "log",
    "日志",
  ...
  [
    ...
    "लॉगिन sync विफल: {0}",
    "Falha na sincronização do login: {0}"
  ],
  [
    "logs",
    "日志",
  ...
  [
    ...
    "सेव सक्षम करने के लिए कोई बदलाव करें",
  ...
  [
    ...
    "sync / अकाउंट प्रबंधित करें",
    "Gerenciar sincronização / conta"
  ],
  [
    "Mark done",
    "标记为完成",
  ...
  [
    ...
    "匹配的 {path, line, text} 结果。跳过 .git / node_modules /",
    "{path, line, text} 일치 항목. .git / node_modules /는 건너뜁니다.",
    "{path, line, text} の一致ヒット。 .git / node_modules / はスキップ",
    "نتائج {path, line, text} المطابقة. يتخطى .git / node_modules /",
    "risultati {path, line, text} corrispondenti. Salta .git / node_modules /",
    "मेल खाते {path, line, text} रिज़ल्ट। .git / node_modules / छोड़ देता है",
    "resultados {path, line, text} correspondentes. Ignora .git / node_modules /"
  ],
  [
  ...
  [
    ...
    "लौटाने के लिए अधिकतम एंट्री (1-50, डिफ़ॉल्ट 8)।",
    "Máximo de entradas a retornar (1-50, padrão 8)."
  ],
  [
    "Max turns:",
    "最大轮数：",
  ...
  [
    ...
    "MCP सर्वर सबप्रोसेस टूल प्रोवाइडर हैं (आम तौर पर npx से चलने वाले npm पैकेज)। दो परतें:",
    "Servidores MCP são provedores de ferramentas em subprocesso (tipicamente pacotes npm executados via npx). Duas camadas:"
  ],
  [
    "MCP tool {0}",
    "MCP 工具 {0}",
  ...
  [
    ...
    "MCP टूल OFF हैं — एजेंटों को सिर्फ़ built-in टूल दिखते हैं। MCP टूल वापस चालू करने के लिए क्लिक करें।",
    "As ferramentas MCP estão DESLIGADAS — os agentes veem apenas as ferramentas integradas. Clique para religar as ferramentas MCP."
  ],
  [
    ...
    "MCP टूल ON हैं — हर एजेंट को दिखाए जाते हैं। सभी MCP टूल बंद करने के लिए क्लिक करें (लोकल टूल बने रहते हैं)।",
    "As ferramentas MCP estão LIGADAS — anunciadas a todos os agentes. Clique para desligar todas as ferramentas MCP (as locais permanecem)."
  ],
  [
    "MCP tools OFF",
    "MCP 工具关闭",
  ...
  [
    ...
    "memory_search)। स्टोर किया गया कंटेंट लौटाता है, या कुछ नहीं अगर वह key सेट नहीं है।",
    "memory_search). Retorna o conteúdo armazenado, ou nada se essa chave não estiver definida."
  ],
  [
    "Merge",
    "合并",
  ...
  [
    ...
    "Fai il merge del worktree di questa pagina in {0}",
    "इस पेज के worktree को वापस {0} में merge करें",
    "Fazer merge do worktree desta página de volta em {0}"
  ],
  [
    "Message Content",
    "消息内容",
  ...
  [
    ...
    "दूसरे एजेंट को मैसेज करें… (वही workspace, अपनी अलग बातचीत और मॉडल)",
    "Envie uma mensagem ao segundo agente… (mesmo workspace, conversa e modelo próprios)"
  ],
  [
    ...
    "Messaggio… (incolla o allega un'immagine, Enter per inviare, Shift+Enter per andare a capo)",
    "मैसेज… (इमेज पेस्ट या अटैच करें, भेजने के लिए Enter, नई लाइन के लिए Shift+Enter)",
    "Mensagem… (cole ou anexe uma imagem, Enter para enviar, Shift+Enter para nova linha)"
  ],
  [
    "message.channels",
    "message.channels",
  ...
  [
    ...
    "Messaging API · इनबाउंड webhook · एक public URL चाहिए (tunnel)",
    "Messaging API · webhook de entrada · precisa de uma URL pública (túnel)"
  ],
  [
    ...
    "Meta Cloud API · webhook को public URL चाहिए (cloudflared/ngrok)",
    "Meta Cloud API · o webhook precisa de uma URL pública (cloudflared/ngrok)"
  ],
  [
    "Minimize",
    "最小化",
  ...
  [
    ...
    "Mirroring dei tuoi login Windows nella sandbox…",
    "आपके Windows लॉगिन सैंडबॉक्स में मिरर हो रहे हैं…",
    "Espelhando seus logins do Windows no sandbox…"
  ],
  [
    "Mission",
    "使命",
  ...
  [
    ...
    "मॉडल · सिर्फ़ यह एजेंट",
    "MODELO · apenas este agente"
  ],
  [
    "MODEL {0}",
    "模型 {0}",
  ...
  [
    ...
    "मॉडल स्ट्रीम रोकी गई",
    "Stream do modelo pausado"
  ],
  [
    "Model:",
    "模型：",
  ...
  [
    ...
    "I modelli e i fine-tune sono storage protetto. La pulizia è suddivisa in base a quanto è sicuro rimuoverli.",
    "मॉडल और fine-tune सुरक्षित स्टोरेज हैं। सफ़ाई इस आधार पर बाँटी गई है कि हटाना कितना सुरक्षित है।",
    "Modelos e fine-tunes são armazenamento protegido. A limpeza é dividida conforme o quão seguro é remover."
  ],
  [
    ...
    "modelli, che non possono essere fine-tuned direttamente. Scegline uno; viene scaricato automaticamente quando premi Avvia.",
    "मॉडल, जिन्हें सीधे fine-tune नहीं किया जा सकता। कोई एक चुनें; Start दबाने पर यह अपने-आप डाउनलोड हो जाता है।",
    "modelos, que não podem ser fine-tuned diretamente. Escolha um; ele baixa automaticamente quando você pressiona Iniciar."
  ],
  [
    ...
    "किसी मौजूदा फ़ाइल में एक सटीक substring को नए टेक्स्ट से बदलकर उसे संशोधित करें",
    "Modifica um arquivo EXISTENTE substituindo uma substring exata por uma nova"
  ],
  [
    "module",
    "模块",
  ...
  [
    ...
    "현재 스토어에 장착됨{0}",
    "現在ストアにマウントされています{0}",
    "مُحمَّل في المخزن الآن{0}",
    "Attualmente montato nello store{0}",
    "इस समय store में माउंट है{0}",
    "Montado no store neste momento{0}"
  ],
  [
    "Move down",
    "下移",
  ...
  [
    ...
    "myhost.example.com:47771 (खाली = हटाएँ)",
    "myhost.example.com:47771 (em branco = limpar)"
  ],
  [
    "name",
    "名称",
  ...
  [
    ...
    "नाम (छोटा, एजेंट इस रूप में रेफ़र करते हैं",
    "Nome (curto, os agentes referenciam como"
  ],
  [
  ...
  [
    ...
    "'{0}' की आपकी कॉपी का नाम:",
    "Nome para a sua cópia de '{0}':"
  ],
  [
    ...
    "الاسم للوكيل الجديد الخاص بك (مثال: data_wrangler):",
    "Nome per il tuo nuovo agente (ad esempio data_wrangler):",
    "आपके नए एजेंट का नाम (जैसे data_wrangler):",
    "Nome para o seu novo agente (ex.: data_wrangler):"
  ],
  [
    "Name is required.",
    "名称为必填项。",
  ...
  [
    ...
    "以项目命名 · origin 已连接 · 首个分支已推送",
    "프로젝트 이름에서 따옴 · origin wired · 첫 번째 브랜치 푸시됨",
    "プロジェクトにちなんだ名前 · origin接続済み · 最初のブランチをプッシュ済み",
    "سُمّي على اسم المشروع · origin موصول · تم عمل push لأول branch",
    "chiamato come il progetto · origin collegato · primo push del branch fatto",
    "प्रोजेक्ट के नाम पर · origin कनेक्टेड · पहली branch push हो चुकी",
    "nomeado a partir do projeto · origin conectado · primeiro branch enviado via push"
  ],
  [
    "native",
    "原生",
  ...
  [
    ...
    "नेटिव Rust हर subprocess को सुपरवाइज़ करता है, इसके ज़रिए:",
    "O Rust nativo supervisiona cada subprocesso com"
  ],
  [
    "Navigate the already-open persistent browser to a new URL (same logged-in",
    "将已打开的持久浏览器导航到新 URL（同一登录状态",
    "이미 열려 있는 지속 브라우저를 새 URL로 이동 (같은 로그인",
    "すでに開いている永続ブラウザを新しいURLへ移動します（同じログイン",
    ...
    "पहले से खुले persistent ब्राउज़र को नए URL पर ले जाएँ (वही लॉगिन",
    "Leva o navegador persistente já aberto a uma nova URL (mesmo login"
  ],
  [
    ...
    "सर्टिफ़िकेट चाहिए? Apple पोर्टल खोलें",
    "Precisa de um certificado? Abra o portal da Apple"
  ],
  [
    ...
    "Apple CSR / .cer इम्पोर्ट फ़्लो के लिए ज़रूरी। Windows पर यह Git के साथ आता है।",
    "Necessário para os fluxos de importação de CSR / .cer da Apple. No Windows, vem junto com o Git."
  ],
  [
    "needs install",
    "需要安装",
  ...
  [
    ...
    "नेटवर्क और पहुँच (WAN)",
    "Rede e conectividade (WAN)"
  ],
  [
    ...
    "exa.ai की neural/semantic सर्च। हर रिज़ल्ट का पूरा टेक्स्ट देती है। 1000 क्वेरी/माह मुफ़्त, कार्ड की ज़रूरत नहीं।",
    "Busca neural/semântica da exa.ai. Retorna o texto completo por resultado. 1000 consultas/mês grátis, sem cartão."
  ],
  [
    "new",
    "新",
  ...
  [
    ...
    "नई चैट (कोई प्रोजेक्ट नहीं)",
    "Novo chat (sem projeto)"
  ],
  [
    "New conversation",
    "新对话",
  ...
  [
    ...
    "नया नियम — जोड़ने के लिए Enter दबाएँ",
    "Nova regra — Enter para adicionar"
  ],
  [
    "🆕 Start fresh",
    "🆕 全新开始",
  ...
  [
    ...
    "ソースの隣に。各quantは個別のカードとして並ぶので、複数を同時に保持できます。",
    "بجانب المصدر. يظهر كل quant كبطاقة مستقلة بحيث يمكنك الاحتفاظ بعدة نسخ في آنٍ واحد.",
    "accanto alla fonte. Ogni quant arriva come la propria scheda così puoi tenerne diverse contemporaneamente.",
    "सोर्स के बगल में। हर quant अपना अलग कार्ड बनता है, इसलिए आप एक साथ कई रख सकते हैं।",
    "ao lado da origem. Cada quant vira um card próprio, então você pode manter vários ao mesmo tempo."
  ],
  [
    "no",
    "否",
  ...
  [
    ...
    "कोई `owllm/` या `.owllm` मेमोरी फ़ाइल नहीं)। प्रोजेक्ट डॉक्यूमेंटेशन अलग है: वह यहाँ रहता है",
    "sem arquivo de memória `owllm/` ou `.owllm`). A DOCUMENTAÇÃO DO PROJETO é diferente: ela fica em"
  ],
  [
    ...
    "まだアカウントがありませんか？サインインページから1分で無料で作成できます — ここに戻ると自動的に接続されます。（または",
    ...
    "अभी अकाउंट नहीं है? साइन-इन पेज से एक मिनट में मुफ़्त अकाउंट बन जाता है — यहाँ वापस आइए, यह अपने-आप कनेक्ट हो जाएगा। (या",
    "Ainda não tem uma conta? A página de login permite criar uma grátis em um minuto — volte aqui e ela conecta automaticamente. (Ou"
  ],
  [
    ...
    "अभी कोई गतिविधि नहीं। किसी भी प्रोवाइडर पर Install या Connect क्लिक करें — लाइव आउटपुट पॉप-आउट कंसोल की बजाय यहीं दिखेगा।",
    "Nenhuma atividade ainda. Clique em Instalar ou Conectar em qualquer provedor para ver a saída ao vivo aqui, em vez de um console separado."
  ],
  [
    "no address yet — enable remote control on it",
    "尚未有地址 — 在其上启用远程控制",
    "아직 주소가 없음 — 원격 제어를 활성화하세요",
    "まだアドレスがありません — そのデバイスでリモートコントロールを有効にしてください",
    "لا يوجد عنوان بعد — فعّل التحكم عن بعد عليه",
    "nessun indirizzo ancora — abilita il controllo remoto su di esso",
    "अभी कोई पता नहीं — उस पर रिमोट कंट्रोल चालू करें",
    "sem endereço ainda — habilite o controle remoto nele"
  ],
  [
    "No agents on this team yet. Pick a template via",
    "这个团队中还没有代理。通过选择模板",
    "이 팀에는 아직 에이전트가 없습니다. 다음에서 템플릿을 선택하세요:",
    "このチームにはまだエージェントがいません。テンプレートを選ぶには:",
    "لا يوجد وكلاء في هذا الفريق بعد. اختر قالبًا عبر",
    "Ancora nessun agente in questo team. Scegli un template tramite",
    "इस टीम में अभी कोई एजेंट नहीं। टेम्पलेट चुनें:",
    "Nenhum agente nesta equipe ainda. Escolha um template via"
  ],
  [
    "No API key saved",
    "未保存 API 密钥",
    ...
    "कोई API key सेव नहीं है",
    "Nenhuma chave de API salva"
  ],
  [
    ...
    "कोई ऐप इसे बदल नहीं सकता",
    "nenhum app pode alterá-lo"
  ],
  [
    "No assets yet",
    "还没有资产",
  ...
  [
    ...
    "保存されたパスワードのあるブラウザが見つかりませんでした。",
    "لم يتم العثور على متصفحات بها كلمات مرور محفوظة.",
    "Nessun browser con password salvate trovato.",
    "सेव किए गए पासवर्ड वाला कोई ब्राउज़र नहीं मिला।",
    "Nenhum navegador com senhas salvas foi encontrado."
  ],
  [
    ...
    "अभी कोई क्लाउड अकाउंट कनेक्ट नहीं है — यहाँ से एक कनेक्ट करें:",
    "Nenhuma conta de nuvem conectada ainda — conecte uma na"
  ],
  [
    ...
    "अभी कोई कस्टम एजेंट नहीं — अपना बनाने के लिए किसी भी built-in एजेंट को Duplicate करें।",
    "Nenhum agente personalizado ainda — Duplique qualquer agente integrado para criar o seu."
  ],
  [
  ...
  [
    ...
    "現在のフィルター／検索に一致するダウンロード済みモデルはありません。",
    "لا تتطابق أي نماذج تم تنزيلها مع الفلتر / البحث الحالي.",
    "Nessun modello scaricato corrisponde al filtro/ricerca attuale.",
    "मौजूदा फ़िल्टर/सर्च से मेल खाता कोई डाउनलोड किया हुआ मॉडल नहीं।",
    "Nenhum modelo baixado corresponde ao filtro/busca atual."
  ],
  [
    ...
    "ग्राफ़ के लिए अभी कोई टिकाऊ फ़ैक्ट नहीं — हाल की एजेंट गतिविधि देखने के लिए “Show worklog” टॉगल करें।",
    "Nenhum fato duradouro para o grafo ainda — ative “Mostrar worklog” para ver a atividade recente dos agentes."
  ],
  [
    ...
    "अभी कोई इंजन आउटपुट नहीं।",
    "Nenhuma saída do engine ainda."
  ],
  [
    "No entries in {0}.",
    "{0} 中没有条目。",
    ...
    "Nessuna voce in {0}.",
    "{0} में कोई एंट्री नहीं।",
    "Nenhuma entrada em {0}."
  ],
  [
  ...
  [
    ...
    "अभी कोई फ़ैक्ट नहीं। एजेंट काम करते हुए टिकाऊ जानकारी यहाँ सेव करते हैं — या नीचे एक जोड़ें।",
    "Nenhum fato ainda. Os agentes salvam conhecimento duradouro aqui enquanto trabalham — ou adicione um abaixo."
  ],
  [
    ...
    "BRIEF.md में अभी कोई Feature Priority टेबल नहीं — co-founder से एक जोड़ने को कहें, या Conversation व्यू इस्तेमाल करें।",
    "Ainda não há tabela de Prioridade de Funcionalidades no BRIEF.md — peça ao cofundador para adicionar uma, ou use a visão de Conversa."
  ],
  [
    ...
    "एरर में कोई फ़ाइल path नहीं मिला",
    "Nenhum caminho de arquivo foi detectado no erro"
  ],
  [
    "no focus",
    "无焦点",
  ...
  [
    ...
    "कोई GPU नहीं दिख रहा — nvidia-smi उपलब्ध नहीं।",
    "Nenhuma GPU visível — nvidia-smi inacessível."
  ],
  [
    ...
    "아직 앱 내 레지스트리는 없습니다 — HuggingFace의 모델 허브 같은 공개 MCP 마켓플레이스 API가 없기 때문입니다. 공식 목록은 GitHub에 있습니다. 그중 하나에서 서버를 골라, 해당 서버의",
    ...
    "अभी कोई in-app रजिस्ट्री नहीं — HuggingFace के मॉडल hub जैसा कोई सार्वजनिक MCP marketplace API नहीं है। आधिकारिक सूचियाँ GitHub पर हैं। इनमें से किसी एक से सर्वर चुनें, उसका",
    "Ainda não há registro dentro do app — não existe uma API pública de marketplace MCP como o hub de modelos do Hugging Face. As listas canônicas ficam no GitHub. Escolha um servidor de uma delas, pegue seu"
  ],
  [
    ...
    "कोई लोकल मॉडल उपलब्ध नहीं — Models पेज पर एक लोड करें।",
    "Nenhum modelo local disponível — carregue um na página Modelos."
  ],
  [
    ...
    "अभी कोई loss डेटा नहीं — कर्व देखने के लिए एक run शुरू करें।",
    "Nenhum dado de loss ainda — inicie uma execução para ver a curva."
  ],
  [
    ...
    "Mac नहीं है? साइनिंग रिक्वेस्ट (CSR) यहाँ जनरेट करें",
    "Sem Mac? Gere a solicitação de assinatura (CSR) aqui"
  ],
  [
    ...
    "कोई MCP सर्वर कॉन्फ़िगर नहीं। नीचे एक जोड़ें या + Add Server क्लिक करें।",
    "Nenhum servidor MCP configurado. Adicione um abaixo ou clique em + Adicionar Servidor."
  ],
  [
    ...
    "لا توجد ذاكرة للرسم البياني بعد — يضيف الوكلاء (وأنت) ملاحظات أثناء عمل الفريق.",
    "Ancora nessuna memoria da graficare — gli agenti (e tu) aggiungono note mentre il team lavora.",
    "ग्राफ़ के लिए अभी कोई मेमोरी नहीं — टीम के काम करने के दौरान एजेंट (और आप) नोट्स जोड़ते हैं।",
    "Nenhuma memória para o grafo ainda — os agentes (e você) adicionam notas conforme a equipe trabalha."
  ],
  [
    "no model",
    "没有模型",
  ...
  [
    ...
    "दूसरे एजेंट के लिए कोई मॉडल नहीं — दूसरे एजेंट के पैनल में एक चुनें (या primary मॉडल चुनें)।",
    "Nenhum modelo para o segundo agente — escolha um no painel do segundo agente (ou selecione um modelo principal)."
  ],
  [
    ...
    "कोई मॉडल नहीं चुना गया। पहले टीम का डिफ़ॉल्ट मॉडल सेट करें।",
    "Nenhum modelo escolhido. Defina primeiro um modelo padrão da equipe."
  ],
  [
    ...
    "कोई मॉडल नहीं चुना गया — ऊपर से एक चुनें।",
    "Nenhum modelo selecionado — escolha um acima."
  ],
  [
  ...
  [
    ...
    "一致するモデルがありません: \"",
    "لا توجد نماذج تطابق \"",
    "Nessun modello corrisponde a \"",
    "कोई मेल खाता मॉडल नहीं मिला: \"",
    "Nenhum modelo correspondeu a \""
  ],
  [
    "No past chats yet.",
    "还没有聊天记录。",
    ...
    "अभी कोई पुरानी चैट नहीं।",
    "Nenhum chat anterior ainda."
  ],
  [
    ...
    "fine_tuned/ में कोई पुराना run नहीं मिला।",
    "Nenhuma execução anterior encontrada em fine_tuned/."
  ],
  [
    "no probe",
    "没有探测",
  ...
  [
    ...
    "प्रोजेक्ट लोकेशन सेट नहीं है",
    "nenhum local de projeto definido"
  ],
  [
    ...
    "अभी कोई प्रोजेक्ट नियम नहीं — जोड़ने के लिए ऊपर टाइप करें।",
    "Nenhuma regra de projeto ainda — digite uma acima para adicionar."
  ],
  [
    "No project selected",
    "未选择项目",
  ...
  [
    ...
    "अभी कोई प्रोजेक्ट नहीं — शुरू करने के लिए बाईं ओर एक बनाएँ।",
    "Nenhum projeto ainda — crie um à esquerda para começar."
  ],
  [
    ...
    "कोई quantization वैरिएंट नहीं मिला — इस repo में एक ही weight सेट आता है, बस \"Download all\" दबाएँ।",
    "Nenhuma variante de quantização encontrada — este repo traz um único conjunto de pesos, basta clicar em \"Baixar tudo\"."
  ],
  [
    "No reasoning yet — the model's thinking blocks land here while the team runs.",
    "还没有推理——团队运行时，模型的思考块会显示在这里。",
    ...
    "अभी कोई reasoning नहीं — टीम चलने के दौरान मॉडल के thinking ब्लॉक यहाँ आते हैं।",
    "Nenhum raciocínio ainda — os blocos de pensamento do modelo aparecem aqui enquanto a equipe executa."
  ],
  [
    "no reboot is needed",
    "不需要重启",
  ...
  [
    ...
    "इन फ़िल्टरों से मेल खाता कोई recommended मॉडल नहीं। इन्हें हटाएँ या सर्च चलाएँ।",
    "Nenhum modelo recomendado corresponde a esses filtros. Limpe-os ou faça uma busca."
  ],
  [
    ...
    "अभी कोई नियम नहीं — ऊपर एक जोड़ें। उदाहरण: \"मॉड्यूल 500 लाइनों से छोटे रखें\", \"टेस्ट में कभी mocks इस्तेमाल न करें\", \"prototype नहीं, production-ready बनाकर शिप करें\"।",
    "Nenhuma regra ainda — adicione uma acima. Exemplos: \"mantenha os módulos com menos de 500 linhas\", \"nunca use mocks nos testes\", \"entregue pronto para produção, não como protótipo\"."
  ],
  [
    ...
    "अभी कोई सेव किया हुआ पासवर्ड नहीं। नीचे एक जोड़ें या ब्राउज़र से Import करें।",
    "Nenhuma senha salva ainda. Adicione uma abaixo ou importe de um navegador."
  ],
  [
    ...
    "Nessun template di team salvato è alla base di questo roster",
    "इस roster के पीछे कोई सेव किया हुआ टीम टेम्पलेट नहीं है",
    "Nenhum template de equipe salvo está por trás desta formação"
  ],
  [
    ...
    "कोई साइनिंग सर्टिफ़िकेट कॉन्फ़िगर नहीं है (⚙ Set up repo → Code signing), इसलिए यह build UNSIGNED रहेगी।",
    "Nenhum certificado de assinatura está configurado (⚙ Configurar repo → Assinatura de código), então este build será NÃO ASSINADO."
  ],
  [
    ...
    "कोई साइनिंग सर्टिफ़िकेट कॉन्फ़िगर नहीं है, इसलिए यह build UNSIGNED रहेगी।",
    "Nenhum certificado de assinatura está configurado, então este build será NÃO ASSINADO."
  ],
  [
    ...
    "इस सोर्स में कोई SKILL.md फ़ाइल नहीं मिली।",
    "Nenhum arquivo SKILL.md encontrado nesta fonte."
  ],
  [
    ...
    "अभी कोई skill इंस्टॉल नहीं — उन्हें 📚 Skills टैब में जोड़ें, फिर यहाँ टिक करें।",
    "Nenhuma skill instalada ainda — adicione-as na aba 📚 Skills e depois marque-as aqui."
  ],
  [
  ...
  [
    ...
    "अभी कोई skill इंस्टॉल नहीं है। क्लिक करें",
    "Nenhuma skill instalada ainda. Clique em"
  ],
  [
    "No skills match “",
    "没有技能匹配“",
    "일치하는 스킬이 없습니다: “",
    "一致するスキルがありません: “",
    "لا توجد مهارات تطابق “",
    "Nessuna competenza corrisponde “",
    "कोई मेल खाती skill नहीं: “",
    "Nenhuma skill corresponde a “"
  ],
  [
    ...
    "मौजूदा फ़िल्टर से मेल खाती कोई skill नहीं।",
    "Nenhuma skill corresponde ao filtro atual."
  ],
  [
    ...
    "Ancora nessuno specialista in questo team — apri le impostazioni del progetto (",
    "इस टीम में अभी कोई specialist नहीं — प्रोजेक्ट सेटिंग्स खोलें (",
    "Nenhum especialista nesta equipe ainda — abra as configurações do projeto ("
  ],
  [
    ...
    "अभी कोई step नहीं — ऊपर एक जोड़ें, या नीचे अपने नोट्स 🪄 डाइजेस्ट करें।",
    "Nenhum passo ainda — adicione um acima, ou 🪄 processe suas notas abaixo."
  ],
  [
    ...
    "अभी कोई टीम नहीं चुनी गई। per-agent चैट ग्रिड भरने के लिए Studio से एक प्रोजेक्ट शुरू करें।",
    "Nenhuma equipe escolhida ainda. Inicie um projeto no Studio para preencher a grade de chat por agente."
  ],
  [
    ...
    "कोई टीम तैयार नहीं — एक प्रोजेक्ट और मॉडल चुनें",
    "nenhuma equipe pronta — escolha um projeto e um modelo"
  ],
  [
    ...
    "कोई टेक्स्ट नहीं निकाला जा सका — सोर्स जाँचें (PDF में पढ़ने लायक टेक्स्ट चाहिए; कुछ के लिए 'pypdf' चाहिए)।",
    "Nenhum texto pôde ser extraído — verifique as fontes (PDFs precisam de texto legível; alguns exigem 'pypdf')."
  ],
  [
    ...
    "अभी कोई tool call नहीं — एजेंट जो भी कमांड चलाता है (Bash, Read, Write, Edit आदि) वह अपने arguments और लौटाए गए नतीजे के साथ यहाँ दिखता है।",
    "Nenhuma chamada de ferramenta ainda — cada comando que o agente executa (Bash, Read, Write, Edit etc.) aparece aqui com seus argumentos e o resultado retornado."
  ],
  [
    ...
    "इस अकाउंट के लिए अभी कोई ट्रैफ़िक रिकॉर्ड नहीं हुआ",
    "nenhum tráfego registrado ainda para esta conta"
  ],
  [
    ...
    "इस सिस्टम पर कोई TTS voice इंस्टॉल नहीं है",
    "Nenhuma voz TTS instalada neste sistema"
  ],
  [
    ...
    "Ancora nessun adapter fine-tuned.",
    "अभी कोई tuned adapter नहीं।",
    "Nenhum adapter fine-tuned ainda."
  ],
  [
    "no username",
    "无用户名",
  ...
  [
    ...
    "在此文件夹中未找到权重文件。",
    "이 폴더에서 가중치 파일을 찾을 수 없습니다.",
    "このフォルダに重みファイルが見つかりません",
    "لم يتم العثور على ملفات الوزن في هذا المجلد.",
    "Nessun file di pesi trovato in questa cartella.",
    "इस फ़ोल्डर में कोई weight फ़ाइल नहीं मिली।",
    "Nenhum arquivo de pesos encontrado nesta pasta."
  ],
  [
    ...
    "अभी कोई worklog नहीं। run के दौरान हाल के एजेंट turns यहाँ अपने-आप रिकॉर्ड होते हैं।",
    "Nenhum worklog ainda. As rodadas recentes dos agentes são registradas aqui automaticamente durante uma execução."
  ],
  [
    ...
    "शोर फ़िल्टर हो जाता है। इससे symbols, callers खोजें,",
    "o ruído é filtrado. Use isto para encontrar símbolos, chamadores,"
  ],
  [
    "None",
    "无",
  ...
  [
    ...
    "कोई नहीं — कैटलॉग से equip करें ◂",
    "nenhuma — adicione do catálogo ◂"
  ],
  [
    "none saved yet",
    "尚未保存",
  ...
  [
    ...
    "ليست في مخزن الشهادات الآن — وصِّل الرمز المميز (token)، أو شغِّل SimplySign لشهادة Certum السحابية.",
    "Al momento non è nell'archivio certificati — collega il token, o avvia SimplySign per un certificato cloud Certum.",
    "अभी सर्टिफ़िकेट store में नहीं है — token लगाएँ, या Certum क्लाउड सर्टिफ़िकेट के लिए SimplySign शुरू करें।",
    "Não está no repositório de certificados no momento — conecte o token ou inicie o SimplySign para um certificado Certum na nuvem."
  ],
  [
    "not installed",
    "未安装",
  ...
  [
    ...
    "Non isolato: gli strumenti girano sull'host (write-jail e protezione dai comandi pericolosi restano comunque attivi).",
    "आइसोलेटेड नहीं: टूल होस्ट पर चलते हैं (write-jail + खतरनाक-कमांड गार्ड फिर भी लागू रहते हैं)।",
    "Não isolado: as ferramentas rodam no host (write-jail + proteção contra comandos perigosos continuam valendo)."
  ],
  [
    "NOT READY ({0})",
    "未准备好 ({0})",
  ...
  [
    ...
    "GitHub में साइन इन नहीं है — discovery के पास खोजने को कुछ नहीं।",
    "Não conectado ao GitHub — a descoberta não tem nada para pesquisar."
  ],
  [
    "not stored",
    "未存储",
  ...
  [
    ...
    "समझ नहीं आ रहा कौन-सा इंस्टॉल करें?",
    "Não sabe qual instalar?"
  ],
  [
    "note (optional)",
    "备注（可选）",
  ...
  [
    ...
    "नोट: इसके लिए transformers-फ़ॉर्मैट की मॉडल डायरेक्टरी चाहिए (GGUF नहीं)। अगर आपके पास सिर्फ़ GGUF है, तो पहले Models पेज से ओरिजिनल HF weights डाउनलोड करें।",
    "Nota: requer um diretório de modelo no formato transformers (não GGUF). Se você só tem o GGUF, baixe primeiro os pesos originais do HF pela página Models."
  ],
  [
    "NOTE: team memory is a database, not a file — do NOT look for it on disk (there is",
    "注意：团队记忆是一个数据库，而不是一个文件——不要在磁盘上寻找它（有",
    "참고: 팀 메모리는 파일이 아니라 데이터베이스입니다 — 디스크에서 찾지 마세요 (거기에는",
    "注意：チームメモリはデータベースであり、ファイルではありません — ディスク上で探さないでください（そこには",
    ...
    "नोट: टीम मेमोरी एक डेटाबेस है, फ़ाइल नहीं — इसे डिस्क पर बिल्कुल न ढूँढें (वहाँ",
    "NOTA: a memória do time é um banco de dados, não um arquivo — NÃO procure por ela no disco (há"
  ],
  [
    "Notebook",
    "笔记本",
  ...
  [
    ...
    "नोटबुक — एजेंट चलते रहें तब वर्किंग नोट्स लिखें, उन्हें Kanban प्लान बोर्ड और बड़े फीड-करने-लायक स्टेप्स में बदलें, फिर स्टेप्स टीम को दें या हर रन के बाद अपने-आप फीड होने दें।",
    "Notebook — escreva notas de trabalho enquanto os agentes rodam, transforme-as em um quadro Kanban de planejamento e em passos maiores prontos para alimentar, depois envie os passos ao time ou alimente-os automaticamente a cada execução."
  ],
  [
    "Nothing sent yet. Type below in the input dock and press Enter — every message you send to the team will land here as a log.",
    "尚未发送任何内容。在下方输入区输入内容，然后按 Enter — 你发送给团队的每条消息都会作为日志记录在这里。",
    ...
    "अभी कुछ नहीं भेजा गया। नीचे इनपुट डॉक में टाइप करें और Enter दबाएँ — टीम को भेजा गया हर मैसेज यहाँ log के रूप में दिखेगा।",
    "Nada enviado ainda. Digite abaixo no dock de entrada e pressione Enter — cada mensagem que você enviar ao time vai aparecer aqui como log."
  ],
  [
    ...
    "अभी सेव करने को कुछ नहीं — पहले पेयर जनरेट करें।",
    "Nada para salvar ainda — gere os pares primeiro."
  ],
  [
    ...
    "सिंक करने को कुछ नहीं — कोई CLI लॉग इन नहीं है और इस PC की Windows साइड पर कोई API key सेव नहीं है (Accounts → Connect)।",
    "Nada para sincronizar — nenhuma CLI está logada e nenhuma chave de API está salva no lado Windows deste PC (Contas → Conectar)."
  ],
  [
    "now",
    "现在",
  ...
  [
    ...
    "बंद (डिफ़ॉल्ट) — मॉडल सर्वर सिर्फ़ loopback पर है; नेटवर्क से कोई भी इस तक नहीं पहुँच सकता।",
    "DESLIGADO (padrão) — o servidor do modelo fica somente em loopback; nada na rede consegue alcançá-lo."
  ],
  [
    ...
    "बंद = 127.0.0.1 पर बाइंड (सिर्फ़ localhost)। चालू = 0.0.0.0 पर बाइंड (आपके लोकल नेटवर्क का कोई भी डिवाइस पहुँच सकता है)। इसे चालू करें तो एक Token ज़रूर सेट करें।",
    "Desligado = vincula a 127.0.0.1 (somente localhost). Ligado = vincula a 0.0.0.0 (qualquer dispositivo na sua rede local pode alcançá-lo). Defina um Token se você ligar isso."
  ],
  [
    "off: advisory only — never blocks the team",
    "关闭：仅供参考——永远不会阻止团队",
    "off: 안내용일 뿐 — 팀을 절대 차단하지 않음",
    "off: 助言のみ — チームをブロックすることはありません",
    "إيقاف التشغيل: للاستشارة فقط — لا يمنع الفريق أبدًا",
    "off: solo informativo — non blocca mai il team",
    "बंद: सिर्फ़ सलाह — टीम को कभी ब्लॉक नहीं करता",
    "desligado: apenas consultivo — nunca bloqueia o time"
  ],
  [
    ...
    "बंद: एक बार में एक टास्क (क्रमवार)",
    "desligado: uma tarefa por vez (sequencial)"
  ],
  [
  ...
  [
    ...
    "old_string को फ़ाइल से बाइट-दर-बाइट मेल खाना होगा (whitespace समेत)।",
    "old_string precisa corresponder ao arquivo byte a byte (incluindo espaços em branco)."
  ],
  [
    "Oldest first",
    "最旧的优先",
  ...
  [
    ...
    "चालू — दूसरी मशीन पर टेक सपोर्ट, सॉफ़्टवेयर इंस्टॉल और डेवलपमेंट के लिए। टारगेट पर एडमिन/एलिवेशन के लिए अब भी उसकी मंज़ूरी चाहिए। डिफ़ॉल्ट रूप से बंद।",
    "ligado — para suporte técnico, instalação de software e desenvolvimento na outra máquina. Admin/elevação no destino ainda exige a aprovação dela. Desligado por padrão."
  ],
  [
    ...
    "चालू — मॉडल पोर्ट पर इस PC तक पहुँच सकने वाली दूसरी मशीनें नीचे दी key के साथ इसे इस्तेमाल कर सकती हैं। 0.0.0.0 पर बाइंड होता है।",
    "LIGADO — outras máquinas que alcançam este PC na porta do modelo podem usá-lo, com a chave abaixo. Vincula a 0.0.0.0."
  ],
  [
    "on · ~",
    "开启 · ~",
  ...
  [
    ...
    "ज़्यादातर PCs पर यह पहले से चालू होता है — बस आपके PC पर संयोग से बंद है।",
    "Na maioria dos PCs isso já vem ligado — o seu por acaso está desligado."
  ],
  [
    ...
    "एजेंट वाली मशीन पर \"Inference source\" → Remote सेट करें, host = इस PC का IP, port = ऊपर मॉडल के सर्वर का पोर्ट, और यह key पेस्ट करें।",
    "Na máquina do agente, defina \"Inference source\" → Remote, host = o IP deste PC, porta = a porta do servidor do modelo acima, e cole esta chave."
  ],
  [
    "on this machine. Agents fall back to the CLI subscription automatically when no key is saved.",
    "在这台机器上。当没有保存密钥时，代理会自动回退到 CLI 订阅。",
    "이 머신에서. 키가 저장되지 않은 경우 에이전트는 자동으로 CLI 구독으로 돌아갑니다.",
    "このマシンで。キーが保存されていない場合、エージェントは自動的にCLIサブスクリプションにフォールバックします。",
    ...
    "इस मशीन पर। key सेव न होने पर एजेंट अपने-आप CLI सब्सक्रिप्शन पर फ़ॉलबैक कर जाते हैं।",
    "nesta máquina. Os agentes voltam automaticamente para a assinatura da CLI quando nenhuma chave está salva."
  ],
  [
    ...
    "इस PC पर। नीचे के डिफ़ॉल्ट ठीक हैं; चाहें तो बदल लें।",
    "neste PC. Os padrões abaixo estão bons; mude-os se quiser."
  ],
  [
    ...
    "Windows पर ये WSL/Ubuntu के अंदर चलते हैं। जो चाहिए वह इंस्टॉल करें — ट्रेनिंग रन शुरू करने पर वह अपने-आप चुन लिया जाता है। torch आपके GPU से अपने-आप मैच हो जाता है।",
    "No Windows, estes rodam dentro do WSL/Ubuntu. Instale o que quiser; ele será escolhido automaticamente quando você iniciar um treinamento. O torch se ajusta automaticamente à sua GPU."
  ],
  [
    ...
    "चालू: स्क्रीन रिकॉर्डिंग को काटकर सिर्फ़ OWLLM ऐप + फ़्रेम तक सीमित कर देता है। बंद: पूरी स्क्रीन रखता है।",
    "Ligado: recorta a gravação de tela para deixar só o app OWLLM + a moldura. Desligado: mantém a tela inteira."
  ],
  [
    ...
    "एक क्लिक में सब कुछ अपने-आप इंस्टॉल हो जाता है। Windows दिखाएगा एक",
    "Um clique instala tudo automaticamente. O Windows vai mostrar um"
  ],
  [
    ...
    "टीम की शुरुआत के लिए एक लाइन का कॉन्टेक्स्ट।",
    "Uma linha de contexto para o time começar."
  ],
  [
    "One of: desktop, iphone, android, tablet.",
    "以下之一：desktop、iphone、android、tablet。",
    "다음 중 하나: desktop, iphone, android, tablet.",
    "次のいずれか：desktop、iphone、android、tablet。",
    "أحد الخيارات: desktop, iphone, android, tablet.",
    "Uno di: desktop, iphone, android, tablet.",
    "इनमें से एक: desktop, iphone, android, tablet.",
    "Um de: desktop, iphone, android, tablet."
  ],
  [
    "One of: screenshot | type | keys | mouse | boot_key | mount_iso | power.",
    "以下之一：screenshot | type | keys | mouse | boot_key | mount_iso | power。",
    "다음 중 하나: screenshot | type | keys | mouse | boot_key | mount_iso | power.",
    "次のいずれか：screenshot | type | keys | mouse | boot_key | mount_iso | power。",
    "أحد الخيارات: screenshot | type | keys | mouse | boot_key | mount_iso | power.",
    "Uno di: screenshot | type | keys | mouse | boot_key | mount_iso | power.",
    "इनमें से एक: screenshot | type | keys | mouse | boot_key | mount_iso | power.",
    "Um de: screenshot | type | keys | mouse | boot_key | mount_iso | power."
  ],
  [
    "one restart",
    "一次重启",
  ...
  [
    ...
    "فقط يرفع الإصدار ويقوم بـ commit و tag و push؛ يقوم سير عمل المستودع ببنائه ونشره (لا حاجة إلى أدوات بناء محلية، لكن يجب تفعيل GitHub Actions مع الفوترة).",
    ...
    "सिर्फ़ version bump, commit, tag और push करता है; repo का workflow इसे build करके publish करता है (लोकल build toolchain की ज़रूरत नहीं, लेकिन GitHub Actions इनेबल्ड और billed होना चाहिए)।",
    "só faz o bump de versão, commit, tag e push; o workflow do repositório compila e publica (não precisa de toolchain de build local, mas o GitHub Actions precisa estar habilitado e com faturamento ativo)."
  ],
  [
    ...
    "यह सिर्फ़ उन्हीं प्रोजेक्ट और एजेंट्स के लिए करें जिन पर आपको भरोसा है। इसे कभी भी वापस बंद कर सकते हैं।",
    "Faça isso só para um projeto e agentes em que você confia. Você pode desligar de novo a qualquer momento."
  ],
  [
    ...
    "مطلوب فقط عندما تكون شهادة Authenticode الخاصة بك في سحابة Certum.",
    "Necessario solo quando il tuo certificato Authenticode risiede nel cloud di Certum.",
    "सिर्फ़ तब ज़रूरी जब आपका Authenticode सर्टिफ़िकेट Certum के क्लाउड में हो।",
    "Necessário apenas quando seu certificado Authenticode fica na nuvem da Certum."
  ],
  [
    "Open",
    "打开",
  ...
  [
    ...
    "साइन अप / अपनी key पाने के लिए {0} खोलें",
    "Abra {0} para se cadastrar / obter sua chave"
  ],
  [
    ...
    "एक गाइड खोलता है जो बताती है कि यह API Cursor / VS Code में कैसे जोड़ें।",
    "Abre um guia explicando como plugar esta API no Cursor / VS Code."
  ],
  [
    ...
    "افتح shell تفاعلية مباشرة على الهدف (على غرار SSH)",
    "Apri una shell interattiva live sul target (simile a SSH)",
    "टारगेट पर लाइव इंटरैक्टिव shell खोलें (SSH-जैसा)",
    "Abrir um shell interativo ao vivo no destino (estilo SSH)"
  ],
  [
    ...
    "नया पेज खोलें — प्रोजेक्ट चुनें या बनाएँ (हर पेज को अपनी branch/worktree मिलती है), या बस चैट करें",
    "Abra uma nova página — escolha ou crie um projeto (cada página ganha seu próprio branch/worktree), ou apenas converse"
  ],
  [
  ...
  [
    ...
    "टीम मेमोरी देखने के लिए कोई प्रोजेक्ट खोलें।",
    "Abra um projeto para ver a memória do time."
  ],
  [
    ...
    "वर्कस्पेस फ़ोल्डर में टर्मिनल खोलें — ऐप के ऊपर तैरता है (सिर्फ़ यही ऐप)। हिलाने के लिए टाइटल बार खींचें; — shell बंद किए बिना छिपा देता है।",
    "Abre um terminal na pasta do workspace — flutua sobre o app (só este app). Arraste a barra de título para movê-lo; — o esconde sem matar o shell."
  ],
  [
    ...
    "افتح عنوان URL (مثال: github.com) — يرث الوكلاء هذه الجلسة",
    "apri un URL (es. github.com) — gli agenti ereditano questa sessione",
    "कोई URL खोलें (जैसे github.com) — एजेंट्स को यही सेशन विरासत में मिलता है",
    "abrir uma URL (ex.: github.com) — os agentes herdam esta sessão"
  ],
  [
    ...
    "URL को असली persistent ब्राउज़र में खोलें — एक नेटिव OwLLM ब्राउज़र विंडो",
    "Abre uma URL no navegador persistente REAL — uma janela de navegador nativa do OwLLM"
  ],
  [
    ...
    "افتح صفحة وكلاء أخرى — شغّل فريقًا على المشروع نفسه أو مشروع مختلف بالتوازي",
    "Apri un'altra pagina Agenti — esegui un team sullo stesso progetto o su un progetto diverso in parallelo",
    "एक और Agents पेज खोलें — उसी या किसी और प्रोजेक्ट पर टीम समानांतर चलाएँ",
    "Abra outra página de Agentes — rode um time no mesmo projeto ou em outro, em paralelo"
  ],
  [
    "Open Apple portal",
    "打开 Apple 门户",
  ...
  [
    ...
    "स्किल लाइब्रेरी खोलें",
    "Abrir a Biblioteca de Skills"
  ],
  [
    "Open subscription",
    "打开订阅",
  ...
  [
    ...
    "Bridges कॉन्फ़िगरेटर खोलें",
    "Abrir o configurador de Bridges"
  ],
  [
    ...
    "फ़ाइन-ट्यूनिंग एनवायरनमेंट वाला डायलॉग खोलें",
    "Abrir o diálogo de ambientes de fine-tuning"
  ],
  [
    ...
    "افتح شبكة الدردشة لكل وكيل في هذه اللوحة (كل وكيل يحصل على نافذة نسخة حية خاصة به)",
    "Apri la griglia di chat per agente in questa tela (ogni agente ottiene la propria finestra di trascrizione in tempo reale)",
    "इस कैनवास में प्रति-एजेंट चैट ग्रिड खोलें (हर एजेंट को अपनी लाइव ट्रांसक्रिप्ट विंडो मिलती है)",
    "Abre a grade de chat por agente neste canvas (cada agente ganha sua própria janela de transcrição ao vivo)"
  ],
  [
    ...
    "Rules सब-टैब खोलें (Super User पेज)",
    "Abrir a sub-aba Regras (página Super User)"
  ],
  [
  ...
  [
    ...
    "チームワークベンチを開く",
    "فتح منصة عمل الفريق",
    "Apri il team workbench",
    "टीम वर्कबेंच खोलें",
    "Abrir o team workbench"
  ],
  [
    ...
    "टीम वर्कबेंच खोलें — लीडर तय करें, कौन किसे डिस्पैच करे यह जोड़ें, स्किल्स दें",
    "Abrir o Team Workbench — atribua líderes, conecte quem despacha para quem, equipe com skills"
  ],
  [
    ...
    "टीम वर्कबेंच खोलें — किसी built-in को एडिट करने पर कस्टम कॉपी सेव होती है",
    "Abrir o team workbench — editar um integrado salva uma cópia personalizada"
  ],
  [
    ...
    "इस साइट को OwLLM ब्राउज़र में खोलकर साइन इन करें।",
    "Abra este site no navegador OwLLM e faça login."
  ],
  [
    "OpenAI",
    "OpenAI",
  ...
  [
    ...
    "OwLLM ब्राउज़र में Apple का सर्टिफ़िकेट पेज खोलता है, आपके सेव किए लॉगिन से साइन-इन होकर।",
    "Abre a página de certificados da Apple no navegador OwLLM, já conectado com seu login salvo."
  ],
  [
    ...
    "OwLLM ब्राउज़र में appleid.apple.com खोलता है, आपके सेव किए लॉगिन से साइन-इन होकर।",
    "Abre appleid.apple.com no navegador OwLLM, já conectado com seu login salvo."
  ],
  [
    ...
    "OwLLM ब्राउज़र में Certum का पैनल (SimplySign / सर्टिफ़िकेट मैनेजमेंट) खोलता है, आपके सेव किए लॉगिन से साइन-इन होकर।",
    "Abre o painel da Certum (SimplySign / gestão de certificados) no navegador OwLLM, já conectado com seu login salvo."
  ],
  [
    ...
    "आपके ब्राउज़र में GitHub खुलता है — Authorize क्लिक करें, बस हो गया। कुछ पेस्ट नहीं करना पड़ता।",
    "Abre o GitHub no seu navegador — clique em Authorize e pronto. Nada para colar."
  ],
  [
    ...
    "आपके ब्राउज़र में huggingface.co/settings/tokens खोलता है। एक READ token बनाएँ।",
    "Abre huggingface.co/settings/tokens no seu navegador. Crie um token READ."
  ],
  [
    "openssl missing",
    "缺少 openssl",
  ...
  [
    ...
    "वैकल्पिक — इस टीम के लिए बेस रोल को और सटीक बनाता है।",
    "Opcional — refina o papel base para este time."
  ],
  [
    ...
    "बाद में खोजने में मदद के लिए वैकल्पिक कॉमा-सेपरेटेड टैग।",
    "Tags opcionais separadas por vírgula para ajudar em buscas futuras."
  ],
  [
    "Optional notes…",
    "可选备注…",
  ...
  [
    ...
    "वैकल्पिक पेज नाम — टैब {0}(नाम) दिखाता है, जैसे {1}(GUI_fix)। खाली छोड़ें तो सिर्फ़ फ़ोल्डर का नाम दिखेगा।",
    "Nome de página opcional — a aba mostra {0}(nome), ex.: {1}(GUI_fix). Deixe vazio para mostrar só o nome da pasta."
  ],
  [
    ...
    "जगह पर upsert करने के लिए वैकल्पिक स्थायी id (जैसे 'build_command', 'api_base_url')।",
    "ID estável opcional para fazer upsert no lugar (ex.: 'build_command', 'api_base_url')."
  ],
  [
    "or",
    "或",
  ...
  [
    ...
    "या आपकी किसी और मशीन पर डेवलपमेंट। stdout/stderr/exit_code लौटाता है। ज़रूरत है",
    "ou desenvolvimento em outra das suas máquinas. Retorna stdout/stderr/exit_code. Requer"
  ],
  [
    ...
    "या किसी लोकल फ़ोल्डर से शुरू करें",
    "Ou comece a partir de uma pasta local"
  ],
  [
    "orch",
    "orch",
  ...
  [
    ...
    "ऑर्केस्ट्रेटर स्वतंत्र टास्क को एक ही वेव में बैच कर देता है",
    "o orquestrador agrupa tarefas independentes em uma única onda"
  ],
  [
    "Order by:",
    "排序方式：",
  ...
  [
    ...
    "يعمد كل",
    "Ortogonalizza ogni",
    "प्रत्येक को ऑर्थोगोनलाइज़ करता है",
    "Ortogonaliza cada"
  ],
  [
    "OTHER",
  ...
  [
    ...
    "Run Brainstorm पर क्लिक करते ही आउटपुट यहाँ दिखेगा।",
    "A saída vai aparecer aqui assim que você clicar em Executar Brainstorm."
  ],
  [
    "Output:",
    "输出：",
  ...
  [
    ...
    "ओवरराइड हर प्रोजेक्ट के लिए अलग सेव होता है। रोल का डिफ़ॉल्ट वापस लाने के लिए 🔄 रीसेट पर क्लिक करें।",
    "A sobrescrita é salva por projeto. Clique em 🔄 Redefinir para restaurar o padrão do papel."
  ],
  [
    ...
    "कैनवास टीम को ओवरराइड करें",
    "Sobrescrever a equipe do canvas"
  ],
  [
    "OWLLM",
    "OWLLM",
  ...
  [
    ...
    "OwLLM은 개인 키(이 컴퓨터에 암호화되어 저장됨)를 생성하며, 또한",
    ...
    "OwLLM निजी कुंजी बनाता है (इस मशीन पर एन्क्रिप्टेड रखी जाती है) और एक",
    "O OwLLM cria a chave privada (mantida criptografada nesta máquina) e uma"
  ],
  [
    ...
    "OwLLM Desktop · अपडेट उपलब्ध",
    "OwLLM Desktop · Atualização disponível"
  ],
  [
    "OWLLM_SIGN_*",
    "OWLLM_SIGN_*",
  ...
  [
    ...
    "owner/model — उदा. unsloth/Llama-3.2-3B-Instruct-bnb-4bit",
    "proprietário/modelo — ex.: unsloth/Llama-3.2-3B-Instruct-bnb-4bit"
  ],
  [
    "owner/name — empty = publish script's default",
    "所有者/名称 — 空 = 使用发布脚本的默认值",
    "owner/name — 비어 있음 = 게시 스크립트의 기본값",
    "所有者/名前 — 空欄 = 公開スクリプトのデフォルト",
    "مالك/اسم — فارغ = الافتراضي لبرنامج النشر",
    "proprietario/nome — vuoto = predefinito dello script di pubblicazione",
    "owner/name — खाली = publish स्क्रिप्ट का डिफ़ॉल्ट",
    "proprietário/nome — vazio = padrão do script de publicação"
  ],
  [
    "pack",
    "包",
  ...
  [
    ...
    "पेज और यह यहाँ अपने आप मिरर हो जाता है।",
    "página e é espelhado aqui automaticamente."
  ],
  [
    "Page not ported yet",
    "页面尚未移植",
    ...
    "पेज अभी पोर्ट नहीं हुआ है",
    "Página ainda não portada"
  ],
  [
    "Pair",
    "配对",
  ...
  [
    ...
    "ペア（自己テスト）",
    "إقران (اختبار ذاتي)",
    "Associa (autoverifica)",
    "पेयर करें (सेल्फ़-टेस्ट)",
    "Parear (autoteste)"
  ],
  [
    ...
    "associa tramite ip:porta (es. 192.168.1.5:47771)",
    "ip:port से पेयर करें (उदा. 192.168.1.5:47771)",
    "parear por ip:porta (ex.: 192.168.1.5:47771)"
  ],
  [
    ...
    "पेयरिंग अनुरोध — मंज़ूरी ज़रूरी",
    "Solicitação de pareamento — aprovação necessária"
  ],
  [
    "Pairs / chunk",
    "配对 / 块",
  ...
  [
    ...
    "पैरलल डिस्पैच (स्वतंत्र एजेंट एक साथ चलाएँ)",
    "despacho paralelo (executar agentes independentes ao mesmo tempo)"
  ],
  [
    "pass",
    "通过",
  ...
  [
    ...
    "सबसे हाल की एंट्रीज़ देखने के लिए खाली क्वेरी भेजें।",
    "Passe uma query vazia para ver as entradas mais recentes."
  ],
  [
    "password",
    "密码",
  ...
  [
    ...
    "GitHub टोकन पेस्ट करें ताकि एजेंट प्राइवेट repos को clone कर सकें और सैंडबॉक्स के अंदर से push कर सकें।",
    "Cole um token do GitHub para que os agentes possam clonar repos privados e fazer push de dentro do sandbox."
  ],
  [
    ...
    "URL पेस्ट करें और Enter दबाएँ…",
    "Cole uma URL e pressione Enter…"
  ],
  [
    "paste key here",
    "在此处粘贴密钥",
  ...
  [
    ...
    "अपना read टोकन यहाँ पेस्ट करें (hf_… से शुरू होता है)",
    "Cole seu token de leitura aqui (começa com hf_…)"
  ],
  [
    ...
    "Google Cloud OAuth क्लाइंट (web app टाइप) से डाउनलोड की गई gcp-oauth.keys.json का पाथ। README देखें।",
    "Caminho para o gcp-oauth.keys.json baixado de um cliente OAuth do Google Cloud (tipo web app). Veja o README."
  ],
  [
    ...
    "रिमोट होस्ट पर फ़ाइल का पाथ।",
    "Caminho do arquivo no host remoto."
  ],
  [
    ...
    "उस JSON फ़ाइल का पाथ जहाँ ये सेटिंग्स सेव रहती हैं।",
    "Caminho do arquivo JSON onde essas configurações são salvas."
  ],
  [
    ...
    "भेजी जाने वाली लोकल फ़ाइल का पाथ।",
  ...
  [
    ...
    "पाथ, जिसे आप फिर सामान्य स्क्रीनशॉट/विज़न पाथ से देखते हैं), 'type' (एक टेक्स्ट स्ट्रिंग टाइप करें via",
    "caminho que você então visualiza pelo caminho normal de screenshot/visão), 'type' (digita uma string de texto via"
  ],
  [
    "Pause",
    "暂停",
  ...
  [
    ...
    "PDF, DOCX, TXT, MD या वेब पेज। ये कभी आपकी मशीन से बाहर नहीं जाते।",
    "PDF, DOCX, TXT, MD ou páginas web. Eles nunca saem da sua máquina."
  ],
  [
    "pending",
    "待处理",
  ...
  [
    ...
    "मॉडल + रंग + प्रॉम्प्ट को टीम टेम्पलेट में सेव करें",
    "Persistir modelo + cor + prompt no template da equipe"
  ],
  [
    ...
    "ये सेटिंग्स ~/.owllm/bridge_config.json में सेव करें",
    "Persistir essas configurações em ~/.owllm/bridge_config.json"
  ],
  [
    ...
    "~/.owllm/bridge_config.json में सेव करें",
    "Persistir em ~/.owllm/bridge_config.json"
  ],
  [
    ...
    "परसिस्टेंट नॉलेज-ग्राफ़ स्टोर। एजेंट सेशनों के आर-पार फ़ैक्ट सेव और रिकॉल कर सकते हैं।",
    "Armazenamento persistente de grafo de conhecimento. Agentes podem salvar e recuperar fatos entre sessões."
  ],
  [
    "Personal access token. Classic or fine-grained both work. Grant the scopes you want the agent to use (repo, read:org, etc).",
    "个人访问令牌。经典或精细控制的都可以。授予您希望智能体使用的权限范围（repo、read:org 等）。",
    ...
    "رمز الوصول الشخصي. الكلاسيكي أو المفصل كلاهما يعمل. امنح النطاقات التي تريد أن يستخدمها الوكيل (repo، read:org، إلخ).",
    ...
    "पर्सनल एक्सेस टोकन। Classic या fine-grained दोनों चलते हैं। वे scopes दें जो आप एजेंट से इस्तेमाल करवाना चाहते हैं (repo, read:org आदि)।",
    "Token de acesso pessoal. Tanto o clássico quanto o refinado funcionam. Conceda os escopos que você quer que o agente use (repo, read:org, etc)."
  ],
  [
    "Personal assistant",
    "个人助手",
  ...
  [
    ...
    "पहले ऊपर Base Model कार्ड में एक बेस मॉडल चुनें।",
    "Escolha primeiro um modelo base no card Modelo Base acima."
  ],
  [
    ...
    "वर्कस्पेस रूट के तौर पर इस्तेमाल के लिए कोई दूसरा फ़ोल्डर चुनें।",
    "Escolha outra pasta para usar como raiz do workspace."
  ],
  [
    ...
    "अपनी ड्राइव पर एक फ़ोल्डर चुनें…",
    "Escolha uma pasta no seu drive…"
  ],
  [
    ...
    "एक फ़ोल्डर चुनें, एक मॉडल चुनें और बदलाव बताएं।",
    "Escolha uma pasta, selecione um modelo e descreva a mudança."
  ],
  [
    ...
    "पहले ऊपर एक मॉडल चुनें।",
    "Escolha primeiro um modelo acima."
  ],
  [
    ...
    "सर्वर शुरू करने के लिए ऊपर एक मॉडल चुनें।",
    "Escolha um modelo acima para iniciar um servidor."
  ],
  [
    ...
    "पेयर जनरेट करने के लिए एक मॉडल चुनें।",
    "Escolha um modelo para gerar os pares."
  ],
  [
    ...
    "एक मॉडल चुनें, गाइडेड वॉकथ्रू पाएँ, या अपनी स्क्रीन का स्क्रीनशॉट लेकर पूछें।",
    "Escolha um modelo, receba tutoriais guiados ou capture a tela e pergunte."
  ],
  [
  ...
  [
    ...
    "ऊपर की पट्टी में एक प्रोजेक्ट चुनें, या क्लिक करें",
    "Escolha um projeto na faixa no topo, ou clique em"
  ],
  [
    ...
    "ऊपर की पट्टी में एक प्रोजेक्ट चुनें, या कोई टीम टेम्पलेट लोड करें।",
    "Escolha um projeto na faixa no topo, ou carregue um template de equipe."
  ],
  [
    ...
    "पट्टी में एक प्रोजेक्ट चुनें, या क्लिक करें",
    "Escolha um projeto na faixa, ou clique em"
  ],
  [
    ...
    "शुरू करने के लिए एक प्रोजेक्ट या टीम टेम्पलेट चुनें।",
    "Escolha um projeto ou template de equipe para começar."
  ],
  [
    ...
    "एक क्वांटाइज़ेशन चुनें, फिर Export पर क्लिक करें।",
    "Escolha uma quantização e clique em Exportar."
  ],
  [
    ...
    "पहले कोई सोर्स चुनें या कस्टम git URL पेस्ट करें।",
    "Escolha uma fonte ou cole uma URL git personalizada primeiro."
  ],
  [
    ...
    "ग्रिड से एक टीम चुनें ताकि उसके साथ आने वाले एजेंट देख सकें,",
    "Escolha uma equipe na grade para ver os agentes que a acompanham,"
  ],
  [
    ...
    "एक ट्रेनिंग डेटासेट चुनें",
    "Escolha um dataset de treinamento"
  ],
  [
    ...
    "पहले एक ट्रेनिंग डेटासेट चुनें (ऊपर Dataset कार्ड)।",
    "Escolha primeiro um dataset de treinamento (card Dataset acima)."
  ],
  [
    "Pick a voice",
    "选择一个语音",
  ...
  [
    ...
    "एक वर्कफ़्लो चुनें: Code Operator, Product Studio, Research Lab, Chief of Staff, n8n Workflow Builder, Data Room या Content Studio। MCP पैक उन वर्कफ़्लो के लिए ज़रूरी टूल कॉन्फ़िगर करते हैं।",
    "Escolha um fluxo de trabalho: Code Operator, Product Studio, Research Lab, Chief of Staff, n8n Workflow Builder, Data Room ou Content Studio. Os pacotes MCP configuram as ferramentas de que esses fluxos precisam."
  ],
  [
    ...
    "पहले वर्कस्पेस फ़ोल्डर चुनें (Browse)।",
    "Escolha primeiro uma pasta de workspace (Procurar)."
  ],
  [
    ...
    "पहले वर्कस्पेस फ़ोल्डर चुनें…",
    "Escolha primeiro uma pasta de workspace…"
  ],
  [
    ...
    "एजेंट चुनें, नाम दें, टेम्पलेट के रूप में सेव करें।",
    "Escolha os agentes, dê um nome e salve como template."
  ],
  [
    "Pick an icon for",
    "选择一个图标为",
  ...
  [
    ...
    "कम से कम एक फ़ाइल चुनें, या 'सभी डाउनलोड करें' चेक करें।",
    "Escolha pelo menos um arquivo ou marque 'Baixar tudo'."
  ],
  [
    ...
    "पहले कोई फ़ोल्डर चुनें या टाइप करें",
    "Escolha ou digite uma pasta primeiro"
  ],
  [
    ...
    "कार्ड / नोड का रंग चुनें",
    "Escolha a cor do card / nó"
  ],
  [
    ...
    "चुनें कि इन्फ़रेंस सर्वर कौन-सा डाउनलोड किया हुआ मॉडल सर्व करे।",
    "Escolha qual modelo baixado o servidor de inferência deve servir."
  ],
  [
    "Pin to top",
    "置顶",
  ...
  [
    ...
    "चल रहे MCP सर्वर के /health एंडपॉइंट को ping करें और दिखाएँ कि वह जवाब दे रहा है या नहीं।",
    "Faz ping no endpoint /health do servidor MCP em execução e mostra se ele está respondendo."
  ],
  [
    "Pipeline: {0}",
    "管道：{0}",
  ...
  [
    ...
    "काम की योजना बनाता है और विशेषज्ञों को डिस्पैच करता है।",
    "Planeja o trabalho e despacha os especialistas."
  ],
  [
    "Play",
    "播放",
  ...
  [
    ...
    "ठीक उसी इवेंट स्ट्रीम से स्क्रिप्टेड डेमो चलाएँ जो एक असली रन एमिट करता है",
    "Reproduza uma demo roteirizada usando o MESMO fluxo de eventos que uma execução real emite"
  ],
  [
    "port",
    "端口",
  ...
  [
    ...
    "टोकन पेस्ट करना चाहेंगे?",
    "Prefere colar um token?"
  ],
  [
    "preferred, falling back to Brave Search when a key is saved. Use this",
    "优先使用，保存密钥后回退到 Brave Search。使用此",
    "선호됨, 키가 저장되어 있을 때 Brave Search로 대체됩니다. 이것을 사용하세요",
    "が優先され、キーが保存されている場合は Brave Search にフォールバックします。これを使用",
    ...
    "को प्राथमिकता दी जाती है, और कुंजी सेव होने पर Brave Search पर फ़ॉलबैक होता है। इसका उपयोग करें",
    "preferido, com fallback para o Brave Search quando uma chave está salva. Use isto"
  ],
  [
    "preparing",
    "正在准备",
  ...
  [
    ...
    "준비 중 (메모리 · 샌드박스 · 모델)…",
    "準備中（メモリ · サンドボックス · モデル）… ",
    "التحضير (الذاكرة · sandbox · النموذج)…",
    "Preparazione (memoria · sandbox · modello)…",
    "तैयारी हो रही है (मेमोरी · सैंडबॉक्स · मॉडल)…",
    "Preparando (memória · sandbox · modelo)…"
  ],
  [
    ...
    "प्राइवेट वर्कस्पेस तैयार हो रहा है",
    "Preparando um workspace privado para"
  ],
  [
    "Preparing next item...",
    "正在准备下一个项目...",
    ...
    "अगला आइटम तैयार हो रहा है...",
    "Preparando o próximo item..."
  ],
  [
    ...
    "Preparazione dello spazio di lavoro — si sblocca tra un momento",
    "वर्कस्पेस तैयार हो रहा है — बस एक पल में अनलॉक होगा",
    "Preparando o workspace — desbloqueia em instantes"
  ],
  [
    ...
    "Premi un tasto della tastiera nel browser persistente (es. 'Enter', 'Tab', 'Escape',",
    "परसिस्टेंट ब्राउज़र में कीबोर्ड की कोई key दबाएँ (जैसे 'Enter', 'Tab', 'Escape',",
    "Pressione uma tecla do teclado no browser persistente (ex.: 'Enter', 'Tab', 'Escape',"
  ],
  [
    ...
    "ब्राउज़र डिटेक्ट करने के लिए Rescan दबाएँ।",
    "Pressione Reescanear para detectar navegadores."
  ],
  [
    "Press Stop to abort.",
    "按“停止”以中止。",
    ...
    "रोकने के लिए Stop दबाएँ।",
    "Pressione Parar para abortar."
  ],
  [
    ...
    "काम करते समय सजावटी विंडो फ़्रेम को फीका होने से रोकें",
    "Impede que a moldura decorativa da janela esmaeça enquanto você trabalha"
  ],
  [
    "Preview this voice",
    "预览此语音",
    ...
    "इस आवाज़ का प्रीव्यू सुनें",
    "Ouvir uma prévia desta voz"
  ],
  [
    "probing hardware…",
    "探测硬件…",
  ...
  [
    ...
    "प्रोजेक्ट — सेव किए गए रोस्टर के एजेंट।",
    "Projeto — agentes do roster salvo."
  ],
  [
    "Project Brainstorm",
    "项目头脑风暴",
  ...
  [
    ...
    "प्रोजेक्ट सेटिंग्स — फ़ोल्डर, सुरक्षा, टीम, ब्रिज, नाम बदलें, हटाएँ",
    "Configurações do projeto — pasta, segurança, equipe, bridge, renomear, excluir"
  ],
  [
    ...
    "स्थायी फ़ैक्ट में बदलें (हमेशा के लिए सेव, आपके सभी PC पर सिंक)",
    "Promover a um fato permanente (mantido para sempre, sincronizado entre seus PCs)"
  ],
  [
    "prompt",
    "提示",
  ...
  [
    ...
    "प्रॉम्प्ट (इस एजेंट के रोल को बढ़ाता है)",
    "Prompt (complementa o papel deste agente)"
  ],
  [
    "Proposed plan",
    "拟议计划",
  ...
  [
    ...
    "प्रस्तावित टीम — समीक्षा करें, फिर लागू करें। चलाने से पहले कैनवास पर हर एजेंट का मॉडल बदल सकते हैं।",
    "Equipe proposta — revise e depois aplique. Você pode mudar o modelo de cada agente no canvas antes de executar."
  ],
  [
    "Proposed update",
    "拟议更新",
  ...
  [
    ...
    "सुरक्षित · केवल निरीक्षण",
    "Protegido · somente inspeção"
  ],
  [
    "Public endpoint",
    "公共端点",
  ...
  [
    ...
    "नई रिलीज़ पब्लिश करें? ({0})",
    "Publicar uma nova release? ({0})"
  ],
  [
    "Publish command",
    "发布命令",
  ...
  [
    ...
    "पब्लिक रिलीज़ पब्लिश करें",
    "Publicar release pública"
  ],
  [
    "Publish script",
    "发布脚本",
  ...
  [
    ...
    "publish-release.sh：构建 → minisign → latest.json → gh release → 验证)。",
    "publish-release.sh: 빌드 → minisign → latest.json → gh release → 검증).",
    "publish-release.sh: ビルド → minisign → latest.json → gh release → 検証)。",
    "publish-release.sh: البناء → minisign → latest.json → gh release → التحقق).",
    "publish-release.sh: build → minisign → latest.json → gh release → verify).",
    "publish-release.sh: build → minisign → latest.json → gh release → verify).",
    "publish-release.sh: build → minisign → latest.json → gh release → verify)."
  ],
  ...
  [
    ...
    "GitHub वॉल्ट से डिवाइस रिकॉर्ड लाएँ",
    "Buscar registros de dispositivos do vault do GitHub"
  ],
  [
    "Push",
    "推送",
  ...
  [
    ...
    "{1}의 커밋 {0}개를 origin에 push",
    "{1}の{0}件のコミットをoriginにプッシュ",
    "Push {0} commit من {1} إلى origin",
    "Push {0} commit(s) su {1} su origin",
    "{1} पर मौजूद {0} commit को origin पर push करें",
    "Fazer push de {0} commit(s) de {1} para origin"
  ],
  [
    "Push {0} to origin",
    "将 {0} 推送到 origin",
    ...
    "Push {0} إلى origin",
    "Push {0} su origin",
    "{0} को origin पर push करें",
    "Fazer push de {0} para origin"
  ],
  [
    ...
    "GitHub secrets में push करें",
    "Enviar para os secrets do GitHub"
  ],
  [
    "Q2_K",
    "Q2_K",
  ...
  [
    ...
    "메시지를 대기열에 추가…",
    "またメッセージを送る...",
    "أضف رسالة أخرى إلى قائمة الانتظار…",
    "Metti in coda un altro messaggio…",
    "एक और संदेश क़तार में जोड़ें…",
    "Adicionar outra mensagem à fila…"
  ],
  [
    "queued",
    "已排队",
  ...
  [
    ...
    "क़तार में — लाइव रन को दिशा देता है",
    "na fila — direciona a execução ao vivo"
  ],
  [
    ...
    "क्विक ऐड — लोकप्रिय MCP सर्वर",
    "Adição rápida — servidores MCP populares"
  ],
  [
    "Qwen 3 (thinking)",
    "Qwen 3（思考）",
  ...
  [
    ...
    "रॉ मॉडल आउटपुट यहाँ दिखाई देगा।",
    "A saída bruta do modelo aparecerá aqui."
  ],
  [
    ...
    "Reinserisci le regole di best practice integrate che hai eliminato (non duplicherà quelle che hai mantenuto)",
    "आपके द्वारा हटाए गए बिल्ट-इन बेस्ट-प्रैक्टिस नियम फिर से जोड़ें (जो नियम आपने रखे हैं उनकी नक़ल नहीं बनेगी)",
    "Readicione as regras de boas práticas integradas que você excluiu (não duplicará as que você manteve)"
  ],
  [
    "Re-check",
    "重新检查",
  ...
  [
    ...
    "WSL / GPU / एनवायरनमेंट / रनटाइम फिर से जाँचें",
    "Verificar novamente WSL / GPU / ambiente / runtime"
  ],
  [
    ...
    "इस टीम के एजेंट + वायरिंग को बिल्ट-इन {0} टेम्पलेट से फिर से तैयार करें (नाम बदले/नई भूमिका वाले एजेंट भी शामिल)। आपके प्रति-एजेंट मॉडल चयन बने रहते हैं।",
    "Rederive os agentes + a fiação deste time a partir do template integrado {0} (capta agentes renomeados/reaproveitados). Mantém suas escolhas de modelo por agente."
  ],
  [
    "Re-open this step",
    "重新打开此步骤",
  ...
  [
    ...
    "ब्रेनस्टॉर्म फिर से चलाएँ (BRIEF.md मौजूद है — ओवरराइट हो जाएगा)",
    "Executar o brainstorm novamente (BRIEF.md existe — será sobrescrito)"
  ],
  [
    ...
    "लाइव इन्फ़रेंस सर्वर के लिए फिर से स्कैन करें।",
    "Reescanear em busca de servidores de inferência ativos."
  ],
  [
    "Read",
    "读取",
  ...
  [
    ...
    "डिस्क से UTF-8 टेक्स्ट फ़ाइल पढ़ें। सामग्री स्ट्रिंग के रूप में लौटाता है।",
    "Lê um arquivo de texto UTF-8 do disco. Retorna o conteúdo como string."
  ],
  [
    ...
    "एक साझा-मेमोरी एंट्री उसकी सटीक key से पढ़ें (सटीक पूरक है",
    "Lê UMA entrada da memória compartilhada pela sua chave exata (o complemento preciso de"
  ],
  [
    ...
    "उपयोगकर्ता के साझा code-signing क्रेडेंशियल्स पढ़ें (OwLLM Signing पेज पर प्रबंधित) ताकि आप",
    "Lê as credenciais compartilhadas de assinatura de código do usuário (gerenciadas na página Signing do OwLLM) para que você possa"
  ],
  [
    "read_file",
    "read_file",
  ...
  [
    ...
    "केवल रीड-ओनली डायग्नोस्टिक्स",
    "apenas diagnósticos somente leitura"
  ],
  [
    ...
    "रीड-ओनली Postgres क्वेरीज़। आख़िरी arg में अपना कनेक्शन URL डालें।",
    "Consultas Postgres somente leitura. Edite o ÚLTIMO argumento com a sua URL de conexão."
  ],
  [
    "Readiness check",
    "准备就绪检查",
  ...
  [
    ...
    "रेडीनेस जाँच चल रही है… — क्या कमी है देखने के लिए क्लिक करें",
    "Verificação de prontidão em execução… — clique para ver o que falta"
  ],
  [
    "reading notebook...",
    "正在读取笔记本...",
  ...
  [
    ...
    "README जो अभी मौजूद नहीं हैं।",
    "READMEs que ainda não existem."
  ],
  [
    ...
    "पढ़ता है। One-click के लिए चाहिए",
    "leituras. O one-click precisa do"
  ],
  [
    "ready",
    "准备就绪",
  ...
  [
    ...
    "جاهز. تشغّل الإجراءات git على جانب المضيف — تظهر المخرجات هنا.",
    "Pronto. Le azioni eseguono git lato host — l'output appare qui.",
    "तैयार। एक्शन होस्ट-साइड git चलाते हैं — आउटपुट यहाँ दिखेगा।",
    "Pronto. As ações executam git no lado do host — a saída aparece aqui."
  ],
  [
    "reboot once",
    "重启一次",
  ...
  [
    ...
    "Ambienti ricostruibili",
    "फिर से बनाए जा सकने वाले एनवायरनमेंट",
    "Ambientes reconstruíveis"
  ],
  [
    ...
    "बाद में उसे वापस पाएँ (dispatches और आने वाले रन, दोनों में)। स्थिर, दोबारा काम आने वाली",
    "recuperá-la depois (entre dispatches E execuções futuras). Use para informações estáveis e reutilizáveis"
  ],
  [
    "Recent",
    "最近的",
  ...
  [
    ...
    "回收磁盘空间？这会物理缩小 WSL 磁盘文件。它将：• 重启 WSL（正在运行的代理都会停止）• 请求 Windows 管理员权限 • 最多需要一分钟 提示：先按“清除缓存”，这样可以回收更多空间。是否继续？",
    ...
    "डिस्क स्पेस वापस पाएँ? यह WSL डिस्क फ़ाइल को भौतिक रूप से छोटा करता है। यह: • WSL रीस्टार्ट करेगा (चल रहे सभी एजेंट रुक जाएँगे) • Windows एडमिन प्रॉम्प्ट माँगेगा • एक मिनट तक ले सकता है सुझाव: पहले “कैश साफ़ करें” दबाएँ ताकि वापस पाने को और जगह हो। जारी रखें?",
    "Recuperar espaço em disco? Isso reduz fisicamente o arquivo de disco do WSL. Vai: • REINICIAR o WSL (agentes em execução param) • pedir um prompt de administrador do Windows • levar até um minuto Dica: clique antes em “Limpar caches” para haver mais o que recuperar. Continuar?"
  ],
  [
    "recommended",
    "推荐",
  ...
  [
    ...
    "चुनी हुई विंडो जैसी है वैसी रिकॉर्ड हो रही है। OWLLM फ़्रेम के लिए, रोकें और “पूरी स्क्रीन” चुनकर फिर से रिकॉर्ड करें। रोकने के लिए Ctrl+Shift+R।",
    "Gravando a janela escolhida como está. Para o frame do OWLLM, pare e grave novamente escolhendo “Tela inteira”. Ctrl+Shift+R para parar."
  ],
  [
    ...
    "पूरी स्क्रीन रिकॉर्ड हो रही है। शेयर डायलॉग में “पूरी स्क्रीन” चुनें। रोकने के लिए Ctrl+Shift+R दबाएँ।",
    "Gravando a tela inteira. Na caixa de diálogo de compartilhamento, escolha “Tela inteira”. Pressione Ctrl+Shift+R para parar."
  ],
  [
    "Recording.",
    "录制中。",
  ...
  [
    ...
    "Anthropic द्वारा मेंटेन किए गए रेफ़रेंस सर्वर। कैननिकल सूची + सेटअप नोट्स के लिए README पढ़ें।",
    "Servidores de referência mantidos pela Anthropic. Leia o README para a lista canônica + notas de configuração."
  ],
  [
    ...
    "حسّن الموجز، أو كوّن فريقًا في الأعلى…",
    "Perfeziona il brief, o assembla un team qui sopra…",
    "ब्रीफ़ को निखारें, या ऊपर एक टीम बनाएँ…",
    "Refine o brief, ou monte um time acima…"
  ],
  [
    "Refresh",
    "刷新",
  ...
  [
    ...
    "हर पिकर में मॉडल सूचियाँ रिफ़्रेश करें",
    "Atualizar as listas de modelos em todos os seletores"
  ],
  [
    ...
    "किसी डायरेक्टरी की फ़ाइलों में regex कंटेंट खोज। लौटाता है",
    "Busca de conteúdo por regex nos arquivos de um diretório. Retorna"
  ],
  [
    "Rejected",
    "被拒绝",
  ...
  [
    ...
    "गलत फ़ॉर्मैट वाली कॉल अस्वीकृत: {0}",
    "Chamada malformada rejeitada: {0}"
  ],
  [
    "Relay",
    "中继",
  ...
  [
    ...
    "रिलीज़ (नियम-आधारित publish)",
    "Release (publicação baseada em regras)"
  ],
  [
    "Release notes",
    "发布说明",
  ...
  [
    ...
    "GitHub + अपडेटर में दिखाए जाने वाले रिलीज़ नोट्स।",
    "Notas de release exibidas no GitHub + no atualizador."
  ],
  [
    "Release repo",
    "发布仓库",
  ...
  [
    ...
    "रिलीज़ टारगेट repo (प्रोजेक्ट कार्ड)",
    "Repo de destino do release (Cartão do Projeto)"
  ],
  [
    "Release visibility",
    "发布可见性",
  ...
  [
    ...
    "Ricarica la pagina corrente nel browser persistente. Dopo, fai uno snapshot per rileggere gli elementi.",
    "परसिस्टेंट ब्राउज़र में मौजूदा पेज रीलोड करें। एलिमेंट दोबारा पढ़ने के लिए बाद में snapshot लें।",
    "Recarrega a página atual no navegador persistente. Depois, faça um snapshot para reler os elementos."
  ],
  [
    "REMOTE",
    "远程",
  ...
  [
    ...
    "रिमोट डिवाइस ऑडिट",
    "Auditoria de dispositivos remotos"
  ],
  [
    ...
    "Remote Devices के लिए डेस्कटॉप ऐप (Tauri) रनटाइम ज़रूरी है।",
    "Dispositivos Remotos requer o runtime do app desktop (Tauri)."
  ],
  [
    ...
    "रिमोट होस्ट/IP, या ~/.ssh/config का कोई alias।",
    "Host/IP remoto, ou um alias do ~/.ssh/config."
  ],
  [
    ...
    "रिमोट होस्ट/IP, या ~/.ssh/config से कोई alias।",
    "Host/IP remoto, ou um alias do ~/.ssh/config."
  ],
  [
    "Remote origin",
  ...
  [
    ...
    "हाल के प्रोजेक्ट्स से हटाएँ (फ़ाइलें डिस्क पर बनी रहेंगी)",
    "Remover dos projetos recentes (mantém os arquivos no disco)"
  ],
  [
  ...
  [
    ...
    "इंस्टॉल की गई स्किल '{0}' हटाएँ? इससे LLM/data/skills/{1}/ डिलीट हो जाएगा।",
    "Remover a skill instalada '{0}'? Isso exclui LLM/data/skills/{1}/."
  ],
  [
    "Remove MCP server '{0}'?",
    "移除 MCP 服务器 '{0}'？",
  ...
  [
    ...
    "लोकल {0} क्रेडेंशियल्स हटाएँ?",
    "Remover as credenciais locais de {0}?"
  ],
  [
    ...
    "このマシンから保存されている Apple 署名証明書とパスワードを削除しますか？",
    ...
    "इस मशीन से सेव किया गया Apple साइनिंग सर्टिफ़िकेट और पासवर्ड हटाएँ?",
    "Remover o certificado de assinatura da Apple e as senhas armazenados desta máquina?"
  ],
  [
    "Remove this agent",
    "删除此代理",
  ...
  [
    ...
    "यह इंस्टॉल की गई स्किल हटाएँ",
    "Remover esta skill instalada"
  ],
  [
    ...
    "이 저장된 노드 제거",
    "この保存済みノードを削除",
    "إزالة هذه العقدة المحفوظة",
    "Rimuovere questo Node salvato",
    "यह सेव किया गया Node हटाएँ",
    "Remover este Node salvo"
  ],
  [
    "Removed {0}.",
    "已删除 {0}。",
  ...
  [
    ...
    "नाम बदलें (सिर्फ़ दिखने का नाम — फ़ोल्डर नहीं बदलता)",
    "Renomear (apenas exibição — a pasta não muda)"
  ],
  [
    "Rename failed: {0}",
    "重命名失败：{0}",
  ...
  [
    ...
    "प्रोजेक्ट '{0}' का नया नाम:",
    "Renomear o projeto '{0}' para:"
  ],
  [
    ...
    "यह चरण फिर से खोलें (इसे वापस सक्रिय फ़ीड में ले जाता है)",
    "Reabrir esta etapa (move-a de volta para o feed ativo)"
  ],
  [
    "Replacement text.",
    "替换文本。",
  ...
  [
    ...
    "지속 브라우저의 현재 페이지(URL + 제목 + 로드 상태)를 보고합니다.",
    ...
    "परसिस्टेंट ब्राउज़र के मौजूदा पेज (URL + शीर्षक + लोड स्थिति) की रिपोर्ट दें।",
    "Informa a página atual (URL + título + estado de carregamento) do navegador persistente."
  ],
  [
    ...
    "रिपॉज़िटरी सेटिंग्स + रेडीनेस विवरण",
    "Configurações do repositório + detalhes de prontidão"
  ],
  [
    "Research",
    "研究",
  ...
  [
    ...
    "भूमिका/समूह के डिफ़ॉल्ट रंग पर रीसेट करें",
    "Redefinir para a cor padrão do papel/grupo"
  ],
  [
    "Reset zoom + pan",
    "重置缩放 + 平移",
  ...
  [
    ...
    "मॉडल सर्वर रीस्टार्ट करें",
    "Reiniciar o servidor de modelos"
  ],
  [
    ...
    "नया कॉन्टेक्स्ट साइज़ लागू करने के लिए सर्वर रीस्टार्ट करें।",
    "Reinicie o servidor para aplicar o novo tamanho de contexto."
  ],
  [
    "Resume",
    "恢复",
  ...
  [
    ...
    "परसिस्टेंट ब्राउज़र में मौजूदा पेज का दिखने वाला टेक्स्ट कंटेंट लौटाएँ।",
    "Retorna o conteúdo de texto visível da página atual no navegador persistente."
  ],
  [
    ...
    "stdout, stderr, exit_code लौटाता है। git, npm install, python के लिए इस्तेमाल करें",
    "Retorna stdout, stderr, exit_code. Use para git, npm install, python"
  ],
  [
    ...
    "सेव किए गए PNG का path लौटाता है। प्रतिस्पर्धियों के GUI कैप्चर करने के लिए इसका उपयोग करें",
    "Retorna o caminho do PNG salvo. Use para capturar GUIs de concorrentes"
  ],
  [
    ...
    "Restituisce il log dello script; in caso di successo termina con PUBLISH_OK. Usa prima dry_run='true'",
    "स्क्रिप्ट लॉग लौटाता है; सफल होने पर अंत में PUBLISH_OK आता है। पहले dry_run='true' इस्तेमाल करें",
    "Retorna o log do script; o sucesso termina com PUBLISH_OK. Use dry_run='true' primeiro"
  ],
  [
    "review",
    "复审",
  ...
  [
    ...
    "复审工作、挑战假设、及早发现问题",
    "작업을 검토하고, 가정에 도전하며, 문제를 조기에 발견합니다",
    "作業をレビューし、前提を疑い、問題を早期に発見します",
    "يراجع العمل، ويتحدى الافتراضات، ويكتشف المشاكل مبكرًا",
    "revisiona il lavoro, mette in discussione le assunzioni, individua i problemi in anticipo",
    "काम की समीक्षा करता है, मान्यताओं को चुनौती देता है, समस्याएँ जल्दी पकड़ता है",
    "revisa o trabalho, questiona suposições, detecta problemas cedo"
  ],
  [
    "Revoke",
    "撤销",
  ...
  [
    ...
    "इस होस्ट के लिए सहमति वापस लें",
    "Revogar o consentimento deste host"
  ],
  [
    "revoked",
    "已撤销",
  ...
  [
    ...
    "नियम सक्रिय टीम के हर एजेंट में इंजेक्ट किए जाते हैं (",
    "As regras são injetadas em todos os agentes do time ativo ("
  ],
  [
    "run",
    "运行",
  ...
  [
    ...
    "运行 `gh auth login` 以启用 secrets 推送和 release 发布。",
    ...
    "Esegui `gh auth login` per abilitare il push dei secret e le release.",
    "सीक्रेट push और रिलीज़ सक्षम करने के लिए `gh auth login` चलाएँ।",
    "Execute `gh auth login` para habilitar o push de segredos e os releases."
  ],
  [
    ...
    "किसी पेयर की गई (PAIRED) OwLLM डिवाइस पर शेल कमांड चलाएँ — OwLLM चला रहा दूसरा PC जो",
    "Execute um comando shell em um dispositivo OwLLM PAREADO — outro PC executando o OwLLM que"
  ],
  [
    ...
    "SSH के ज़रिए किसी रिमोट (REMOTE) होस्ट पर शेल कमांड चलाएँ, उपयोगकर्ता के मौजूदा SSH क्रेडेंशियल्स का उपयोग करते हुए",
    "Execute um comando shell em um host REMOTO via SSH, usando as credenciais SSH existentes do usuário"
  ],
  [
    ...
    "शेल कमांड चलाएँ। Windows पर cmd.exe /c, बाक़ी जगह sh -c इस्तेमाल होता है।",
    "Executa um comando shell. No Windows usa cmd.exe /c; nos demais, sh -c."
  ],
  [
    ...
    "एक एजेंटिक टीम चलाएँ — पूरे हुए रन यहाँ आते हैं और XP देते हैं जो नए सीन अनलॉक करते हैं।",
    "Execute um time agêntico — execuções concluídas chegam aqui e concedem XP que desbloqueia novas cenas."
  ],
  [
    "Run command: {0}",
    "运行命令：{0}",
  ...
  [
    ...
    "अगर पक्का नहीं कि क्या उपलब्ध है, तो पहले list_skills चलाएँ।",
    "Execute list_skills primeiro se não tiver certeza do que está disponível."
  ],
  [
    ...
    "실시간 실행 — 단계가 이를 조종함",
    "ライブ実行 — 手順で操作する",
    "التشغيل مباشر — الخطوات توجّهه",
    "esecuzione live — i passaggi la guidano",
    "रन लाइव है — चरण उसे दिशा देते हैं",
    "execução ao vivo — as etapas a direcionam"
  ],
  [
    "Run name",
    "运行名称",
  ...
  [
    ...
    "लक्षित जाँचें चलाएँ: venv, GPU, torch-बनाम-GPU आर्किटेक्चर, हर पैकेज",
    "Executa verificações direcionadas: venv, GPU, arquitetura torch vs. GPU, cada pacote"
  ],
  [
    ...
    "कार्ड + repo पर Steward का डिटर्मिनिस्टिक लिंट चलाएँ",
    "Executar o lint determinístico do Steward no cartão + repo"
  ],
  [
    "running",
    "正在运行",
  ...
  [
    ...
    "चल रहा है — गेटवे कनेक्टेड.{0}",
    "Em execução — gateway conectado.{0}"
  ],
  [
    "Running — last update_id {0}.{1}",
    "运行中 — 上次 update_id {0}.{1}",
    "실행 중 — 마지막 update_id {0}.{1}",
    "実行中 — 最終更新ID {0}.{1}",
    "جارٍ التشغيل — آخر update_id {0}.{1}",
    "In esecuzione — ultimo update_id {0}.{1}",
    "चल रहा है — आख़िरी update_id {0}.{1}",
    "Em execução — último update_id {0}.{1}"
  ],
  [
    ...
    "चल रहा है — हर {1} सेकंड पर {0} पोल हो रहा है.{2}",
    "Em execução — fazendo polling de {0} a cada {1}s.{2}"
  ],
  [
    ...
    "चल रहा है — Socket Mode कनेक्टेड.{0}",
    "Em execução — Socket Mode conectado.{0}"
  ],
  [
    "Running — webhook callback URL = <tunnel>/line.",
    "运行中 — webhook 回调 URL = <tunnel>/line.",
    ...
    "चल रहा है — webhook कॉलबैक URL = <tunnel>/line.",
    "Em execução — URL de callback do webhook = <tunnel>/line."
  ],
  [
    "running ·",
    "运行 ·",
  ...
  [
    ...
    "इसके ज़रिए ~32 \"हानिकारक\" + ~32 \"हानिरहित\" प्रॉम्प्ट चलाता है।",
    "Passa ~32 prompts \"nocivos\" + ~32 \"inofensivos\" por ele."
  ],
  [
    ...
    "चुने गए डिवाइस पर चलता है, इस पर नहीं",
    "executa no dispositivo selecionado, não neste"
  ],
  [
    ...
    "टूल + बाहरी एक्शन चलाता है (शेल, वेब, इंटीग्रेशन)",
    "executa ferramentas + ações externas (shell, web, integrações)"
  ],
  [
    "Runtime",
    "运行时间",
  ...
  [
    ...
    "रनटाइम (RTX 4090-क्लास GPU):",
    "Tempo de execução (GPU classe RTX 4090):"
  ],
  [
    "Runtime tools",
    "运行时工具",
  ...
  [
    ...
    "प्रत्येक लाइन से मिलान के लिए Rust regex।",
    "Regex Rust para comparar com cada linha."
  ],
  [
    "s · last:",
    "s · 上次：",
  ...
  [
    ...
    "इस एजेंट की मॉडल कॉल्स के लिए सैंपलिंग temperature। 0.0 = डिटर्मिनिस्टिक (कोड, गणित, प्लानिंग के लिए अच्छा)। 0.7 = संतुलित। 1.2 = क्रिएटिव / ब्रेनस्टॉर्मिंग। हर टास्क के डिफ़ॉल्ट के लिए खाली छोड़ें (ऑर्केस्ट्रेटर के लिए लगभग 0.4, गद्य के लिए 0.7)।",
    "Temperatura de amostragem para as chamadas de modelo deste agente. 0.0 = determinístico (bom para código, matemática, planejamento). 0.7 = equilibrado. 1.2 = criativo / brainstorm. Deixe vazio para o padrão por tarefa (cerca de 0.4 para orquestradores, 0.7 para prosa)."
  ],
  [
    ...
    "सैंडबॉक्स में फ़ाइल ऑपरेशंस। अनुमत रूट डायरेक्टरी सेट करने के लिए आख़िरी positional arg एडिट करें।",
    "Operações de arquivo em sandbox. Edite o ÚLTIMO argumento posicional para definir o diretório raiz permitido."
  ],
  [
    "SANITIZED",
    "已清理",
  ...
  [
    ...
    "सेव करके बाहर निकलें। Windows में वापस आकर, क्लिक करें",
    "Salve e saia. De volta ao Windows, clique em"
  ],
  [
    ...
    "साझा टीम मेमोरी में एक स्थायी तथ्य सेव करें ताकि आप और दूसरे एजेंट",
    "Salve um fato durável na MEMÓRIA COMPARTILHADA DA EQUIPE para que você e outros agentes possam"
  ],
  [
    "Save all",
    "全部保存",
  ...
  [
    ...
    "इस टीम में बदलाव सेव करें",
    "Salvar alterações nesta equipe"
  ],
  [
    "Save chat as JSON",
    "将聊天保存为 JSON",
    ...
    "चैट को JSON के रूप में सेव करें",
    "Salvar chat como JSON"
  ],
  [
    "Save dataset (JSONL)",
    "保存数据集（JSONL）",
    ...
    "Salva dataset (JSONL)",
    "डेटासेट सेव करें (JSONL)",
    "Salvar dataset (JSONL)"
  ],
  [
    "Save failed:",
    "保存失败：",
  ...
  [
    ...
    "निर्देश टेम्पलेट इस रूप में सेव करें:",
    "Salvar template de instrução como:"
  ],
  [
    "Save login",
    "保存登录信息",
  ...
  [
    ...
    "प्लान सेव करें + नोट्स साफ़ करें",
    "Salvar plano + limpar notas"
  ],
  [
    ...
    "मौजूदा Port / Token / Root / LAN सेटिंग्स को डिस्क पर सेव करें ताकि वे रीस्टार्ट के बाद भी बनी रहें।",
    "Salvar as configurações atuais de Porta / Token / Root / LAN no disco para que sobrevivam a uma reinicialização."
  ],
  [
    ...
    "मौजूदा सिस्टम प्रॉम्प्ट को एक नए नामित टेम्पलेट के रूप में सेव करें",
    "Salvar o prompt de sistema atual como um novo template nomeado"
  ],
  [
    ...
    "अपने बदलाव उसी जगह सेव करें — एक संपादन-योग्य ओवरराइड लिखता है जिसे ऐप बंडल की गई फ़ाइल की जगह लोड करता है",
    "Salve suas edições no local — grava um override editável que o app carrega em vez do arquivo empacotado"
  ],
  [
    "save: {0}",
    "保存: {0}",
  ...
  [
    ...
    "सेव किए गए लॉगिन इस मशीन पर एन्क्रिप्टेड रहते हैं और सिर्फ़ OwLLM ब्राउज़र के अंदर मेल खाने वाले पेज में ही सीधे इंजेक्ट किए जाते हैं — वे न कभी यहाँ दिखते हैं, न वॉल्ट से बाहर जाते हैं। ये इस पेज के हर \"Open … portal\" बटन को चलाते हैं, और एजेंट्स के ब्राउज़र को भी।",
    "Os logins salvos ficam criptografados nesta máquina e só são injetados diretamente na página correspondente dentro do navegador OwLLM — eles nunca aparecem aqui nem saem do cofre. Eles alimentam todos os botões \"Abrir … portal\" desta página, e também o navegador dos agentes."
  ],
  [
    ...
    "सेव किए गए लॉगिन जिन्हें एजेंट ऑटोफ़िल कर सकते हैं। इस डिवाइस पर एन्क्रिप्टेड स्टोर किए जाते हैं (Windows पर DPAPI)। पासवर्ड यहाँ कभी नहीं दिखाए जाते।",
    "Logins salvos que os agentes podem preencher automaticamente. Armazenados criptografados neste dispositivo (DPAPI no Windows). As senhas nunca são exibidas aqui."
  ],
  [
    ...
    "सेव किए गए नोड्स — कनेक्शन + लॉगिन जिन्हें एजेंट ऑटोफ़िल करते हैं (ताकि \"KVM का स्क्रीनशॉट लो\" सीधे काम करे, IP/पोर्ट/पासवर्ड का अंदाज़ा लगाने की ज़रूरत नहीं)। पासवर्ड इस PC पर एन्क्रिप्टेड रहता है और एजेंट्स या UI को कभी नहीं दिखाया जाता।",
    "Nós salvos — conexão + login que os agentes preenchem automaticamente (assim \"tirar screenshot do KVM\" simplesmente funciona, sem adivinhar IP/porta/senha). A senha é criptografada neste PC e nunca é mostrada aos agentes nem à UI."
  ],
  [
    "Saved to:",
    "已保存到：",
  ...
  [
    ...
    "비디오와 클릭 트랙을 저장했습니다.",
    "ビデオとクリックトラックを保存しました。",
    "تم حفظ الفيديو ومسار النقرات.",
    "Video salvato e tracciamento dei click.",
    "वीडियो और क्लिक ट्रैक सेव कर दिए गए।",
    "Vídeo e trilha de cliques salvos."
  ],
  [
    ...
    "संशोधित weights को एक नई transformers डायरेक्टरी में सेव करता है — किसी भी दूसरे मॉडल की तरह चलाने / quantize करने / फ़ाइन-ट्यून करने योग्य।",
    "Salva os pesos modificados em um novo diretório transformers — executável / quantizável / ajustável com fine-tuning como qualquer outro modelo."
  ],
  [
    "saving",
    "正在保存",
  ...
  [
    ...
    "स्कीमा अपने-आप सैनिटाइज़ कर दिया गया ताकि यह टूल-कॉलिंग न तोड़ सके: {0}",
    "O schema foi sanitizado automaticamente para não quebrar o tool-calling: {0}"
  ],
  [
    ...
    "स्कोप। सिर्फ़ इसी डिवाइस पर स्टोर किया गया।",
    "escopo. Armazenado apenas neste dispositivo."
  ],
  [
    ...
    "इस WebView में स्क्रीन कैप्चर उपलब्ध नहीं है।",
    "A captura de tela não está disponível neste WebView."
  ],
  [
    ...
    "हेडलेस Chromium (TwinForge web_adapter) के ज़रिए किसी URL का स्क्रीनशॉट लें।",
    "Capturar screenshot de uma URL via Chromium headless (TwinForge web_adapter)."
  ],
  [
    ...
    "تمت إزالة script/style، ودُمجت المسافات). الحد الأقصى 60 كيلوبايت.",
    "script/style rimossi, spazi bianchi compressi). Limite a 60 KB.",
    "script/style हटाए गए, व्हाइटस्पेस संकुचित)। अधिकतम 60 KB।",
    "script/style removidos, espaços em branco compactados). Limitado a 60 KB."
  ],
  [
    "scripts, etc.",
    "脚本等。",
  ...
  [
    ...
    "Cerca tra {0} abilità installate…",
    "{0} इंस्टॉल की गई स्किल्स में खोजें…",
    "Pesquisar entre {0} skills instaladas…"
  ],
  [
    "Search assets…",
    "搜索资产…",
  ...
  [
    ...
    "नाम, विवरण या पाथ से खोजें…",
    "Pesquisar por nome, descrição ou caminho…"
  ],
  [
    "Search Hugging Face…",
    "搜索 Hugging Face…",
  ...
  [
    ...
    "मेमोरी खोजें (कीवर्ड) — खाली रखने पर सबसे हाल की दिखेंगी",
    "Pesquisar na memória (palavras-chave) — vazio mostra as mais recentes"
  ],
  [
    "Search query string.",
    "搜索查询字符串。",
    ...
    "クエリ文字列を検索。",
    "سلسلة استعلام البحث.",
    "Stringa della query di ricerca.",
    "सर्च क्वेरी स्ट्रिंग।",
    "String da consulta de pesquisa."
  ],
  [
    ...
    "साझा टीम मेमोरी खोजें — एक स्थायी नॉलेज बेस जिसे पूरी टीम",
    "Pesquisar na MEMÓRIA COMPARTILHADA DA EQUIPE — uma base de conhecimento durável que toda a equipe"
  ],
  [
    ...
    "वेब पर खोजें। अधिकतम 5 परिणाम देता है (शीर्षक, url, स्निपेट)।",
    "Pesquisar na web. Retorna até 5 resultados (título, url, trecho)."
  ],
  [
    "Search…",
    "搜索…",
  ...
  [
    ...
    "दूसरा एजेंट — उसी workspace पर एक समानांतर कोडर, जिसकी अपनी बातचीत और अपना मॉडल है (ऊपर एक चुनें, वरना यह प्राइमरी चैट का मॉडल इस्तेमाल करता है)।",
    "Segundo agente — um coder paralelo no mesmo workspace, com a própria conversa e o próprio modelo (escolha um acima, ou ele usa o modelo do chat principal)."
  ],
  [
    ...
    "दूसरा एजेंट {0} में काम कर रहा है",
    "Segundo agente trabalhando em {0}"
  ],
  [
    "secrets your",
    "你的秘密",
  ...
  [
    ...
    "देखें कि मुफ़्त GitHub अकाउंट से आप क्या-क्या अनलॉक करते हैं",
    "Veja tudo o que você desbloqueia com uma conta GitHub gratuita"
  ],
  [
    "see notices",
    "查看通知",
  ...
  [
    ...
    "पूरे निर्देशों के लिए OPENAI_COMPATIBLE_API.md देखें।",
    "Veja OPENAI_COMPATIBLE_API.md para as instruções completas."
  ],
  [
    "Seen channels:",
    "已查看的频道：",
  ...
  [
    ...
    "पहले एक बेस मॉडल चुनें (ऊपर Base Model कार्ड)।",
    "Selecione primeiro um modelo base (card Modelo Base acima)."
  ],
  [
    "Select a project…",
    "选择一个项目…",
  ...
  [
    ...
    "इक्विप करने के लिए एक एजेंट चुनें",
    "selecione um agente para equipar"
  ],
  [
    ...
    "दिए गए इंडेक्स पर <select> ड्रॉपडाउन में एक विकल्प (value के अनुसार) चुनें, स्रोत है",
    "Selecionar uma opção (por valor) no dropdown <select> no índice indicado a partir do"
  ],
  [
    ...
    "नवीनतम browser_snapshot से एलिमेंट इंडेक्स चुनें।",
    "Selecione o índice do elemento a partir do browser_snapshot mais recente."
  ],
  [
    "Select Model:",
    "选择模型：",
  ...
  [
    ...
    "चुना गया — मॉडल A चुनते ही सर्वर शुरू हो जाएगा।",
    "Selecionado — o servidor iniciará quando você escolher o modelo A."
  ],
  [
    "selected ·",
    "已选择 ·",
  ...
  [
    ...
    "इन्फ़रेंस के लिए चुना गया — इस GPU को छोड़ने के लिए अनचेक करें",
    "Selecionada para inferência — desmarque para pular esta GPU"
  ],
  [
    ...
    "सिमेंटिक सर्च — रिसर्च/तथ्य खोजने के लिए कीवर्ड से बेहतर।",
    "Busca semântica — melhor que palavras-chave para pesquisa/apuração de fatos."
  ],
  [
    "Send",
    "发送",
  ...
  [
    ...
    "नीचे एक संदेश भेजें — यह कॉलम जवाब देगा।",
    "Envie uma mensagem abaixo — esta coluna responderá."
  ],
  [
    "Send message",
    "发送消息",
  ...
  [
    ...
    "इस डिवाइस को पेयरिंग अनुरोध भेजें (उसे आपको मंज़ूरी देनी होगी)",
    "Enviar a este dispositivo uma solicitação de pareamento (ele precisa aprovar você)"
  ],
  [
    ...
    "दूसरे एजेंट को भेजें",
    "Enviar para o segundo agente"
  ],
  [
    ...
    "अपना विवरण + यह व्यू + डायग्नोस्टिक्स + कोई भी स्क्रीनशॉट OwLLM टीम को भेजें।",
    "Envie sua descrição + esta visualização + diagnósticos + qualquer screenshot para a equipe do OwLLM."
  ],
  [
    "sent",
    "已发送",
  ...
  [
    ...
    "Sentry इंटरनल इंटीग्रेशन टोकन। Settings → Developer Settings → Internal Integrations।",
    "Token de integração interna do Sentry. Settings → Developer Settings → Internal Integrations."
  ],
  [
    ...
    "Sentry issues — सूची देखें, स्टैकट्रेस में गहराई से जाएँ, हाल की घटनाएँ।",
    "Issues do Sentry — listar, explorar stacktraces, eventos recentes."
  ],
  [
    "Server",
    "服务器",
  ...
  [
    ...
    "I log del server appariranno qui.",
    "सर्वर लॉग यहाँ दिखाई देंगे।",
    "Os logs do servidor aparecerão aqui."
  ],
  [
    "serving",
    "服务中",
  ...
  [
    ...
    "सेशन; localhost URL डिफ़ॉल्ट रूप से http)। बाद में browser_snapshot कॉल करें",
    "sessão; URLs localhost usam http por padrão). Chame browser_snapshot em seguida"
  ],
  [
    "set",
    "设置",
  ...
  [
    ...
    "रिलीज़ .exe/इंस्टॉलर को Authenticode-साइन करने और SmartScreen का \"unknown publisher\" हटाने के लिए एक सर्टिफ़िकेट सेट करें। बिना साइन के शिप करने के लिए दोनों खाली छोड़ें। सर्टिफ़िकेट उसी मशीन पर इंस्टॉल होना चाहिए जो Publish चलाती है (जैसे SimplySign/Certum क्लाउड कार्ड, कोई PFX, या HSM)।",
    "Defina um certificado para assinar com Authenticode o .exe/instalador da release e eliminar o \"editor desconhecido\" do SmartScreen. Deixe ambos vazios para distribuir sem assinatura. O certificado deve estar instalado na máquina que executa o Publish (ex.: cartão em nuvem SimplySign/Certum, um PFX ou um HSM)."
  ],
  [
    "Set key",
    "设置键",
  ...
  [
    ...
    "LINE Developers कंसोल में webhook URL इस पर सेट करें",
    "Defina a URL do webhook no console do LINE Developers para"
  ],
  [
    ...
    "किसी भी प्रोजेक्ट में साइन्ड + नोटराइज़्ड रिलीज़ सेट करें। स्थिति/मेटाडेटा देता है (identity, team id,",
    "configurar uma release assinada + notarizada em QUALQUER projeto. Retorna status/metadados (identidade, team id,"
  ],
  [
    "settings",
    "设置",
  ...
  [
    ...
    "المعرفة المشتركة التي يقرأها ويكتبها وكلاؤك",
    "Conoscenza condivisa che i tuoi agenti leggono e scrivono",
    "साझा नॉलेज जिसे आपके एजेंट पढ़ते और लिखते हैं",
    "Conhecimento compartilhado que seus agentes leem e escrevem"
  ],
  [
    ...
    "Segreto condiviso che i client esterni devono inviare come X-Auth-Token.",
    "साझा secret जिसे बाहरी क्लाइंट्स को X-Auth-Token के रूप में भेजना होगा।",
    "Segredo compartilhado que clientes externos devem enviar como X-Auth-Token."
  ],
  [
    "shared with team",
    "与团队共享",
  ...
  [
    ...
    "शिप करें — GitHub Actions secrets",
    "Lançar — secrets do GitHub Actions"
  ],
  [
    "Show",
    "显示",
  ...
  [
    ...
    "इसके बगल में एक दूसरा, स्वतंत्र एजेंट चैट पेन दिखाएँ — उसकी अपनी ट्रांसक्रिप्ट और इनपुट, वही workspace और मॉडल।",
    "Mostrar um segundo painel de chat de agente independente ao lado deste — com transcrição e entrada próprias, mesmo workspace e modelo."
  ],
  [
    "Show log",
    "显示日志",
  ...
  [
    ...
    "पूरे हो चुके स्टेप्स दिखाएँ या छिपाएँ",
    "Mostrar ou ocultar etapas concluídas"
  ],
  [
    ...
    "रॉ डाइजेस्ट ट्रांसक्रिप्ट दिखाएँ या छिपाएँ",
    "Mostrar ou ocultar a transcrição bruta do digest"
  ],
  [
    ...
    "तैयारी जाँचें दिखाएँ",
    "Mostrar verificações de prontidão"
  ],
  [
  ...
  [
    ...
    "टूल कॉल्स टैब दिखाएँ",
    "Mostrar a aba Chamadas de ferramentas"
  ],
  [
    ...
    "यूज़र इनपुट हिस्ट्री दिखाएँ",
    "Mostrar o histórico de entradas do usuário"
  ],
  [
    "Show tools",
    "显示工具",
  ...
  [
    ...
    "अपनी चैट और सेटिंग्स को डिवाइसों में सिंक करने के लिए साइन इन करें",
    "Entre para sincronizar seus chats e configurações entre dispositivos"
  ],
  [
    "Sign in with GitHub",
    "使用 GitHub 登录",
  ...
  [
    ...
    "ईमेल से साइन अप करें, कोई कार्ड नहीं। AI एजेंट्स के लिए बनाया गया — सामान्य वेब सर्च से ज़्यादा साफ़ नतीजे।",
    "Cadastre-se com e-mail, sem cartão. Feito para agentes de IA — resultados mais limpos que a busca comum na web."
  ],
  [
    "Signed",
    "已签名",
  ...
  [
    ...
    "SimplySign नहीं चल रहा",
    "SimplySign não está em execução"
  ],
  [
    "SimplySign running",
    "SimplySign 正在运行",
    ...
    "SimplySign चल रहा है",
    "SimplySign em execução"
  ],
  [
    ...
    "अनुमोदन→नियंत्रण फ़्लो चलाने के लिए एक पेयरिंग अनुरोध (v1 लूपबैक) सिम्युलेट करें",
    "Simular uma solicitação de pareamento (loopback v1) para acionar o fluxo aprovar→controlar"
  ],
  [
    ...
    "डाइजेस्ट के लिए एकल स्रोत",
    "fonte única para o digest"
  ],
  [
    ...
    "साइट (जैसे developer.apple.com)",
    "site (ex.: developer.apple.com)"
  ],
  [
    "site (e.g. github.com)",
    "网站（例如 github.com）",
  ...
  [
    ...
    "स्किल पैक 📚 स्किल लाइब्रेरी में मैनेज होते हैं — इसे हटाने के लिए उसे खोलें।",
    "Pacotes de skills são gerenciados na 📚 Biblioteca de Skills — abra-a para remover este."
  ],
  [
    "skills",
    "技能",
  ...
  [
    ...
    "स्किल्स ऐप के साथ बंडल की गई नामित क्षमता गाइड हैं। इसका इस्तेमाल करें",
    "Skills são guias de capacidades nomeados incluídos no app. Use isto para"
  ],
  [
    ...
    "स्किल्स SKILL.md क्षमता पैक हैं (Anthropic-शैली)। ये एजेंट नहीं हैं — आप किसी स्किल को एजेंट पर equip करते हैं (Team के Workbench में, या Agents पेज पर प्रति-एजेंट) और runtime उसे तभी लोड करता है जब किसी task को उसकी ज़रूरत हो। लाइब्रेरी से और install करें।",
    "Skills são pacotes de capacidades SKILL.md (no estilo Anthropic). Elas NÃO são agentes — você equipa uma skill em um agente (no Workbench de um Team ou por agente na página Agents) e o runtime a carrega apenas quando uma tarefa precisar. Instale mais a partir da biblioteca."
  ],
  [
    "skills equipped",
    "已装备技能",
  ...
  [
    ...
    "छोड़ें — केवल क्लाउड मॉडल इस्तेमाल करें",
    "Pular — usar apenas modelos na nuvem"
  ],
  [
    "Slack",
    "Slack",
  ...
  [
    ...
    "Slack वर्कस्पेस API — मैसेज, चैनल, खोज।",
    "API do workspace do Slack — mensagens, canais, busca."
  ],
  [
    "Slash commands",
    "斜杠命令",
  ...
  [
    ...
    "पहले snapshot लें ताकि index मिले; पेज बदल सकता है, इसलिए बाद में फिर से snapshot लें।",
    "Faça um snapshot primeiro para obter o índice; a página pode mudar, então faça outro snapshot depois."
  ],
  [
    ...
    "मौजूदा पेज का snapshot लें और इंटरैक्टिव एलिमेंट्स की INDEXED सूची लौटाएँ",
    "Faz um snapshot da página atual e retorna a lista INDEXADA de elementos interativos"
  ],
  [
    "sntrys_…",
    "sntrys_…",
  ...
  [
    ...
    "ताकि Windows Virtual Machine Platform चालू कर सके, फिर यहाँ वापस आएँ। इसके बाद हम आपके लिए Linux यूज़र बना देते हैं — आपको कोई उलझाने वाला Ubuntu कंसोल नहीं दिखेगा।",
    "para que o Windows possa ativar a Plataforma de Máquina Virtual, depois volte aqui. Em seguida criamos o usuário Linux para você — você não verá um console do Ubuntu confuso."
  ],
  [
    "Social media",
    "社交媒体",
  ...
  [
    ...
    "Socket Mode · app + bot token · किसी सार्वजनिक URL की ज़रूरत नहीं",
    "Modo Socket · app + token do bot · nenhuma URL pública necessária"
  ],
  [
    "Software / tool",
    "软件 / 工具",
  ...
  [
    ...
    "Solo-Loop — एक ही कोडर पूरा काम करता है, एक बार critic जाँच, नियम-आधारित publish",
    "Solo-Loop — um único coder faz todo o trabalho, uma única verificação do crítico, publicação baseada em regras"
  ],
  [
    ...
    "कुछ ऐसा जो पहले से पता हो सकता है। सबसे प्रासंगिक एंट्रीज़ लौटाता है।",
    "algo que talvez já seja conhecido. Retorna as entradas mais relevantes."
  ],
  [
    "Sort by",
    "排序方式",
  ...
  [
    ...
    "朗读代理回复——每个代理一种语音。点击 ▾ 切换引擎。",
    "대화 에이전트가 대답을 음성으로 읽음 — 에이전트별 음성. 엔진을 변경하려면 ▾ 클릭.",
    "エージェントの返信を声に出して話す — エージェントごとに声。エンジンを切り替えるには ▾ をクリック。",
    "نطق ردود الوكلاء بصوت عالٍ — صوت لكل وكيل. انقر ▾ لتغيير المحرك.",
    "Leggi ad alta voce le risposte degli agenti — una voce per agente. Clicca ▾ per cambiare motore.",
    "एजेंट के जवाब ज़ोर से बोलें — हर एजेंट की अपनी आवाज़। इंजन बदलने के लिए ▾ क्लिक करें।",
    "Falar as respostas dos agentes em voz alta — uma voz por agente. Clique em ▾ para trocar o motor."
  ],
  [
    ...
    "इस एजेंट के जवाब ज़ोर से बोलें",
    "Falar as respostas deste agente em voz alta"
  ],
  [
    ...
    "बोलने की गति (शब्द प्रति मिनट, 0 = डिफ़ॉल्ट)",
    "Velocidade de fala (palavras por minuto, 0 = padrão)"
  ],
  [
    "Speed",
    "速度",
  ...
  [
    ...
    "इस एजेंट के मॉडल से प्रॉम्प्ट टेक्स्ट को Mission / Rules / Definition of Done में बाँटें। सिर्फ़ वर्गीकृत करता है — आपके शब्द वैसे ही रहते हैं। समीक्षा करें, फिर Save करें।",
    "Divida o texto do prompt em Mission / Rules / Definition of Done usando o modelo deste agente. Apenas categoriza — mantém suas palavras. Revise e depois salve."
  ],
  [
    "SSH keys (no passwords). Returns stdout/stderr/exit_code. Use to operate,",
    "SSH 密钥（不含密码）。返回 stdout/stderr/exit_code。用于操作，",
    ...
    "Chiavi SSH (nessuna password). Restituisce stdout/stderr/exit_code. Usalo per operare,",
    "SSH keys (कोई पासवर्ड नहीं)। stdout/stderr/exit_code लौटाता है। संचालन के लिए इस्तेमाल करें,",
    "Chaves SSH (sem senhas). Retorna stdout/stderr/exit_code. Use para operar,"
  ],
  [
    "SSH port (default 22).",
    "SSH 端口（默认 22）。",
  ...
  [
    ...
    "SSH यूज़रनेम (ssh config / मौजूदा यूज़र इस्तेमाल करने के लिए खाली छोड़ें)।",
    "Nome de usuário SSH (omita para usar a configuração do ssh / usuário atual)."
  ],
  [
    "SSH username.",
    "SSH 用户名。",
  ...
  [
    ...
    "LoRA अडैप्टर बनाने के लिए Train टैब से एक ट्रेनिंग रन शुरू करें।",
    "Inicie um treinamento na aba Train para produzir um adaptador LoRA."
  ],
  [
    ...
    "डिक्टेशन शुरू करें (Web Speech)",
    "Iniciar ditado (Web Speech)"
  ],
  [
    "Start failed: {0}",
    "启动失败：{0}",
    ...
    "فشل البدء: {0}",
    "Avvio fallito: {0}",
    "शुरू करने में विफल: {0}",
    "Falha ao iniciar: {0}"
  ],
  [
    "Start the whole NOW batch as a new goal. The board keeps its cards.",
    "将整个 NOW 批次作为新目标启动。看板保留其卡片。",
    "전체 NOW 배치를 새로운 목표로 시작합니다. 보드는 자신의 카드를 유지합니다.",
    "NOW バッチ全体を新しい目標として開始します。ボードはカードを保持します。",
    "ابدأ دفعة NOW بأكملها كهدف جديد. يحتفظ اللوح ببطاقاته.",
    "Avvia l'intero batch NOW come nuovo obiettivo. La board mantiene le sue card.",
    "पूरे NOW बैच को नए लक्ष्य के रूप में शुरू करें। बोर्ड के कार्ड बने रहते हैं।",
    "Inicie todo o lote NOW como um novo objetivo. O board mantém seus cards."
  ],
  [
  ...
  [
    ...
    "शुरू हो रहा है — साझा webhook listener बाइंड किया जा रहा है।",
    "Iniciando — vinculando o listener de webhook compartilhado."
  ],
  [
    ...
    "शुरू हो रहा है — webhook listener बाइंड किया जा रहा है।",
    "Iniciando — vinculando o listener de webhook."
  ],
  [
    ...
    "शुरू हो रहा है — IMAP से कनेक्ट किया जा रहा है।",
    "Iniciando — conectando ao IMAP."
  ],
  [
    ...
    "शुरू हो रहा है — Discord gateway से कनेक्ट किया जा रहा है।",
    "Iniciando — conectando ao gateway do Discord."
  ],
  [
    ...
    "शुरू हो रहा है — Socket Mode कनेक्शन खोला जा रहा है।",
    "Iniciando — abrindo conexão no Modo Socket."
  ],
  [
    ...
    "शुरू हो रहा है — Telegram getUpdates के सफल होने की प्रतीक्षा।",
    "Iniciando — aguardando o getUpdates do Telegram ter sucesso."
  ],
  [
    "Starting {0}…",
    "启动 {0}…",
  ...
  [
    ...
    "بدء الخادم ({0})…",
    "Avvio del server ({0})…",
    "सर्वर शुरू हो रहा है ({0})…",
    "Iniciando o servidor ({0})…"
  ],
  [
    "Starting…",
    "启动…",
  ...
  [
    ...
    "ज़रूरत हो तो ब्राउज़र शुरू करता है, फिर नेविगेट करता है। इसके बाद browser_snapshot कॉल करें",
    "Inicia o browser se necessário e depois navega. Em seguida, chame browser_snapshot"
  ],
  [
    "State:",
    "状态：",
  ...
  [
    ...
    "इतने chunks के बाद रुकें (0 = सभी)। पहले लागत का अनुमान देखने के लिए उपयोगी।",
    "Parar após esta quantidade de chunks (0 = todos). Útil para prever o custo antes."
  ],
  [
    "Stop dictation",
    "停止听写",
  ...
  [
    ...
    "진행 중인 디스패치 중지",
    "実行中のディスパッチを停止",
    "إيقاف الإرسال الجاري",
    "Interrompi il dispatch in corso",
    "चल रही dispatch रोकें",
    "Parar o dispatch em andamento"
  ],
  [
    ...
    "दूसरे एजेंट को रोकें",
    "Parar o segundo agente"
  ],
  [
    "stopped",
    "已停止",
  ...
  [
    ...
    "रुका — आख़िरी त्रुटि: {0}",
    "Parado — último erro: {0}"
  ],
  [
    "Stopped.",
    "已停止。",
  ...
  [
    ...
    "Owllm अकाउंट स्टोर में लोकली सेव होता है। huggingface.co के अलावा कहीं नहीं भेजा जाता।",
    "Armazenado localmente no repositório de contas do Owllm. Nunca é enviado a lugar nenhum, exceto huggingface.co."
  ],
  [
  ...
  [
    ...
    "从上方的基础模型中移除拒绝方向。输出到一个新的 transformers 格式目录 — 之后可量化为 GGUF 或直接运行。",
    "기본 모델에서 거부 지침 제거. 출력은 새로운 transformers 형식 디렉토리로 이동 — GGUF로 양자화하거나 그 직후 바로 실행.",
    "上のベースモデルから拒否方向を除去します。出力は新しいtransformers形式のディレクトリに保存されます — その後GGUFに量子化するか、そのまま実行できます。",
    ...
    "Rimuove le direzioni di rifiuto dal modello base sopra. L'output va in una nuova directory in formato transformers — poi quantizza in GGUF o esegui direttamente.",
    "ऊपर वाले बेस मॉडल से refusal दिशाएँ हटाएँ। आउटपुट एक नई transformers-फ़ॉर्मैट डायरेक्टरी में जाता है — बाद में GGUF में quantize करें या सीधे चलाएँ।",
    "Remove as direções de recusa do modelo base acima. A saída vai para um novo diretório no formato transformers — depois quantize para GGUF ou execute diretamente."
  ],
  [
    ...
    "संरचित तर्क सहायता — एजेंट ट्रैक की गई chain में विचार निकालते हैं, संशोधित कर सकते हैं।",
    "Auxílio de raciocínio estruturado — os agentes emitem pensamentos em uma cadeia rastreada e podem revisar."
  ],
  [
    "Studio",
    "工作室",
  ...
  [
    ...
    "जैसे POST के दौरान F2/F12/Del)। प्रलेखित STUBS (backend not-implemented लौटा सकता है):",
    "como F2/F12/Del durante o POST). STUBS documentados (o backend pode retornar não-implementado):"
  ],
  [
    "super",
    "超级",
  ...
  [
    ...
    "切换浏览器的设备模拟：'desktop'、'iphone'、'android' 或",
    "브라우저의 기기 에뮬레이션 전환: 'desktop', 'iphone', 'android' 또는",
    "ブラウザのデバイスエミュレーションを切り替える: 'desktop'、'iphone'、'android' または",
    "تبديل محاكاة جهاز المتصفح: 'desktop' أو 'iphone' أو 'android' أو",
    "Cambia l'emulazione del dispositivo del browser: 'desktop', 'iphone', 'android' o",
    "ब्राउज़र का डिवाइस इम्यूलेशन बदलें: 'desktop', 'iphone', 'android' या",
    "Troca a emulação de dispositivo do browser: 'desktop', 'iphone', 'android' ou"
  ],
  [
    "Switch to dark mode",
    "切换到暗黑模式",
  ...
  [
    ...
    "Browse टैब पर जाएँ और किसी मॉडल कार्ड पर Download क्लिक करके यहाँ एक जोड़ें।",
    "Vá para a aba Browse e clique em Download em um card de modelo para adicionar um aqui."
  ],
  [
    ...
    "अपने क्लाउड लॉगिन (codex/claude/gemini/kimi + API keys) Windows से sandbox में sync करें। यह अपने आप भी चलता है — किसी नए प्रोवाइडर में लॉगिन करने के बाद फिर से sync करने के लिए इसका इस्तेमाल करें।",
    "Sincronize seus logins de nuvem (codex/claude/gemini/kimi + chaves de API) do Windows para o sandbox. Também roda automaticamente — use para ressincronizar após fazer login em um novo provedor."
  ],
  [
    "Synced as @",
    "已同步为 @",
  ...
  [
    ...
    "सिस्टम प्रॉम्प्ट खाली है — सेव करने के लिए कुछ नहीं।",
    "O prompt do sistema está vazio — nada para salvar."
  ],
  [
    "T0…",
    "T0…",
  ...
  [
    ...
    "टैब पर जाकर इसे यहाँ देखें",
    "aba para acompanhar aqui"
  ],
  [
    "tag",
    "tag",
  ...
  [
    ...
    "कार्रवाई से पहले टार्गेट देखने के लिए पहले 'screenshot' लें।",
    "Tire um 'screenshot' primeiro para ver o alvo antes de agir."
  ],
  [
    ...
    "خذ OWLLM في كل مكان",
    "Porta OWLLM ovunque",
    "OWLLM को हर जगह ले जाएँ",
    "Leve o OWLLM para todo lugar"
  ],
  [
    "target / dist / __pycache__ / venv / python_runtime so vendor",
    "target / dist / __pycache__ / venv / python_runtime，因此 vendor",
    "target / dist / __pycache__ / venv / python_runtime — 그래서 vendor",
    "target / dist / __pycache__ / venv / python_runtime so vendor",
    "target / dist / __pycache__ / venv / python_runtime لذلك vendor",
    "target / dist / __pycache__ / venv / python_runtime quindi vendor",
    "target / dist / __pycache__ / venv / python_runtime ताकि vendor",
    "target / dist / __pycache__ / venv / python_runtime para que vendor"
  ],
  [
    ...
    "टार्गेट डिवाइस का NAME या id (आपकी OwLLM Devices सूची से)।",
    "NOME ou id do dispositivo de destino (da sua lista de Devices do OwLLM)."
  ],
  [
    ...
    "टार्गेट पाथ (जैसे C:\\tmp\\note.txt)",
    "caminho de destino (ex.: C:\\tmp\\note.txt)"
  ],
  [
    ...
    "TCP पोर्ट जिस पर MCP HTTP सर्वर सुनता है। डिफ़ॉल्ट 8763।",
    "Porta TCP em que o servidor HTTP do MCP escuta. Padrão 8763."
  ],
  [
    "team",
    "团队",
  ...
  [
    ...
    "team (decisioni, convenzioni, comandi di build/run, posizioni dei file, insidie, precedenti",
    "टीम के साथ (निर्णय, परंपराएँ, build/run कमांड, फ़ाइल स्थान, ध्यान देने योग्य बातें, पिछली",
    "equipe (decisões, convenções, comandos de build/run, locais de arquivos, pegadinhas, anteriores"
  ],
  [
  ...
  [
    ...
    "团队空闲 — 提供的步骤开始运行",
    "팀 대기 중 — 투입된 단계가 실행을 시작합니다",
    "チーム待機中 — 投入されたステップが実行を開始します",
    "الفريق خامل — خطوات التغذية تبدأ التشغيل",
    "team inattivo — i passi inviati avviano un'esecuzione",
    "टीम निष्क्रिय — फ़ीड किए गए स्टेप्स एक रन शुरू करते हैं",
    "equipe ociosa — passos enviados iniciam uma execução"
  ],
  [
    "team is running — fed steps steer it live",
    "团队正在运行 — 提供的步骤实时引导",
    "팀 실행 중 — 투입된 단계가 실시간으로 조종합니다",
    "チーム実行中 — 投入されたステップがライブで誘導します",
    "الفريق يعمل — خطوات التغذية تقوده مباشرة",
    "team in esecuzione — i passi inviati lo guidano in tempo reale",
    "टीम चल रही है — फ़ीड किए गए स्टेप्स इसे लाइव स्टीयर करते हैं",
    "equipe em execução — passos enviados a guiam ao vivo"
  ],
  [
    "team leader",
    "团队领导",
  ...
  [
    ...
    "TEAM MEMORY — एक टिकाऊ, प्रोजेक्ट-व्यापी नॉलेज बेस जिसे आप साझा करते हैं बाक़ी",
    "TEAM MEMORY — uma base de conhecimento durável, de todo o projeto, que você COMPARTILHA com o resto da"
  ],
  [
    ...
    "टीम मेमोरी — साझा नॉलेज बेस जिसे आपके एजेंट पढ़ते-लिखते हैं (build कमांड, निर्णय, फ़ाइल मैप)। vault के ज़रिए आपके PCs में sync होती है।",
    "Memória da Equipe — a base de conhecimento compartilhada que seus agentes leem e escrevem (comandos de build, decisões, mapas de arquivos). Sincroniza entre seus PCs via vault."
  ],
  [
    "Team model",
    "团队模型",
  ...
  [
    ...
    "टीम मॉडल · हर एजेंट को असाइन होता है",
    "MODELO DA EQUIPE · atribui a todos os agentes"
  ],
  [
    "Team name",
    "团队名称",
  ...
  [
    ...
    "टीम रन जारी है",
    "Execução da equipe em andamento"
  ],
  [
    "Team template",
    "团队模板",
  ...
  [
    ...
    "polling الخاص بـ Telegram غير متصل.",
    "Il polling di Telegram non è connesso.",
    "Telegram polling कनेक्टेड नहीं है।",
    "O polling do Telegram não está conectado."
  ],
  [
    "temp",
    "临时",
  ...
  [
    ...
    "जो कॉल्स के बीच यूज़र की cookies/लॉगिन बनाए रखता है (headless scrape नहीं)।",
    "que mantém os cookies/logins do usuário entre as chamadas (não é um scraping headless)."
  ],
  [
    ...
    "उस मशीन ने अभी तक कोई डायल-योग्य पता प्रकाशित नहीं किया है। उसका Devices पेज खोलें और remote control सक्षम करें — पता आपके vault के ज़रिए यहाँ sync हो जाता है।",
    "Aquela máquina ainda não publicou um endereço acessível. Abra a página Devices dela e habilite o controle remoto — o endereço sincroniza aqui pelo seu vault."
  ],
  [
    ...
    "एजेंट काम कर रहा है — बीता समय",
    "O agente está trabalhando — tempo decorrido"
  ],
  [
    ...
    "एजेंट के टूल इसके भीतर चलते हैं",
    "As ferramentas do agente rodam dentro de"
  ],
  [
    ...
    "متصفح الوكلاء هو نافذة حقيقية يتحكمون فيها باستخدام أدوات browser_* (فتح الصفحات، النقر، الكتابة، ملء النماذج). افتح عنوان URL أعلاه لبدء تشغيله وسجّل الدخول مسبقًا إلى موقع — الوكلاء يرثون الجلسة. تعمل خوادم التطوير المحلية أيضًا (localhost:5173 يفتح كـ http)، وتعرض رقائق DEVICE معاينة تخطيطات الهواتف المحمولة.",
    ...
    "एजेंट्स का ब्राउज़र एक असली विंडो है जिसे वे browser_* टूल्स से चलाते हैं (पेज खोलना, क्लिक, टाइप, फ़ॉर्म भरना)। इसे शुरू करने के लिए ऊपर कोई URL खोलें और किसी साइट में पहले से लॉगिन करें — एजेंट्स को वही सेशन मिलता है। लोकल dev सर्वर भी चलते हैं (localhost:5173 http के रूप में खुलता है), और DEVICE चिप्स मोबाइल लेआउट का प्रीव्यू दिखाते हैं।",
    "O browser dos agentes é uma janela real que eles controlam com as ferramentas browser_* (abrir páginas, clicar, digitar, preencher formulários). Abra uma URL acima para iniciá-lo e faça login antecipado em um site — os agentes herdam a sessão. Servidores de dev locais também funcionam (localhost:5173 abre como http), e os chips DEVICE mostram prévia de layouts mobile."
  ],
  [
    ...
    "ब्राउज़र एक दिखाई देने वाली विंडो है; एलिमेंट सूची के लिए browser_snapshot इस्तेमाल करें और",
    "O browser é uma janela visível; use browser_snapshot para a lista de elementos e"
  ],
  [
    ...
    "बंडल की गई फ़ाइल read-only रहती है; Save एक संपादन-योग्य override लिखता है जिसे ऐप उसकी जगह लोड करता है — इसलिए आपके बदलाव लागू होते हैं और बने रहते हैं।",
    "O arquivo embutido permanece somente leitura; Salvar grava um override editável que o app carrega no lugar — assim suas alterações entram em vigor e persistem."
  ],
  [
    ...
    "يعمل Coder والضبط الدقيق الآن داخل Linux. لا شيء آخر مطلوب.",
    "Il Coder e il fine-tuning ora vengono eseguiti all'interno di Linux. Non c'è altro da fare.",
    "Coder और fine-tuning अब Linux के अंदर चलते हैं। और कुछ नहीं करना है।",
    "O Coder e o fine-tuning agora rodam dentro do Linux. Nada mais a fazer."
  ],
  [
    ...
    "نافذة السياق التي حمّلها الخادم قيد التشغيل فعليًا (مباشرة من llama-server). الإعدادات المسبقة أدناه هي الحجم لبدء التشغيل التالي.",
    ...
    "वह context window जिसके साथ चल रहा सर्वर वास्तव में लोड हुआ (llama-server से लाइव)। नीचे दिए presets अगली बार शुरू होने का आकार हैं।",
    "A janela de contexto com que o servidor em execução realmente carregou (ao vivo do llama-server). Os presets abaixo são o tamanho para a PRÓXIMA inicialização."
  ],
  [
    ...
    "वह सटीक key जिसके अंतर्गत fact सेव किया गया था (जैसे 'build_command')।",
    "A chave exata sob a qual o fato foi salvo (ex.: 'build_command')."
  ],
  [
    ...
    "याद रखने योग्य fact/निर्णय, स्पष्ट और आत्मनिर्भर रूप में।",
    "O fato/decisão a lembrar, declarado de forma clara e autossuficiente."
  ],
  [
    ...
    "यह run जिस fine-tuning environment का उपयोग करेगा — बदलने के लिए क्लिक करें",
    "O ambiente de fine-tuning que esta execução usará — clique para alterar"
  ],
  [
    ...
    "लिखने के लिए फ़ाइल की पूरी सामग्री।",
    "O conteúdo completo do arquivo a ser gravado."
  ],
  [
    ...
    "Gamify HQ अभी निर्माणाधीन है — एक्सप्लोर करें, लेकिन बदलावों की अपेक्षा रखें।",
    "O Gamify HQ ainda está em construção — explore, mas espere mudanças."
  ],
  [
    ...
    "releases 发布到的 GitHub 仓库（gh release）。可能与 origin 不同 — OwLLM 的源码是私有的，而其发布仓库是公开的。保存在已提交的 .owllm/project.json 中。",
    ...
    "Il repository GitHub SU cui le release vengono pubblicate (gh release). Può differire da origin — il source di OwLLM è privato mentre il repository delle release è pubblico. Salvato nel file .owllm/project.json committato.",
    "वह GitHub repo जिस पर releases publish होती हैं (gh release)। origin से अलग हो सकता है — OwLLM का source निजी है जबकि उसका releases repo सार्वजनिक है। कमिट की गई .owllm/project.json में सेव होता है।",
    "O repositório GitHub PARA o qual as releases são publicadas (gh release). Pode diferir do origin — o código-fonte do OwLLM é privado, enquanto seu repositório de releases é público. Salvo no .owllm/project.json commitado."
  ],
  [
    "the most recent).",
    "最新的）。",
  ...
  [
    ...
    "चुनने के लिए option की value।",
    "O valor da opção a selecionar."
  ],
  [
    ...
    "पेज reload होता है; ताज़ा element indexes के लिए बाद में browser_snapshot कॉल करें।",
    "A página é recarregada; chame browser_snapshot em seguida para obter índices de elementos atualizados."
  ],
  [
    ...
    "प्रोजेक्ट की खुद की फ़ाइलें (README, docs/, comments) — इन्हें read_file / से खोजें",
    "os arquivos PRÓPRIOS do projeto (README, docs/, comentários) — encontre-os com read_file /"
  ],
  [
    ...
    "公開パイプラインは、ホストに既にマウントされている証明書で署名します（Windows 証明書ストア、ハードウェアトークン、または SimplySign のようなクラウド署名サービス）。拇印（thumbprint）またはサブジェクトで指定してください — これらは以下にマッピングされます",
    ...
    "Publish pipeline होस्ट पर पहले से माउंटेड certificate से sign करती है (Windows store, hardware token, या SimplySign जैसा cloud signer)। उसे thumbprint या subject से पॉइंट करें — ये मैप होते हैं",
    "O pipeline de publicação assina com um certificado já montado no host (repositório do Windows, token de hardware ou um assinador em nuvem como o SimplySign). Aponte para um por thumbprint ou subject — eles correspondem ao"
  ],
  [
    ...
    "चुना गया डिवाइस WSL रिपोर्ट नहीं करता — कोई और target या कोई दूसरा mode चुनें।",
    "O dispositivo selecionado não informa WSL — escolha outro alvo ou um modo diferente."
  ],
  [
    ...
    "चलाने के लिए shell command line।",
    "A linha de comando do shell a executar."
  ],
  [
    ...
    "रिमोट डिवाइस पर चलाने के लिए shell command।",
    "O comando de shell a executar no dispositivo remoto."
  ],
  [
    ...
    "रिमोट होस्ट पर चलाने के लिए shell command।",
    "O comando de shell a executar no host remoto."
  ],
  [
    ...
    "Skill का नाम या id (जैसे 'pdf-processing')।",
    "O nome ou id da skill (ex.: 'pdf-processing')."
  ],
  [
    ...
    "Source डाउनलोड अभी भी यहाँ cache में है: {0}",
    "O download da fonte ainda está em cache em: {0}"
  ],
  [
    ...
    "सेव किया गया thumbprint अभी माउंटेड नहीं है — token लगाएँ / SimplySign शुरू करें।",
    "O thumbprint salvo não está montado no momento — conecte o token / inicie o SimplySign."
  ],
  [
    ...
    "टीम चल रही है — बीता समय",
    "A equipe está em execução — tempo decorrido"
  ],
  [
    ...
    "फ़ील्ड में टाइप करने के लिए टेक्स्ट।",
    "O texto a digitar no campo."
  ],
  [
    ...
    "यह जो tools देता है, और इसके निर्देश।",
    "as ferramentas que ele concede e suas instruções."
  ],
  [
    "The Watcher",
    "观察者",
  ...
  [
    ...
    "The Watcher — OWLLM का सपोर्ट असिस्टेंट",
    "The Watcher — assistente de suporte do OWLLM"
  ],
  [
    "The Watcher ↑",
    "观察者 ↑",
  ...
  [
    ...
    "पुरानी या अधिक specific entries के लिए (खाली query के साथ memory_search सूची देता है",
    "eles para entradas mais antigas ou mais específicas (memory_search com uma query vazia lista"
  ],
  [
  ...
  [
    ...
    "ये keys खाली दिख रही हैं: {0} इनके बिना server शायद शुरू नहीं हो पाएगा। फिर भी जोड़ें?",
    "Estas chaves parecem vazias: {0} O servidor provavelmente não iniciará sem elas. Adicionar mesmo assim?"
  ],
  [
    ...
    "वे sandbox के बाहर चलेंगे — कहीं भी फ़ाइलें पढ़ने-लिखने, system commands चलाने और नेटवर्क इस्तेमाल करने में सक्षम, बिल्कुल आपकी तरह। folder-only सुरक्षा केवल इसी प्रोजेक्ट के लिए हटाई गई है।",
    "Eles rodarão FORA da sandbox — podendo ler e gravar arquivos em qualquer lugar, executar comandos do sistema e usar a rede, exatamente como você. A proteção somente-pasta é removida apenas para ESTE projeto."
  ],
  [
    ...
    "Pensa ad alta voce qui mentre gli agenti lavorano: decisioni, bug, idee per l'interfaccia, file da modificare. Premi Ctrl+Enter o usa le note Digest per trasformarlo in un piano e passaggi utilizzabili.",
    "एजेंट्स के काम करते समय यहाँ खुलकर सोचें: निर्णय, bugs, UI आइडिया, बदलने वाली फ़ाइलें। Ctrl+Enter दबाएँ या Digest notes का उपयोग करके इसे एक योजना और feed करने योग्य steps में बदलें।",
    "Pense em voz alta aqui enquanto os agentes trabalham: decisões, bugs, ideias de UI, arquivos a alterar. Pressione Ctrl+Enter ou use Digest notes para transformar isso em um plano e etapas aproveitáveis."
  ],
  [
    ...
    "यह WSL के अंदर की इसकी sandbox कॉपी भी हटा देता है (वह disk space खाली होता है)। आपका मूल फ़ोल्डर, अगर कोई है, वहीं रहता है।",
    "Isso também remove sua cópia sandbox dentro do WSL (libera esse espaço em disco). Sua pasta original, se houver, permanece intacta."
  ],
  [
    "This app's recorded traffic for this provider — token count is an estimate (~4 chars/token).",
    "此应用为该提供商记录的流量 — token 数量为估计值（约 4 字符/token）。",
    ...
    "इस provider के लिए इस ऐप का रिकॉर्ड किया गया ट्रैफ़िक — token की संख्या एक अनुमान है (~4 अक्षर/token)।",
    "O tráfego registrado por este app para este provedor — a contagem de tokens é uma estimativa (~4 caracteres/token)."
  ],
  [
    "This arrow lets",
    "这个箭头可以",
  ...
  [
    ...
    "यह version bump करता है, commit, tag और push करता है। Repository का GitHub Actions workflow एक सार्वजनिक release build और publish करेगा।",
    "Isso incrementa a versão, faz commit, tag e push. O workflow do GitHub Actions do repositório fará o build e publicará uma release pública."
  ],
  [
    ...
    "यह version bump करता है, commit, tag और push करता है। Repository का GitHub Actions workflow release build और publish करेगा।",
    "Isso incrementa a versão, faz commit, tag e push. O workflow do GitHub Actions do repositório fará o build e publicará a release."
  ],
  [
    ...
    "यह version bump करता है, commit, tag, push करता है और host build चलाता है → {0} → GitHub पर एक सार्वजनिक release publish करता है।",
    "Isso incrementa a versão, faz commit, tag, push e executa o build no host → {0} → publica uma release pública no GitHub."
  ],
  [
    ...
    "यह version bump करता है, commit, tag, push करता है और host build चलाता है → {0} → GitHub पर publish करता है।",
    "Isso incrementa a versão, faz commit, tag, push e executa o build no host → {0} → publica no GitHub."
  ],
  [
  ...
  [
    ...
    "Questa cartella è anche un progetto agentico — regole e notebook sono CONDIVISI con le pagine del team.",
    "यह फ़ोल्डर एक agentic प्रोजेक्ट भी है — rules और notebook टीम पेजों के साथ साझा हैं।",
    "Esta pasta também é um projeto agêntico — regras e notebook são COMPARTILHADOS com as páginas da equipe."
  ],
  [
    ...
    "यह एक firmware स्विच है —",
    "Este é um interruptor de firmware —"
  ],
  [
    ...
    "यह स्थायी है। Cache को फिर से डाउनलोड करना पड़ सकता है; environments को फिर से बनाना पड़ सकता है।",
    "Isso é permanente. O cache pode precisar ser baixado novamente; os ambientes podem precisar ser reconstruídos."
  ],
  [
    ...
    "これは、DavidAUのabliterated Gemma、NousResearchのバリアント、そしてダウンロード済みリストの「supergemma4-abliterated」エントリのようなモデルを生み出したのと同じ技術です。",
    ...
    "Questa è la stessa tecnica che ha prodotto modelli come la Gemma abliterated di DavidAU, le varianti di NousResearch e la voce \"supergemma4-abliterated\" nella tua lista dei download.",
    "यह वही तकनीक है जिससे DavidAU का abliterated Gemma, NousResearch के variants, और आपकी डाउनलोड सूची की \"supergemma4-abliterated\" एंट्री जैसे मॉडल बने हैं।",
    "Esta é a mesma técnica que produziu modelos como o Gemma abliterated do DavidAU, as variantes da NousResearch e a entrada \"supergemma4-abliterated\" na sua lista de downloads."
  ],
  [
    ...
    "यह मशीन रिमोट से नियंत्रित की जा रही है।",
    "Esta máquina está sendo controlada remotamente."
  ],
  [
    ...
    "यह केवल प्रोजेक्ट हटाता है; disk पर आपका फ़ोल्डर बना रहता है।",
    "Isso remove apenas o projeto; sua pasta no disco permanece."
  ],
  [
    ...
    "इस पेज पर एक टीम run चल रहा है — इसे बंद करने से run रुक जाएगा। फिर भी बंद करें?",
    "Esta página tem uma execução de equipe em andamento — fechá-la interrompe a execução. Fechar mesmo assim?"
  ],
  [
    "this PC",
    "这台电脑",
  ...
  [
    ...
    "इस प्रोजेक्ट की कोई location सेट नहीं है। पहले एक फ़ोल्डर चुनें ताकि brainstormer BRIEF.md सेव कर सके।",
    "Este projeto não tem um local definido. Escolha uma pasta primeiro para que o brainstormer possa salvar o BRIEF.md."
  ],
  [
    ...
    "यह फ़ाइल और उसका metadata sidecar हटा देता है। इसे पूर्ववत नहीं किया जा सकता।",
    "Isso remove o arquivo e seu sidecar de metadados. Não pode ser desfeito."
  ],
  [
    ...
    "उन skills पर टिक करें जो इस एजेंट के पास हर टीम में होनी चाहिए — केवल वही load होती हैं जिनकी task को ज़रूरत है। क्लिक करें",
    "Marque as skills que este agente deve ter em todas as equipes — apenas as que uma tarefa precisa são carregadas. Clique"
  ],
  [
    "tier",
    "等级",
  ...
  [
    ...
    "Adattamento stretto (inferenza; il fine-tuning potrebbe avere difficoltà)",
    "तंग फ़िट (inference; fine-tuning में दिक्कत हो सकती है)",
    "Ajuste justo (inferência; o fine-tuning pode ter dificuldades)"
  ],
  [
    ...
    "URL di timestamp (RFC3161)",
    "Timestamp URL (RFC3161)",
    "URL de timestamp (RFC3161)"
  ],
  [
    ...
    "Timezone-aware समय queries + रूपांतरण। छोटा, scheduling एजेंट्स के लिए उपयोगी।",
    "Consultas de horário com fuso horário + conversão. Minúsculo, útil para agentes de agendamento."
  ],
  [
    ...
    "Anthropic-शैली के SKILL.md packs जोड़ने के लिए, फिर उन्हें अपने एजेंट्स को दें (एजेंट्स टैब → एक एजेंट → 📚 Skills)।",
    "para adicionar pacotes SKILL.md no estilo Anthropic e depois entregá-los aos seus agentes (aba Agentes → um agente → 📚 Skills)."
  ],
  [
    "to apply.",
    "以应用。",
  ...
  [
    ...
    "trovare prodotti concorrenti, prior art, documentazione o ricerche.",
    "प्रतिस्पर्धी उत्पाद, prior art, दस्तावेज़ या शोध खोजने के लिए।",
    "para encontrar produtos concorrentes, trabalhos anteriores, documentação ou pesquisas."
  ],
  [
    ...
    "क्लिक या fill करने से पहले interactive elements की indexed सूची पाने के लिए।",
    "para obter a lista indexada de elementos interativos antes de clicar ou preencher."
  ],
  [
    ...
    "caricare un template sul canvas.",
    "canvas पर एक template load करने के लिए।",
    "para carregar um template no canvas."
  ],
  [
    "to load a template.",
    "加载一个模板。",
    ...
    "एक template load करने के लिए।",
    "para carregar um template."
  ],
  [
    ...
    "इसे यहाँ किसी local फ़ोल्डर पर पॉइंट करने के लिए।",
    "para apontá-lo para uma pasta local aqui."
  ],
  [
    ...
    "rileggere gli elementi interattivi.",
    "interactive elements को फिर से पढ़ने के लिए।",
    "para reler os elementos interativos."
  ],
  [
    ...
    "Virtual Machine Platform चालू करने के लिए। जब तक आप reboot नहीं करते, Linux फ़ीचर अनुपलब्ध रहते हैं और धीमे लग सकते हैं। अपना काम सेव करें, फिर reboot करें — वापस आने पर यह डायलॉग खोलें और बाकी सब अपने आप हो जाएगा।",
    "para ativar a Plataforma de Máquina Virtual. Até você reiniciar, os recursos do Linux ficam indisponíveis e podem parecer lentos. Salve seu trabalho e reinicie — quando voltar, abra este diálogo e o resto acontece automaticamente."
  ],
  [
    "To use this skill:",
    "使用此技能：",
  ...
  [
    ...
    "TODO、設定参照、内容によるすべて。",
    "عناصر TODO، مراجع التكوين، أي شيء حسب المحتوى.",
    "TODO, riferimenti alla configurazione, qualsiasi cosa per contenuto.",
    "TODO, configuration संदर्भ, content के आधार पर कुछ भी।",
    "TODOs, referências de configuração, qualquer coisa por conteúdo."
  ],
  [
    "Together AI",
    "Together AI",
  ...
  [
    ...
    "toggle तय करता है कि यह अपने आप launch होता है या नहीं। Auto-start server ऐप बूट पर शुरू नहीं होते — वे ज़रूरत पड़ने पर lazily शुरू होते हैं",
    "o botão decide se ele inicia sozinho. Servidores de início automático não iniciam na abertura do app — eles sobem sob demanda no"
  ],
  [
    "tok",
    "tok",
  ...
  [
    ...
    "आपके GPU के लिए बहुत बड़ा (केवल search)",
    "Grande demais para sua GPU (apenas busca)"
  ],
  [
    "tool",
    "工具",
  ...
  [
    ...
    "tool, हर उस डिवाइस के लिए जिसे आपने pair किया है और जिसकी अनुमति आपको मिली है",
    "ferramenta para qualquer dispositivo que você pareou e recebeu permissão"
  ],
  [
    ...
    "Tool इंस्टॉल विफल: {0}",
    "Falha na instalação da ferramenta: {0}"
  ],
  [
    "Tools",
    "工具",
  ...
  [
    ...
    "Tools · इनहेरिटेड, role '",
    "Ferramentas · herdadas da role '"
  ],
  [
    "tools (from role)",
    "工具（来自角色）",
  ...
  [
    ...
    "Tools हर एजेंट से इनहेरिट होते हैं",
    "As ferramentas são herdadas de cada agente"
  ],
  [
    ...
    "Tools आपकी फ़ाइलों तक पहुँच सकते हैं — केवल write-jail और dangerous-command guard लागू होते हैं।",
    "As ferramentas podem acessar seus arquivos — apenas o write-jail e a proteção contra comandos perigosos se aplicam."
  ],
  [
    "total",
    "总计",
  ...
  [
    ...
    "शुरू हुए steps में कुल queue समय",
    "Tempo total de fila nas etapas iniciadas"
  ],
  [
    "training",
    "训练",
  ...
  [
    ...
    "Il training userà la CPU (più lento)",
    "Training CPU का उपयोग करेगी (धीमा)",
    "O treinamento usará a CPU (mais lento)"
  ],
  [
    ...
    "ऑडियो अटैचमेंट (Telegram, WhatsApp, in-app) को हर एजेंट path के लिए टेक्स्ट में transcribe करता है। Local — कोई cloud round-trip नहीं।",
    "Transcreve anexos de áudio (Telegram, WhatsApp, no app) em texto para todos os caminhos de agente. Local — sem ida e volta à nuvem."
  ],
  [
    ...
    "क्षणिक गपशप), अपने जवाब में कहीं भी ठीक इसी रूप में एक लाइन डालें:",
    "conversa transitória), coloque uma linha em QUALQUER LUGAR da sua resposta exatamente neste formato:"
  ],
  [
    ...
    "एक फ़ाइल पढ़ने की कोशिश की",
    "tentou ler um arquivo"
  ],
  [
    ...
    "true لإرجاع قيم بيئة CI السرية أيضًا. الافتراضي false (بيانات وصفية فقط).",
    "true per restituire anche i valori segreti dell'ambiente CI. Predefinito false (solo metadati).",
    "secret CI env values भी लौटाने के लिए true। डिफ़ॉल्ट false (केवल metadata)।",
    "true para retornar também os valores secretos de env do CI. Padrão false (somente metadados)."
  ],
  [
    ...
    "Trust writes — एजेंट फ़ाइलों को सीधे एडिट करते हैं (write guard स्किप होता है)।",
    "Confiar nas escritas — os agentes editam arquivos diretamente (pula a proteção de escrita)."
  ],
  [
    ...
    "Trust writes — टीम को sandbox guard के बिना फ़ाइलें सीधे एडिट करने दें।",
    "Confiar nas escritas — deixe o time editar arquivos diretamente sem a proteção do sandbox."
  ],
  [
    "trusted",
    "受信任的",
  ...
  [
    ...
    "विश्वसनीय कंट्रोलर और अनुमतियाँ",
    "Controladores confiáveis e permissões"
  ],
  [
    "trusted LAN",
    "受信任的局域网",
  ...
  [
    ...
    "नवीनतम स्नैपशॉट से दिए गए index वाले input/textarea एलिमेंट में टेक्स्ट टाइप करें",
    "Digite texto no elemento input/textarea no índice indicado do snapshot mais recente"
  ],
  [
  ...
  [
    ...
    "जब तक workspace की तैयारी पूरी होती है, अपना अनुरोध टाइप करें…",
    "Digite sua solicitação enquanto o workspace termina de preparar…"
  ],
  [
    "UAC prompt",
    "UAC 提示",
  ...
  [
    ...
    "Ubuntu इंस्टॉल है लेकिन अभी कोई Linux यूज़र नहीं है — अपना अकाउंट बनाएँ ताकि एनवायरनमेंट आपकी home (root नहीं) के अंदर इंस्टॉल हों।",
    "O Ubuntu está instalado mas ainda não tem um usuário Linux — crie sua conta para que os ambientes sejam instalados na sua home (não no root)."
  ],
  [
    ...
    "Ubuntu इंस्टॉल है लेकिन अभी कोई यूज़र अकाउंट नहीं है। एक नाम और पासवर्ड चुनें — हम आपके लिए अकाउंट बनाते हैं (कोई कंसोल विंडो नहीं) और उसे याद रखते हैं",
    "O Ubuntu está instalado mas ainda não tem uma conta de usuário. Escolha um nome e uma senha — criamos a conta para você (sem janela de console) e a lembramos"
  ],
  [
    "uname -a",
    "uname -a",
  ...
  [
    ...
    "HEADに対する未コミットの変更",
    "تغييرات بدون commit مقابل HEAD",
    "Modifiche non committate rispetto a HEAD",
    "बिना commit किए बदलाव vs HEAD",
    "Alterações sem commit vs HEAD"
  ],
  [
    "Unequip",
    "卸下",
  ...
  [
    ...
    "चुने गए सेव किए हुए टेम्पलेट को मौजूदा सिस्टम prompt से अपडेट करें",
    "Atualizar o template salvo selecionado com o prompt de sistema atual"
  ],
  [
    "Updated:",
    "已更新：",
  ...
  [
    ...
    "जिस URL पर नेविगेट करना है (वेब या localhost)।",
    "URL para onde navegar (web ou localhost)."
  ],
  [
    ...
    "खोलने के लिए URL (जैसे https://example.com या localhost:5173)।",
    "URL para abrir (ex.: https://example.com ou localhost:5173)."
  ],
  [
    ...
    "वह URL जहाँ MCP सर्वर सुनता है। बाहरी क्लाइंट इसी URL पर पॉइंट करते हैं।",
    "URL onde o servidor MCP escuta. Clientes externos apontam para essa URL."
  ],
  [
    "Usage",
    "使用",
  ...
  [
    ...
    "अपने अकाउंट से {0} ({1}:{2}) उपयोग करें",
    "Usar {0} ({1}:{2}) da sua conta"
  ],
  [
    "Use a",
    "使用一个",
  ...
  [
    ...
    "ट्रेनिंग रन के लिए इस एनवायरनमेंट का उपयोग करें",
    "Usar este ambiente para execuções de treinamento"
  ],
  [
    "Use this on URLs returned by web_search to extract feature lists,",
    "在 web_search 返回的网址上使用它以提取功能列表",
    "web_search가 반환한 URL에 사용해 기능 목록을 추출하세요,",
    ...
    "web_search से मिले URL पर इसका उपयोग करें ताकि फ़ीचर सूचियाँ निकाली जा सकें,",
    "Use isto nas URLs retornadas pelo web_search para extrair listas de recursos,"
  ],
  [
    ...
    "जब आपको फ़ाइलों की सामग्री अभी पता न हो, तब फ़ाइलें खोजने के लिए इसका उपयोग करें।",
    "Use isto para descobrir arquivos quando você ainda não conhece o conteúdo deles."
  ],
  [
    ...
    "इंटरैक्टिव-एलिमेंट सूची के बजाय आर्टिकल/बॉडी कंटेंट पढ़ने के लिए उपयोग करें।",
    "Use para ler o conteúdo do artigo/corpo em vez da lista de elementos interativos."
  ],
  [
    "Used tool: {0}",
    "使用的工具：{0}",
  ...
  [
    ...
    "यूज़र इनपुट हिस्ट्री",
    "Histórico de entradas do usuário"
  ],
  [
    "Username",
    "用户名",
  ...
  [
    ...
    "बाहरी टूल्स के साथ अपने लोकल LLM का उपयोग",
    "Usando seu LLM local com ferramentas externas"
  ],
  [
    "uv",
    "uv",
  ...
  [
    ...
    "वैल्यूज़ — Apple के लिए: APPLE_CERTIFICATE (base64 .p12), APPLE_CERTIFICATE_PASSWORD, APPLE_SIGNING_IDENTITY,",
    "valores — para Apple: APPLE_CERTIFICATE (base64 .p12), APPLE_CERTIFICATE_PASSWORD, APPLE_SIGNING_IDENTITY,"
  ],
  [
    ...
    "वैल्यूज़ को सावधानी से संभालें: उन्हें कभी logs, commits या chat में echo न करें।",
    "valores com cuidado: nunca os exponha em logs, commits ou no chat."
  ],
  [
    "variables.",
    "变量。",
  ...
  [
    ...
    "सिग्नेचर वेरिफ़ाई करके बाइनरी बदली जा रही है। ऐप कुछ ही क्षण में रीस्टार्ट होगा।",
    "Verificando a assinatura e trocando o binário. O app vai reiniciar em instantes."
  ],
  [
    "Version",
    "版本",
  ...
  [
    ...
    "अपने पैकेज मैनेजर से। फिर इस पेज को रीलोड करें।",
    "pelo seu gerenciador de pacotes. Depois recarregue esta página."
  ],
  [
    "video",
    "视频",
  ...
  [
    ...
    "एजेंट्स का साझा वेब ब्राउज़र (browser_* टूल्स) देखें और चलाएँ — लाइव पेज देखें, URL खोलें, daemon रोकें।",
    "Veja e controle o navegador web compartilhado dos agentes (ferramentas browser_*) — veja a página ao vivo, abra URLs, pare o daemon."
  ],
  [
    "View diff",
    "查看差异",
  ...
  [
    ...
    "यूज़र की आवाज़ — ऑर्केस्ट्रेटर की योजना की समीक्षा करता है। हमेशा मौजूद, सलाहकार।",
    "A voz do usuário — revisa o plano do orquestrador. Sempre presente, consultivo."
  ],
  [
    ...
    "यूज़र की आवाज़। ऑर्केस्ट्रेटर की योजना की समीक्षा करता है, Director Mode चालू होने पर [NEED_USER_INPUT] का जवाब देता है।",
    "A voz do usuário. Revisa o plano do orquestrador e responde [NEED_USER_INPUT] quando o Modo Diretor está ativo."
  ],
  [
    "Voice runtime ·",
    "语音运行时 ·",
  ...
  [
    ...
    "ट्रेनिंग प्रोसेस शुरू होने की प्रतीक्षा हो रही है…",
    "Aguardando o início do processo de treinamento…"
  ],
  [
  ...
  [
    ...
    "इस मशीन को नियंत्रित करना चाहता है।",
    "quer controlar esta máquina."
  ],
  [
    "wants to run a",
    "想要运行一个",
  ...
  [
    ...
    "Watcher ऑब्ज़र्वेटरी",
    "Observatório do Watcher"
  ],
  [
    "We opened",
    "我们打开了",
  ...
  [
    ...
    "Brave Search API से वेब सर्च। 2000 क्वेरी/माह फ़्री, लेकिन अब वेरिफ़िकेशन के लिए कार्ड ज़रूरी है।",
    "Busca na web via Brave Search API. Grátis 2000 consultas/mês, mas agora exige um cartão para verificação."
  ],
  [
    ...
    "DuckDuckGo से वेब सर्च। कोई key नहीं, कोई कार्ड नहीं, अनलिमिटेड। `uvx` (Astral uv) चाहिए — `winget install astral-sh.uv` या `pip install uv` से इंस्टॉल करें, फिर OwLLM रीस्टार्ट करें।",
    "Busca na web via DuckDuckGo. SEM chave, SEM cartão, ilimitado. Requer `uvx` (Astral uv) — instale com `winget install astral-sh.uv` ou `pip install uv` e reinicie o OwLLM."
  ],
  [
    ...
    "웹 전용 · 구독하려면 가입",
    "ウェブ専用 · 購読サインアップ",
    "متاح على الويب فقط · سجّل للاشتراك",
    "Solo web · iscriviti per abbonarti",
    "केवल वेब · सब्सक्राइब करने के लिए साइन अप करें",
    "Somente web · cadastre-se para assinar"
  ],
  [
    "Website / Web app",
    "网站 / 网络应用",
  ...
  [
    ...
    "उस दिशा के विरुद्ध वेट मैट्रिक्स।",
    "matriz de pesos contra essa direção."
  ],
  [
    "Weights on disk",
    "磁盘上的权重",
  ...
  [
    ...
    "आपने क्या किया, क्या उम्मीद थी, क्या हुआ? टीम सबसे पहले यही पढ़ती है।",
    "O que você fez, o que esperava, o que aconteceu? É isso que o time lê primeiro."
  ],
  [
    ...
    "आप क्या बनाना चाहते हैं? एक कार्ड चुनें — आपके लिए एजेंट्स की सही टीम और सेटिंग्स तैयार हैं। बाद में आप सब कुछ बदल सकते हैं।",
    "O que você quer criar? Escolha um card — o time certo de agentes e as configurações são preparados para você. Você pode ajustar tudo depois."
  ],
  [
    "What is abliteration?",
    "什么是 abliteration？",
  ...
  [
    ...
    "यह एजेंट टीम में क्या करता है",
    "O que este agente faz no time"
  ],
  [
    ...
    "यह एजेंट यहाँ क्या हासिल करने के लिए है — टीम में इसका उद्देश्य।",
    "O que este agente está aqui para alcançar — seu objetivo no time."
  ],
  [
    ...
    "यह प्रोजेक्ट क्या है, एक-दो लाइनों में — टीम इसे पढ़ती है।",
    "O que é este projeto, em uma ou duas linhas — o time lê isto."
  ],
  [
  ...
  [
    ...
    "जब लक्ष्य में “publish” कहा जाता है, तो release नियम से चलती है: bump → commit → tag → push, फिर या तो लोकल build करें या GitHub Actions से पूरा होने दें।",
    "Quando um objetivo diz “publicar”, a release segue a regra: bump → commit → tag → push, depois faça o build localmente ou deixe o GitHub Actions concluir."
  ],
  [
    ...
    "जब कोई रन सही से पूरा होता है, तो अगला पेंडिंग स्टेप अपने आप डिस्पैच हो जाता है — रोडमैप लिखें, टीम उस पर चलती है। सिर्फ़ वही पेज क़तार भरता है जिस पर यह चालू है।",
    "Quando uma execução termina sem erros, o próximo passo pendente é despachado automaticamente — escreva o roadmap e o time o percorre. Só a página que ativa isto alimenta a fila."
  ],
  [
    ...
    "Quando è attivo, i tuoi agenti (team Agentic / Code) ottengono un",
    "चालू होने पर, आपके एजेंट्स (Agentic टीम / Code) को मिलता है",
    "Quando ativado, seus agentes (time Agentic / Code) recebem um"
  ],
  [
    ...
    "जब पहला एजेंट जवाब पूरा कर लेता है, तो वह अपने आप दूसरे एजेंट को उसकी अगली बारी के रूप में भेज दिया जाता है।",
    "Quando o 1º agente termina uma resposta, ela é enviada automaticamente ao 2º agente como seu próximo turno."
  ],
  [
    ...
    "जब दूसरा एजेंट जवाब पूरा कर लेता है, तो वह अपने आप पहले एजेंट को उसकी अगली बारी के रूप में भेज दिया जाता है।",
    "Quando o 2º agente termina uma resposta, ela é enviada automaticamente ao 1º agente como seu próximo turno."
  ],
  [
    ...
    "जब प्रोजेक्ट बनता है।",
    "quando o projeto nasce."
  ],
  [
    "Where am I?",
    "我在哪里？",
  ...
  [
    ...
    "कौन-सा signing सेट: 'apple' (डिफ़ॉल्ट) या 'windows'।",
    "Qual conjunto de assinatura: 'apple' (padrão) ou 'windows'."
  ],
  [
    "whisper-cpp",
    "whisper-cpp",
  ...
  [
    ...
    "Windows सर्टिफ़िकेट माउंटेड",
    "Certificado do Windows montado"
  ],
  [
    ...
    "Windows सर्टिफ़िकेट स्टोर में नहीं है",
    "Certificado do Windows NÃO está no repositório"
  ],
  [
    ...
    "Windows सर्टिफ़िकेट: अज्ञात",
    "Certificado do Windows: desconhecido"
  ],
  [
    "Windows:",
    "Windows：",
  ...
  [
    ...
    "लोकल clone मिटाएँ और शुरू से फिर clone करें",
    "Apagar o clone local e clonar de novo do zero"
  ],
  [
    ...
    "ऊपर का लॉग पैनल साफ़ करें। चल रहे सर्वरों पर असर नहीं पड़ता।",
    "Limpa o painel de log acima. Não afeta os servidores em execução."
  ],
  [
    ...
    "browser_click / browser_fill / browser_select के साथ — हमेशा पहले इसे कॉल करें ताकि",
    "com browser_click / browser_fill / browser_select — SEMPRE chame isto primeiro para"
  ],
  [
    "working",
    "工作中",
  ...
  [
    ...
    "पब्लिक वेब और लोकल डेव सर्वर दोनों पर काम करता है (localhost:5173, 127.0.0.1:3000",
    "Funciona na web pública E em servidores de desenvolvimento locais (localhost:5173, 127.0.0.1:3000"
  ],
  [
    ...
    "वह workspace फ़ोल्डर जिसके अंदर MCP टूल्स (shell, फ़ाइल ऑपरेशंस, git) काम करते हैं।",
    "Pasta de workspace dentro da qual as ferramentas MCP (shell, operações de arquivo, git) operam."
  ],
  [
    "Workspace still preparing — Send unlocks in a moment.",
    "工作区仍在准备中——“发送”按钮稍后解锁。",
    "작업 공간이 아직 준비 중입니다 — 잠시 후 보내기 버튼이 활성화됩니다.",
    "ワークスペースは準備中 — まもなく送信ボタンが有効になります。",
    "مساحة العمل لا تزال قيد التحضير — سيتم تفعيل زر الإرسال بعد لحظة.",
    "Workspace ancora in preparazione — Invia si sblocca tra un momento.",
    "Workspace अभी तैयार हो रहा है — Send बटन कुछ ही देर में अनलॉक हो जाएगा।",
    "O workspace ainda está sendo preparado — o botão Enviar desbloqueia em instantes."
  ],
  [
    ...
    "एक स्टेप लिखें और Enter दबाएँ…",
    "Escreva um passo e pressione Enter…"
  ],
  [
    ...
    "कोड लिखता और एडिट करता है",
    "escreve e edita código"
  ],
  [
    "Writes the six",
    "写六个",
  ...
  [
    ...
    "में लिखता है (निर्णय, कन्वेंशन, build/run कमांड, फ़ाइल स्थान,",
    "escreve em (decisões, convenções, comandos de build/execução, locais de arquivos,"
  ],
  [
    ...
    "यूज़र-फ़ेसिंग और डेवलपर डॉक्स लिखता है",
    "escreve documentação para usuários e desenvolvedores"
  ],
  [
    "Writing & content",
    "写作与内容",
  ...
  [
    ...
    "WSL को पहले एक क्विक सेटअप चाहिए।",
    "O WSL precisa primeiro de uma configuração rápida."
  ],
  [
    ...
    "WSL नोट: Win11 mirrored networking में loopback चल सकता है (exposure बंद); Win10 (NAT) में इसे ON करना ज़रूरी है।",
    "Nota sobre WSL: no Win11, a rede espelhada pode usar loopback (exposição desativada); no Win10 (NAT) isto precisa estar ATIVADO."
  ],
  [
    "WSL setup log",
    "WSL 设置日志",
  ...
  [
    ...
    "WSL इंस्टॉल हो गया, लेकिन Windows को चाहिए",
    "O WSL foi instalado, mas o Windows precisa"
  ],
  [
    "wsl-restart",
    "wsl-restart",
  ...
  [
    ...
    "xapp-…（Socket 模式，connections:write）",
    "xapp-… (Socket Mode, connections:write)",
    "xapp-…（ソケットモード、connections:write）",
    "xapp-… (وضع Socket، connections:write)",
    "xapp-… (Socket Mode, connections:write)",
    "xapp-… (Socket Mode, connections:write)",
    "xapp-… (Socket Mode, connections:write)"
  ],
  ...
  [
    ...
    "हाँ, स्थायी रूप से हटाएँ",
    "Sim, excluir permanentemente"
  ],
  [
    "yet — then follow its instructions. You may call it again with a",
    "尚未 — 然后按照它的指示操作。你可以再次调用它，用一个",
    "아직 — 그 다음에는 지침을 따르십시오. 다시 호출할 때는",
    "まだ — その指示に従ってください。また、次のように呼び出すことができます",
    "بعدُ — ثم اتبع تعليماته. يمكنك استدعاؤه مرة أخرى باستخدام",
    "ancora — quindi segui le sue istruzioni. Puoi richiamarlo con un",
    "अभी तक — फिर उसके निर्देशों का पालन करें। आप उसे फिर से कॉल कर सकते हैं, एक",
    "ainda — depois siga as instruções dele. Você pode chamá-lo novamente com um"
  ],
  [
    "you",
    "你",
  ...
  [
    ...
    "التي قمت بإقرانها ومنحتها صلاحية shell. على عكس ssh_exec هذا لا يحتاج إلى أي مفاتيح أو إعدادات SSH",
    "hai accoppiato e concesso shell. A differenza di ssh_exec questo NON richiede chiavi/configurazioni SSH",
    "जिन्हें आपने pair किया है और shell एक्सेस दिया है। ssh_exec के विपरीत, इसे किसी SSH keys/config की ज़रूरत नहीं है",
    "com que você pareou e a que concedeu shell. Ao contrário do ssh_exec, isto NÃO precisa de chaves/config SSH"
  ],
  [
    "you@example.com",
    "you@example.com",
  ...
  [
    ...
    "आपके Accounts के लॉगिन सैंडबॉक्स में अपने आप sync होते हैं और बने रहते हैं।",
    "Os logins das suas Contas sincronizam automaticamente no sandbox e persistem."
  ],
  [
    "Your agents",
    "您的代理",
  ...
  [
    ...
    "आपकी चैट और सेटअप, हर डिवाइस पर — आपके अपने GitHub में सहेजे गए।",
    "Seus chats e configurações, em todos os dispositivos — armazenados no seu próprio GitHub."
  ],
  [
    ...
    "La tua idea (una o due frasi — resta sul generico, il brainstormer completa il resto)",
    "आपका आइडिया (एक-दो वाक्य — सामान्य रखें, बाकी ब्रेनस्टॉर्मर भर देगा)",
    "Sua ideia (uma ou duas frases — seja genérico, o brainstormer preenche o resto)"
  ],
  [
    ...
    "Il tuo ambiente di programmazione AI locale — apri una cartella e il tuo modello legge, cerca, modifica ed esegue comandi direttamente al suo interno.",
    "आपका लोकल AI कोडिंग वर्कस्पेस — एक फ़ोल्डर खोलें और आपका मॉडल उसी के अंदर पढ़ता, खोजता, एडिट करता और कमांड चलाता है।",
    "Seu workspace local de codificação com IA — abra uma pasta e seu modelo lê, pesquisa, edita e executa comandos diretamente dentro dela."
  ],
  [
    ...
    "Il tuo modello locale programma direttamente in",
    "आपका लोकल मॉडल सीधे इसमें कोड करता है",
    "Seu modelo local codifica diretamente em"
  ],
  [
    ...
    "نموذجك لديه أداة memory_write، واستدعاؤها يفعل الشيء نفسه.",
    "il tuo modello ha lo strumento memory_write, chiamarlo fa la stessa cosa.",
    "आपके मॉडल के पास memory_write टूल है, उसे कॉल करने से वही होता है।",
    "seu modelo tem a ferramenta memory_write; chamá-la faz a mesma coisa."
  ],
  [
    ...
    "आपका मॉडल सीधे इस प्रोजेक्ट में काम करता है — फ़ाइलें पढ़ना, खोजना, एडिट करना और कमांड चलाना। बातचीत और प्लान सहेजे जाते हैं और दोबारा खोलने पर वापस मिल जाते हैं।",
    "Seu modelo trabalha diretamente neste projeto — lendo, pesquisando, editando arquivos e executando comandos. A conversa e o plano são salvos e retornam quando você o reabre."
  ],
  [
    ...
    "आपकी दूसरी OwLLM मशीनें अपने डिवाइस रिकॉर्ड आपके GitHub वॉल्ट के ज़रिए पब्लिश करती हैं, इसलिए 🔄 Discover तब तक खाली आता रहेगा जब तक आप GitHub कनेक्ट नहीं करते (या एक फ्री अकाउंट नहीं बनाते)। नीचे दिया गया मैनुअल \"Pair by IP\" इसके बिना भी काम करता है।",
    "Suas outras máquinas OwLLM publicam seus registros de dispositivo através do seu vault do GitHub, então o 🔄 Discover continuará voltando vazio até você conectar o GitHub (ou criar uma conta gratuita). O \"Pair by IP\" manual abaixo funciona sem ele."
  ],
  [
    "Your private vault",
    "你的私人保管库",
  ...
  [
    ...
    "आपके भेजे गए मैसेज यहाँ दिखेंगे। उन्हें नीचे Orchestrator के User Input डॉक में टाइप करें।",
    "Suas mensagens enviadas aparecerão aqui. Digite-as no dock de Entrada do Usuário do Orchestrator abaixo."
  ],
  [
    ...
    "आपके वर्कस्पेस की टीम ID (T से शुरू होती है)। slack.com/admin/settings पर देखें।",
