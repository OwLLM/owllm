...
// The website embeds this same bundle in a plain browser, where
// @tauri-apps/api has no __TAURI_INTERNALS__ to bind to and `listen()`
// rejects on mount. Native listeners are gated on this.
