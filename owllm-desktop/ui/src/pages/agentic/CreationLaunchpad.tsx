...
import "./CreationLaunchpad.fold.css";
    ...
    >
      ...
      <div className="creation-launchpad__content">
        ...
        <div className="creation-launchpad__layout">
          <div className="creation-launchpad__primary">
            <div className="creation-launchpad__kicker">New workspace</div>
            ...
            >
              ...
              <div className="creation-launchpad__composer-bar">
                ...
                <span className="creation-launchpad__enter-hint">Enter to continue · Shift + Enter for a new line</span>
                <button
                  type="submit"
            ...
            {actions.length > 0 && (
              <div className="creation-launchpad__actions">
                <span className="creation-launchpad__start-label">Quick start</span>
                {actions.map((action) => (
          ...
          <aside className="creation-launchpad__choices" aria-label="Choose how OWLLM should help">
            <div className="creation-launchpad__choices-label">Start with</div>
            <div className="creation-launchpad__modes" role="group">
              {modes.map((mode) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="creation-launchpad__mode-arrow" aria-hidden="true">→</span>
                  </button>
                );
              })}
            </div>
            <div className="creation-launchpad__privacy-note">
              <span aria-hidden="true">⌾</span>
              <span><strong>Your workspace stays yours.</strong> Choose local or connected models for every project.</span>
            </div>
          </aside>
        </div>
      </div>
