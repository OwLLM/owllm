...
for (const m of ["localTools", "toolNormalizer", "modelProfiles", "inferenceEndpoint", "ModelPicker", "teamConfig", "dispatchParse", "teamMemoryFormat", "skillRuntime", "personalAgentRuntime", "agentSandbox"]) {
