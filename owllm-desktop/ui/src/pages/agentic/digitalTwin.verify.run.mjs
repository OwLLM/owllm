...
const page = fs.readFileSync(path.join(here, "DigitalTwinPage.tsx"), "utf8");
...
const checks = [
  ...
  [page.includes("window.requestAnimationFrame") && page.includes("importRunRef.current += 1"), "multi-file imports yield to the UI and stale work is cancelled on clear or unmount"],
